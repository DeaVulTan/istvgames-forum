...
{
$count_fa3951f0a57c118aa82043ae558efa89 = is_array($this->functionData['asForumPosts']) ? count($this->functionData['asForumPosts']) : 0;
$this->functionData['asForumPosts'][$count_fa3951f0a57c118aa82043ae558efa89]['data'] = $data;
}
$IPBHTML .= "<div class='row'>
	...
	{$this->lang->words['in']}
	".$this->__f__bb01611a4e5ffe603956fac8181e0339($data)."	
	" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
		<span class='mini_pagination'>
			".$this->__f__0a04f77cd259b8f66e8f2d57236bf7f0($data)."		</span>
	") : ("")) . "
	<br />
...
function __f__bb01611a4e5ffe603956fac8181e0339($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0a04f77cd259b8f66e8f2d57236bf7f0($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9da628657450b79beae4340d9a1f19ec = is_array($this->functionData['asForumTopics']) ? count($this->functionData['asForumTopics']) : 0;
$this->functionData['asForumTopics'][$count_9da628657450b79beae4340d9a1f19ec]['data'] = $data;
}
$IPBHTML .= "<div class='row touch-row " . ((!empty( $data['_unreadUrl'] )) ? ("unread") : ("")) . "' id=\"sr-{$data['type_id_2']}\">
	...
	<div class='rowContent'>
		...
		") : ("")) . "
		<div>
			" . ucfirst($this->lang->words['in']) . "".$this->__f__5c9e83f4ff49765d7b5f8a310cdadace($data)."		</div>
...
function __f__5c9e83f4ff49765d7b5f8a310cdadace($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data['_forum_trail'] as $i => $f )
...
{
$count_25d969afe470c1009add5c5b43b1f787 = is_array($this->functionData['followData']) ? count($this->functionData['followData']) : 0;
$this->functionData['followData'][$count_25d969afe470c1009add5c5b43b1f787]['followData'] = $followData;
}
...
{
$count_9abeac5255d892b973916f11859d6deb = is_array($this->functionData['followedContentForumsWrapper']) ? count($this->functionData['followedContentForumsWrapper']) : 0;
$this->functionData['followedContentForumsWrapper'][$count_9abeac5255d892b973916f11859d6deb]['results'] = $results;
}
$IPBHTML .= "" . ((count($results)) ? ("".$this->__f__4457cf46abc1f99335d759a65204b3a9($results)."") : ("")) . "";
return $IPBHTML;
}


function __f__4457cf46abc1f99335d759a65204b3a9($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1cd91cfb4441a9aada972462d524a1bd = is_array($this->functionData['followedContentForumsWrapperForums']) ? count($this->functionData['followedContentForumsWrapperForums']) : 0;
$this->functionData['followedContentForumsWrapperForums'][$count_1cd91cfb4441a9aada972462d524a1bd]['results'] = $results;
}
...
<div class='master_list'>
	".$this->__f__5743e765cae9a9b004d4d1ff75e031e1($results)."</div>";
return $IPBHTML;
}


function __f__5743e765cae9a9b004d4d1ff75e031e1($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8f5dc40e5d2b6eb80b908ac63c4c606a = is_array($this->functionData['followedContentView']) ? count($this->functionData['followedContentView']) : 0;
$this->functionData['followedContentView'][$count_8f5dc40e5d2b6eb80b908ac63c4c606a]['results'] = $results;
$this->functionData['followedContentView'][$count_8f5dc40e5d2b6eb80b908ac63c4c606a]['pagination'] = $pagination;
$this->functionData['followedContentView'][$count_8f5dc40e5d2b6eb80b908ac63c4c606a]['total'] = $total;
$this->functionData['followedContentView'][$count_8f5dc40e5d2b6eb80b908ac63c4c606a]['error'] = $error;
$this->functionData['followedContentView'][$count_8f5dc40e5d2b6eb80b908ac63c4c606a]['contentTypes'] = $contentTypes;
}
$IPBHTML .= "" . (($pagination) ? ("
<div class='controls'>
...
<div class='master_list'>
	...
	<div class='ipsPad'>
		...
		".$this->__f__c7b76ce81806ca7999141b320cd89df7($results,$pagination,$total,$error,$contentTypes)."		</ul>
	</div>
</div>
<div class='master_list'>
	...
	<div class='ipsPad'>
		<ul>
			".$this->__f__0929c96af0b1e8d871b373e0cb76c94d($results,$pagination,$total,$error,$contentTypes)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__c7b76ce81806ca7999141b320cd89df7($results, $pagination, $total, $error, $contentTypes)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0929c96af0b1e8d871b373e0cb76c94d($results, $pagination, $total, $error, $contentTypes)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_252b59b4c2f9403fe3782fcbdd567e74 = is_array($this->functionData['forumAdvancedSearchFilters']) ? count($this->functionData['forumAdvancedSearchFilters']) : 0;
$this->functionData['forumAdvancedSearchFilters'][$count_252b59b4c2f9403fe3782fcbdd567e74]['forums'] = $forums;
$this->functionData['forumAdvancedSearchFilters'][$count_252b59b4c2f9403fe3782fcbdd567e74]['archivedPostCount'] = $archivedPostCount;
$this->functionData['forumAdvancedSearchFilters'][$count_252b59b4c2f9403fe3782fcbdd567e74]['topic'] = $topic;
}
...
{
$count_c9c8148275371a7675f0cbd08616f0ca = is_array($this->functionData['forumsVncFilters']) ? count($this->functionData['forumsVncFilters']) : 0;
$this->functionData['forumsVncFilters'][$count_c9c8148275371a7675f0cbd08616f0ca]['data'] = $data;
$this->functionData['forumsVncFilters'][$count_c9c8148275371a7675f0cbd08616f0ca]['currentPrefs'] = $currentPrefs;
}
...
{
$count_cd6cd3ff284f94642a939b2a69a63f53 = is_array($this->functionData['helpSearchResult']) ? count($this->functionData['helpSearchResult']) : 0;
$this->functionData['helpSearchResult'][$count_cd6cd3ff284f94642a939b2a69a63f53]['r'] = $r;
$this->functionData['helpSearchResult'][$count_cd6cd3ff284f94642a939b2a69a63f53]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_d66dd5a60706b90dbc69e101bac04f5d = is_array($this->functionData['memberCommentsSearchResult']) ? count($this->functionData['memberCommentsSearchResult']) : 0;
$this->functionData['memberCommentsSearchResult'][$count_d66dd5a60706b90dbc69e101bac04f5d]['r'] = $r;
$this->functionData['memberCommentsSearchResult'][$count_d66dd5a60706b90dbc69e101bac04f5d]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_668b61469d072965980c2bdc8736bf30 = is_array($this->functionData['newContentView']) ? count($this->functionData['newContentView']) : 0;
$this->functionData['newContentView'][$count_668b61469d072965980c2bdc8736bf30]['results'] = $results;
$this->functionData['newContentView'][$count_668b61469d072965980c2bdc8736bf30]['pagination'] = $pagination;
$this->functionData['newContentView'][$count_668b61469d072965980c2bdc8736bf30]['total'] = $total;
$this->functionData['newContentView'][$count_668b61469d072965980c2bdc8736bf30]['sortDropDown'] = $sortDropDown;
$this->functionData['newContentView'][$count_668b61469d072965980c2bdc8736bf30]['sortIn'] = $sortIn;
$this->functionData['newContentView'][$count_668b61469d072965980c2bdc8736bf30]['dateCutSet'] = $dateCutSet;
}
...
" . ((is_array($sortIn) AND count( $sortIn )) ? ("
	<div class='ipsFilterPane' id='filter_section_pane' style='display: none'>
		...
		<div>
			...
			<ul>
				".$this->__f__5e65547f3059062e2c520010091af869($results,$pagination,$total,$sortDropDown,$sortIn,$dateCutSet)."			</ul>
		</div>
	</div>
") : ("")) . "
...
function __f__f92eb80a4f76626dbdbde5122d5ec3b8($results, $pagination, $total, $sortDropDown, $sortIn, $dateCutSet=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->registry->getApplications() as $app )
...
function __f__5e65547f3059062e2c520010091af869($results, $pagination, $total, $sortDropDown, $sortIn, $dateCutSet=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a424d7adc7789929f654be3bca67902a = is_array($this->functionData['searchAdvancedForm']) ? count($this->functionData['searchAdvancedForm']) : 0;
$this->functionData['searchAdvancedForm'][$count_a424d7adc7789929f654be3bca67902a]['filters'] = $filters;
$this->functionData['searchAdvancedForm'][$count_a424d7adc7789929f654be3bca67902a]['msg'] = $msg;
$this->functionData['searchAdvancedForm'][$count_a424d7adc7789929f654be3bca67902a]['current_app'] = $current_app;
$this->functionData['searchAdvancedForm'][$count_a424d7adc7789929f654be3bca67902a]['removed_search_terms'] = $removed_search_terms;
$this->functionData['searchAdvancedForm'][$count_a424d7adc7789929f654be3bca67902a]['isFT'] = $isFT;
$this->functionData['searchAdvancedForm'][$count_a424d7adc7789929f654be3bca67902a]['canTag'] = $canTag;
}
...
<div class='master_list ipsForm_vertical'>
	...
	" . ((count($filters)) ? ("".$this->__f__9117cf02438f0b0a3d1d28c4abdc10a1($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag)."		") : ("")) . "
	<div class='submit'>
...
function __f__de3b2f49812dcd491fb29320d2c32871($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='',$id='',$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__f7bada4d782e2c86e21f62a7fec5c986($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
							<ul>
								<li>
									...
									".$this->__f__de3b2f49812dcd491fb29320d2c32871($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data,$id,$_data)."									</select>
...
function __f__110f95955f8f7fbc152176cfc011f5a4($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__9117cf02438f0b0a3d1d28c4abdc10a1($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
			" . (($app == 'forums') ? ("<div id='app_filter_{$app}'>
				...
				" . ((count($data['sortDropDown'])) ? ("" . ((is_array($data['sortDropIn']) AND count( $data['sortDropIn'] )) ? ("
						".$this->__f__f7bada4d782e2c86e21f62a7fec5c986($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data)."					") : ("<div class='ipsField'>
							...
							<select name='search_app_filters[$app][sortKey]' id='search_sort_by_{$app}' class='input_select' style='width:auto'>
								".$this->__f__110f95955f8f7fbc152176cfc011f5a4($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data)."							</select>
...
{
$count_47c865d249a2e9344331b789b65da0b7 = is_array($this->functionData['searchResults']) ? count($this->functionData['searchResults']) : 0;
$this->functionData['searchResults'][$count_47c865d249a2e9344331b789b65da0b7]['results'] = $results;
$this->functionData['searchResults'][$count_47c865d249a2e9344331b789b65da0b7]['titlesOnly'] = $titlesOnly;
}
...
$IPBHTML .= "<div id='search_results'>
	<ol>
		" . ((is_array($results) && count($results)) ? ("
			".$this->__f__383fa0f30191a7bfc6b8b0768f124c13($results,$titlesOnly)."		") : ("")) . "
	</ol>
</div>";
return $IPBHTML;
}
...
function __f__383fa0f30191a7bfc6b8b0768f124c13($results, $titlesOnly)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $results as $result )
...
{
$count_bc04da1e70ef0f607d29a9a256e573df = is_array($this->functionData['searchResultsAsForum']) ? count($this->functionData['searchResultsAsForum']) : 0;
$this->functionData['searchResultsAsForum'][$count_bc04da1e70ef0f607d29a9a256e573df]['results'] = $results;
$this->functionData['searchResultsAsForum'][$count_bc04da1e70ef0f607d29a9a256e573df]['titlesOnly'] = $titlesOnly;
}
...
{
$count_a08a861f77ea3db1dc129b082c0173bd = is_array($this->functionData['searchResultsWrapper']) ? count($this->functionData['searchResultsWrapper']) : 0;
$this->functionData['searchResultsWrapper'][$count_a08a861f77ea3db1dc129b082c0173bd]['results'] = $results;
$this->functionData['searchResultsWrapper'][$count_a08a861f77ea3db1dc129b082c0173bd]['sortDropDown'] = $sortDropDown;
$this->functionData['searchResultsWrapper'][$count_a08a861f77ea3db1dc129b082c0173bd]['sortIn'] = $sortIn;
$this->functionData['searchResultsWrapper'][$count_a08a861f77ea3db1dc129b082c0173bd]['pagination'] = $pagination;
$this->functionData['searchResultsWrapper'][$count_a08a861f77ea3db1dc129b082c0173bd]['total'] = $total;
$this->functionData['searchResultsWrapper'][$count_a08a861f77ea3db1dc129b082c0173bd]['showing'] = $showing;
$this->functionData['searchResultsWrapper'][$count_a08a861f77ea3db1dc129b082c0173bd]['search_term'] = $search_term;
$this->functionData['searchResultsWrapper'][$count_a08a861f77ea3db1dc129b082c0173bd]['url_string'] = $url_string;
$this->functionData['searchResultsWrapper'][$count_a08a861f77ea3db1dc129b082c0173bd]['current_key'] = $current_key;
$this->functionData['searchResultsWrapper'][$count_a08a861f77ea3db1dc129b082c0173bd]['removed_search_terms'] = $removed_search_terms;
$this->functionData['searchResultsWrapper'][$count_a08a861f77ea3db1dc129b082c0173bd]['limited'] = $limited;
$this->functionData['searchResultsWrapper'][$count_a08a861f77ea3db1dc129b082c0173bd]['wasLimited'] = $wasLimited;
$this->functionData['searchResultsWrapper'][$count_a08a861f77ea3db1dc129b082c0173bd]['search_tags'] = $search_tags;
}
...
{
$count_2359d5d6c315230d09fe24d96bfc7418 = is_array($this->functionData['searchRowGenericFormat']) ? count($this->functionData['searchRowGenericFormat']) : 0;
$this->functionData['searchRowGenericFormat'][$count_2359d5d6c315230d09fe24d96bfc7418]['r'] = $r;
$this->functionData['searchRowGenericFormat'][$count_2359d5d6c315230d09fe24d96bfc7418]['resultAsTitle'] = $resultAsTitle;
}
$IPBHTML .= "<div class='result_info'>
...
{
$count_b8fe84a1d52a28a0e51352f38046a82f = is_array($this->functionData['topicPostSearchResultAsForum']) ? count($this->functionData['topicPostSearchResultAsForum']) : 0;
$this->functionData['topicPostSearchResultAsForum'][$count_b8fe84a1d52a28a0e51352f38046a82f]['data'] = $data;
$this->functionData['topicPostSearchResultAsForum'][$count_b8fe84a1d52a28a0e51352f38046a82f]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_6cfaed8d1a6e2e99bb0c057e05d2f7cd = is_array($this->functionData['userPostsView']) ? count($this->functionData['userPostsView']) : 0;
$this->functionData['userPostsView'][$count_6cfaed8d1a6e2e99bb0c057e05d2f7cd]['results'] = $results;
$this->functionData['userPostsView'][$count_6cfaed8d1a6e2e99bb0c057e05d2f7cd]['pagination'] = $pagination;
$this->functionData['userPostsView'][$count_6cfaed8d1a6e2e99bb0c057e05d2f7cd]['total'] = $total;
$this->functionData['userPostsView'][$count_6cfaed8d1a6e2e99bb0c057e05d2f7cd]['member'] = $member;
$this->functionData['userPostsView'][$count_6cfaed8d1a6e2e99bb0c057e05d2f7cd]['limited'] = $limited;
$this->functionData['userPostsView'][$count_6cfaed8d1a6e2e99bb0c057e05d2f7cd]['wasLimited'] = $wasLimited;
$this->functionData['userPostsView'][$count_6cfaed8d1a6e2e99bb0c057e05d2f7cd]['beginTime'] = $beginTime;
$this->functionData['userPostsView'][$count_6cfaed8d1a6e2e99bb0c057e05d2f7cd]['sortIn'] = $sortIn;
$this->functionData['userPostsView'][$count_6cfaed8d1a6e2e99bb0c057e05d2f7cd]['sortDropDown'] = $sortDropDown;
}
