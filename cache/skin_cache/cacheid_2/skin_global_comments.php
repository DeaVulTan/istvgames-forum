...
{
$count_19c71a5d41ac5585768d8267da8a3f46 = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_19c71a5d41ac5585768d8267da8a3f46]['r'] = $r;
$this->functionData['comment'][$count_19c71a5d41ac5585768d8267da8a3f46]['parent'] = $parent;
$this->functionData['comment'][$count_19c71a5d41ac5585768d8267da8a3f46]['settings'] = $settings;
}
...
{
$count_77d9a3ad5e4b12ebea0f73c9b09bed4c = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_77d9a3ad5e4b12ebea0f73c9b09bed4c]['r'] = $r;
$this->functionData['commentHidden'][$count_77d9a3ad5e4b12ebea0f73c9b09bed4c]['parent'] = $parent;
$this->functionData['commentHidden'][$count_77d9a3ad5e4b12ebea0f73c9b09bed4c]['settings'] = $settings;
}
...
{
$count_0eb2c490dc1bde2a26aab3d096125d13 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_0eb2c490dc1bde2a26aab3d096125d13]['comments'] = $comments;
$this->functionData['commentsList'][$count_0eb2c490dc1bde2a26aab3d096125d13]['settings'] = $settings;
$this->functionData['commentsList'][$count_0eb2c490dc1bde2a26aab3d096125d13]['pages'] = $pages;
$this->functionData['commentsList'][$count_0eb2c490dc1bde2a26aab3d096125d13]['parent'] = $parent;
$this->functionData['commentsList'][$count_0eb2c490dc1bde2a26aab3d096125d13]['preReply'] = $preReply;
}
...
<div class='comment_wrap' id='comment_wrap'>
	".$this->__f__dc7fbe5fb028f71932c3aae7c9005719($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($parent['_canComment']) ? ("
...
function __f__dc7fbe5fb028f71932c3aae7c9005719($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a6b5d284ce2f7d510015002795b7c3b5 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_a6b5d284ce2f7d510015002795b7c3b5]['comment'] = $comment;
$this->functionData['form'][$count_a6b5d284ce2f7d510015002795b7c3b5]['parent'] = $parent;
$this->functionData['form'][$count_a6b5d284ce2f7d510015002795b7c3b5]['editor'] = $editor;
$this->functionData['form'][$count_a6b5d284ce2f7d510015002795b7c3b5]['settings'] = $settings;
$this->functionData['form'][$count_a6b5d284ce2f7d510015002795b7c3b5]['errors'] = $errors;
$this->functionData['form'][$count_a6b5d284ce2f7d510015002795b7c3b5]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
