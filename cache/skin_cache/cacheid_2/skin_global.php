...
{
$count_8bb2a98285a73d271249edd15f32802c = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_8bb2a98285a73d271249edd15f32802c]['html'] = $html;
$this->functionData['globalTemplate'][$count_8bb2a98285a73d271249edd15f32802c]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_8bb2a98285a73d271249edd15f32802c]['css'] = $css;
$this->functionData['globalTemplate'][$count_8bb2a98285a73d271249edd15f32802c]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_8bb2a98285a73d271249edd15f32802c]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_8bb2a98285a73d271249edd15f32802c]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_8bb2a98285a73d271249edd15f32802c]['items'] = $items;
$this->functionData['globalTemplate'][$count_8bb2a98285a73d271249edd15f32802c]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_8bb2a98285a73d271249edd15f32802c]['stats'] = $stats;
}
						...
						<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "{$this->settings['query_string_formatted']}", "public",'' ), "", "" ) . "\" method=\"post\">
							<fieldset>
								...
								<select name=\"langid\" id='newLang'>
									".$this->__f__8893189c93d97f5cbc43de1a467f2465($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								</select>
...
function __f__8893189c93d97f5cbc43de1a467f2465($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_46904143431c5b334e63c91d702b42ca = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_46904143431c5b334e63c91d702b42ca]['css'] = $css;
}

$this->minify = array();
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__9c61582066dded69b552362e1965b825($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__0e320c1877a403da2ac2f8322055ddf9($css)."") : ("")) . "";
return $IPBHTML;
}


function __f__9c61582066dded69b552362e1965b825($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0e320c1877a403da2ac2f8322055ddf9($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_255beb817e2dd5572109b3a16938f354 = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_255beb817e2dd5572109b3a16938f354]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__e400b2abcde47b4b4b335d3d6e0c285a($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__b51b02cc41577ca08a0331350b92ec46($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e400b2abcde47b4b4b335d3d6e0c285a($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__b51b02cc41577ca08a0331350b92ec46($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_fa9a97a7f41b4fd88c824c8fa4261c09 = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_fa9a97a7f41b4fd88c824c8fa4261c09]['jsModules'] = $jsModules;
}
...
{
$count_d49cc4d20bcc7723138cfb8c4e61fd10 = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_d49cc4d20bcc7723138cfb8c4e61fd10]['metaTags'] = $metaTags;
}
$IPBHTML .= "" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__ffd685174e16558da8ac5df8a152e1e9($metaTags)."") : ("")) . "
<meta property=\"og:image\" content=\"{$this->settings['meta_imagesrc']}\"/>";
return $IPBHTML;
}


function __f__7b123a2beef40b17a2b29aa242aabbde($metaTags,$tag='',$id='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ffd685174e16558da8ac5df8a152e1e9($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $metaTags as $tag => $id )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__7b123a2beef40b17a2b29aa242aabbde($metaTags,$tag,$id)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_656dd3928943c4fb073c020fac32db43 = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__77077be1a5240dbcb122915673236f23()."<script type='text/javascript'>
	var isRTL	= false;
	var rtlIe	= '';
	var rtlFull	= '';
</script>
...
function __f__77077be1a5240dbcb122915673236f23()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2a6de8e7b5911c257c82e029be892e1f = is_array($this->functionData['includeVars']) ? count($this->functionData['includeVars']) : 0;
$this->functionData['includeVars'][$count_2a6de8e7b5911c257c82e029be892e1f]['header_items'] = $header_items;
}
...
{
$count_7a752040c4673a02a3ec2929fcd58f9f = is_array($this->functionData['inlineLogin']) ? count($this->functionData['inlineLogin']) : 0;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
...
{
$count_1604f4df751c08dd9b1b1beac6498ab4 = is_array($this->functionData['liveEditJs']) ? count($this->functionData['liveEditJs']) : 0;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
...
{
$count_4c9ef3607455b2d17eda731e80786611 = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_4c9ef3607455b2d17eda731e80786611]['data'] = $data;
}
...
{
$count_f02b831dbcecf971336a9c37dc309d6a = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_f02b831dbcecf971336a9c37dc309d6a]['work'] = $work;
$this->functionData['paginationTemplate'][$count_f02b831dbcecf971336a9c37dc309d6a]['data'] = $data;
}
...
{
$count_715c407864d0abcc0a2d68dee036e8ff = is_array($this->functionData['quickSearch']) ? count($this->functionData['quickSearch']) : 0;
}
...
{
$count_7bde6c402924e87b9dece2cc0664241a = is_array($this->functionData['shareLinks']) ? count($this->functionData['shareLinks']) : 0;
$this->functionData['shareLinks'][$count_7bde6c402924e87b9dece2cc0664241a]['links'] = $links;
$this->functionData['shareLinks'][$count_7bde6c402924e87b9dece2cc0664241a]['title'] = $title;
$this->functionData['shareLinks'][$count_7bde6c402924e87b9dece2cc0664241a]['url'] = $url;
$this->functionData['shareLinks'][$count_7bde6c402924e87b9dece2cc0664241a]['cssClass'] = $cssClass;
}
$IPBHTML .= "&nbsp;";
return $IPBHTML;
}
...
{
$count_add7e03df69185e61649cd85129e4e8d = is_array($this->functionData['signature_separator']) ? count($this->functionData['signature_separator']) : 0;
$this->functionData['signature_separator'][$count_add7e03df69185e61649cd85129e4e8d]['sig'] = $sig;
$this->functionData['signature_separator'][$count_add7e03df69185e61649cd85129e4e8d]['author_id'] = $author_id;
$this->functionData['signature_separator'][$count_add7e03df69185e61649cd85129e4e8d]['can_ignore'] = $can_ignore;
}
...
{
$count_15579e83e466e042115d58d5f67a748d = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_15579e83e466e042115d58d5f67a748d]['member'] = $member;
}
...
{
$count_f6083775e62a548d253722e7d39d6294 = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_f6083775e62a548d253722e7d39d6294]['author'] = $author;
$this->functionData['userInfoPane'][$count_f6083775e62a548d253722e7d39d6294]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_f6083775e62a548d253722e7d39d6294]['options'] = $options;
}
$IPBHTML .= "<ul class='user_details'>
	...
	<ul class='user_fields'>
		...
		" . (($author['custom_fields'] != "") ? ("
			".$this->__f__732f8fed7a62f542ed8fac43457ecbdc($author,$contentid,$options)."		") : ("")) . "
	</ul>
...
function __f__e57498ca67b74e8dc5374f5f56fe64c6($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__732f8fed7a62f542ed8fac43457ecbdc($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__e57498ca67b74e8dc5374f5f56fe64c6($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_4171c9138dd791f011aa41e19d251b0b = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_4171c9138dd791f011aa41e19d251b0b]['member'] = $member;
}
...
{
$count_3c7d5262667f4f13ad5d980175d1e7d0 = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_3c7d5262667f4f13ad5d980175d1e7d0]['warning'] = $warning;
$this->functionData['warnDetails'][$count_3c7d5262667f4f13ad5d980175d1e7d0]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__7af52cb46eeb4e59f53571b78d118dc2($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__7af52cb46eeb4e59f53571b78d118dc2($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
