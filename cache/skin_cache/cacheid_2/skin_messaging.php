...
{
$count_8ea5aae1cf4e19fa3a549e2781601ddf = is_array($this->functionData['messengerDisabled']) ? count($this->functionData['messengerDisabled']) : 0;
}
...
{
$count_9fd0f97ce6ea54bc9894cae6028148b0 = is_array($this->functionData['messengerTemplate']) ? count($this->functionData['messengerTemplate']) : 0;
$this->functionData['messengerTemplate'][$count_9fd0f97ce6ea54bc9894cae6028148b0]['html'] = $html;
$this->functionData['messengerTemplate'][$count_9fd0f97ce6ea54bc9894cae6028148b0]['jumpmenu'] = $jumpmenu;
$this->functionData['messengerTemplate'][$count_9fd0f97ce6ea54bc9894cae6028148b0]['dirData'] = $dirData;
$this->functionData['messengerTemplate'][$count_9fd0f97ce6ea54bc9894cae6028148b0]['totalData'] = $totalData;
$this->functionData['messengerTemplate'][$count_9fd0f97ce6ea54bc9894cae6028148b0]['topicParticipants'] = $topicParticipants;
$this->functionData['messengerTemplate'][$count_9fd0f97ce6ea54bc9894cae6028148b0]['inlineError'] = $inlineError;
$this->functionData['messengerTemplate'][$count_9fd0f97ce6ea54bc9894cae6028148b0]['deletedTopic'] = $deletedTopic;
}
$IPBHTML .= "<div class='master_list'>
	...
	" . ((is_array( $topicParticipants ) and count( $topicParticipants )) ? ("
		...
		".$this->__f__d007f3eb8f12f70c985927dbe142f166($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."	") : ("")) . "				
	...
	" . (($this->settings['_hideFolders'] != 1) ? ("<h3>{$this->lang->words['folders']} " . (($this->memberData['g_max_messages'] > 0) ? ("<span class='subtext'>{$totalData['full_percent']}% {$this->lang->words['full']}</span>") : ("")) . "</h3>
		...
		" . ((count($dirData)) ? ("
			".$this->__f__6a77b780148f07ce5e7d1119d0366f74($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."		") : ("")) . "") : ("")) . "
</div>";
return $IPBHTML;
}


function __f__d007f3eb8f12f70c985927dbe142f166($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__6a77b780148f07ce5e7d1119d0366f74($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_13f8bd2f57f1a379cb8a29cd7112b80e = is_array($this->functionData['sendNewPersonalTopicForm']) ? count($this->functionData['sendNewPersonalTopicForm']) : 0;
$this->functionData['sendNewPersonalTopicForm'][$count_13f8bd2f57f1a379cb8a29cd7112b80e]['displayData'] = $displayData;
}
...
{
$count_008ee12f3fea83233f90570235b7bfd6 = is_array($this->functionData['sendReplyForm']) ? count($this->functionData['sendReplyForm']) : 0;
$this->functionData['sendReplyForm'][$count_008ee12f3fea83233f90570235b7bfd6]['displayData'] = $displayData;
}
$IPBHTML .= "" . (($this->settings['_hideFolders'] = 1) ? ("") : ("")) . "
...
{
$count_6c110b571e2fd50a17318d70c33ae4fe = is_array($this->functionData['showConversation']) ? count($this->functionData['showConversation']) : 0;
$this->functionData['showConversation'][$count_6c110b571e2fd50a17318d70c33ae4fe]['topic'] = $topic;
$this->functionData['showConversation'][$count_6c110b571e2fd50a17318d70c33ae4fe]['replies'] = $replies;
$this->functionData['showConversation'][$count_6c110b571e2fd50a17318d70c33ae4fe]['members'] = $members;
$this->functionData['showConversation'][$count_6c110b571e2fd50a17318d70c33ae4fe]['jump'] = $jump;
}
$IPBHTML .= "<div class='controls'>
	...
	{$topic['_pages']}
</div>".$this->__f__f5f1d3ded1059c0c7b083de7603d8f3d($topic,$replies,$members,$jump)."<div class='controls'>
	<div class='buttons'>
...
function __f__f5f1d3ded1059c0c7b083de7603d8f3d($topic, $replies, $members, $jump="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ec301f21141a0e4dfdb1500dd78c6064 = is_array($this->functionData['showConversationForArchive']) ? count($this->functionData['showConversationForArchive']) : 0;
$this->functionData['showConversationForArchive'][$count_ec301f21141a0e4dfdb1500dd78c6064]['topic'] = $topic;
$this->functionData['showConversationForArchive'][$count_ec301f21141a0e4dfdb1500dd78c6064]['replies'] = $replies;
$this->functionData['showConversationForArchive'][$count_ec301f21141a0e4dfdb1500dd78c6064]['members'] = $members;
}
...
$IPBHTML .= "<html>
	...
	<body>
		...
		<br />
		<br />
		".$this->__f__a900b89c35b7d1f811bab5c19cbd6e01($topic,$replies,$members)."	</body>
</html>";
return $IPBHTML;
}


function __f__a900b89c35b7d1f811bab5c19cbd6e01($topic, $replies, $members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $replies as $msg_id => $msg )
...
{
$count_9a9de201cd2d781c29a3c25110bfe78a = is_array($this->functionData['showFolder']) ? count($this->functionData['showFolder']) : 0;
$this->functionData['showFolder'][$count_9a9de201cd2d781c29a3c25110bfe78a]['messages'] = $messages;
$this->functionData['showFolder'][$count_9a9de201cd2d781c29a3c25110bfe78a]['dirname'] = $dirname;
$this->functionData['showFolder'][$count_9a9de201cd2d781c29a3c25110bfe78a]['pages'] = $pages;
$this->functionData['showFolder'][$count_9a9de201cd2d781c29a3c25110bfe78a]['currentFolderID'] = $currentFolderID;
$this->functionData['showFolder'][$count_9a9de201cd2d781c29a3c25110bfe78a]['jumpFolderHTML'] = $jumpFolderHTML;
}
...
" . ((count( $messages )) ? ("
		".$this->__f__4f56f59deedf45b2ff99320ba07f683a($messages,$dirname,$pages,$currentFolderID,$jumpFolderHTML)."") : ("
...
function __f__4f56f59deedf45b2ff99320ba07f683a($messages, $dirname, $pages, $currentFolderID, $jumpFolderHTML)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_49d63eca7cc0f2e322a9394c5277af26 = is_array($this->functionData['showSearchResults']) ? count($this->functionData['showSearchResults']) : 0;
$this->functionData['showSearchResults'][$count_49d63eca7cc0f2e322a9394c5277af26]['messages'] = $messages;
$this->functionData['showSearchResults'][$count_49d63eca7cc0f2e322a9394c5277af26]['pages'] = $pages;
$this->functionData['showSearchResults'][$count_49d63eca7cc0f2e322a9394c5277af26]['error'] = $error;
}
...
<div id='message_list'>
		<table class='ipb_table' id='message_table'>
			...
			" . ((count( $messages )) ? ("
								".$this->__f__dd1e595d27cb5d2fb0731812784f9fdd($messages,$pages,$error)."			") : ("
				<tr>
...
function __f__dd1e595d27cb5d2fb0731812784f9fdd($messages, $pages, $error)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $messages as $id => $msg )
