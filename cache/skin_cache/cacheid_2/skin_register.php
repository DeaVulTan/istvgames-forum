...
{
$count_0920460342eee9285bf304f1059aa094 = is_array($this->functionData['completePartialLogin']) ? count($this->functionData['completePartialLogin']) : 0;
$this->functionData['completePartialLogin'][$count_0920460342eee9285bf304f1059aa094]['mid'] = $mid;
$this->functionData['completePartialLogin'][$count_0920460342eee9285bf304f1059aa094]['key'] = $key;
$this->functionData['completePartialLogin'][$count_0920460342eee9285bf304f1059aa094]['custom_fields'] = $custom_fields;
$this->functionData['completePartialLogin'][$count_0920460342eee9285bf304f1059aa094]['errors'] = $errors;
$this->functionData['completePartialLogin'][$count_0920460342eee9285bf304f1059aa094]['reg'] = $reg;
$this->functionData['completePartialLogin'][$count_0920460342eee9285bf304f1059aa094]['userFromService'] = $userFromService;
}
	...
	<div class='post_form'>
		...
		" . (($custom_fields != '') ? ("<fieldset class='row1'>
				...
				" . ((is_array( $custom_fields['required'] ) && count( $custom_fields['required'] )) ? ("
					".$this->__f__7903068140a4fdaf8add1b4484336ae2($mid,$key,$custom_fields,$errors,$reg,$userFromService)."				") : ("")) . "
				
				" . ((is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] )) ? ("
					".$this->__f__d64bfa2930ee17d6dc7fbfb88691af5b($mid,$key,$custom_fields,$errors,$reg,$userFromService)."				") : ("")) . "
			</fieldset>") : ("")) . "
...
function __f__7903068140a4fdaf8add1b4484336ae2($mid="",$key="",$custom_fields="",$errors="", $reg="", $userFromService=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__d64bfa2930ee17d6dc7fbfb88691af5b($mid="",$key="",$custom_fields="",$errors="", $reg="", $userFromService=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e67fbc75458d74067b6e2278aa334cdb = is_array($this->functionData['lostPasswordForm']) ? count($this->functionData['lostPasswordForm']) : 0;
$this->functionData['lostPasswordForm'][$count_e67fbc75458d74067b6e2278aa334cdb]['errors'] = $errors;
}
...
{
$count_22e3b4fa32957300ef5c4bc929208e55 = is_array($this->functionData['registerCoppaForm']) ? count($this->functionData['registerCoppaForm']) : 0;
}
$IPBHTML .= "<html>
	<head>
...
{
$count_fa96920a95287ace278ca183c6536cd9 = is_array($this->functionData['registerCoppaStart']) ? count($this->functionData['registerCoppaStart']) : 0;
}
		...
		<div class='row post line_spacing'>
			...
			<br /><br />
				<select name='month' id='coppa_bday_m'>
					".$this->__f__386cb61e0b04e8190162c0f080d4235b()."				</select>
				&nbsp;
				<select name='day' id='coppa_bday_d'>
					".$this->__f__c63c4519c264f10398b487cd454bc5b2()."				</select>
				&nbsp;
				<select name='year' id='coppa_bday_y'>
					".$this->__f__0e513c0e948ccc94873b77b8043c3a50()."				</select>
			</div>
		<div class='submit'>
...
function __f__386cb61e0b04e8190162c0f080d4235b()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c63c4519c264f10398b487cd454bc5b2()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0e513c0e948ccc94873b77b8043c3a50()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b41c6bf90ee8baf3e0f1085b7495616c = is_array($this->functionData['registerForm']) ? count($this->functionData['registerForm']) : 0;
$this->functionData['registerForm'][$count_b41c6bf90ee8baf3e0f1085b7495616c]['general_errors'] = $general_errors;
$this->functionData['registerForm'][$count_b41c6bf90ee8baf3e0f1085b7495616c]['data'] = $data;
$this->functionData['registerForm'][$count_b41c6bf90ee8baf3e0f1085b7495616c]['inline_errors'] = $inline_errors;
$this->functionData['registerForm'][$count_b41c6bf90ee8baf3e0f1085b7495616c]['time_select'] = $time_select;
$this->functionData['registerForm'][$count_b41c6bf90ee8baf3e0f1085b7495616c]['custom_fields'] = $custom_fields;
$this->functionData['registerForm'][$count_b41c6bf90ee8baf3e0f1085b7495616c]['nexusFields'] = $nexusFields;
$this->functionData['registerForm'][$count_b41c6bf90ee8baf3e0f1085b7495616c]['nexusStates'] = $nexusStates;
}
	...
	") : ("<div class='master_list'>
			...
			" . ((is_array( $general_errors ) && count( $general_errors )) ? ("
				<div class='message error'>
					...
					".$this->__f__79024d1425db5f8b0203e991e9b00ce6($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."				</div>
			") : ("")) . "
			...
			<form class='ipsForm_vertical' action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=global&amp;section=register", "public",'' ), "", "" ) . "\" method=\"post\" name=\"REG\" id='register'>
				...
				" . ((( is_array( $custom_fields['required'] ) && count( $custom_fields['required'] ) ) || ( is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] ) )) ? ("<div class='row line_spacing'>
						" . ((is_array( $custom_fields['required'] ) && count( $custom_fields['required'] )) ? ("
							".$this->__f__10f995153dbe86198f9d50d1be64f955($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."						") : ("")) . "
				
						" . ((is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] )) ? ("
							".$this->__f__d217d812810f461a0ac534ac58dc586a($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."						") : ("")) . "
						<!--IBF.MODULES.EXTRA-->
					</div>") : ("")) . "
...
function __f__79024d1425db5f8b0203e991e9b00ce6($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__10f995153dbe86198f9d50d1be64f955($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $custom_fields['required'] as $_field )
...
function __f__d217d812810f461a0ac534ac58dc586a($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $custom_fields['optional'] as $_field )
...
{
$count_6740bee7f1ba4536daeb58f03cf854e2 = is_array($this->functionData['showLostpassForm']) ? count($this->functionData['showLostpassForm']) : 0;
$this->functionData['showLostpassForm'][$count_6740bee7f1ba4536daeb58f03cf854e2]['error'] = $error;
}
...
{
$count_177d90c900672ce483cb7a9520f5ef0e = is_array($this->functionData['showRevalidateForm']) ? count($this->functionData['showRevalidateForm']) : 0;
$this->functionData['showRevalidateForm'][$count_177d90c900672ce483cb7a9520f5ef0e]['name'] = $name;
$this->functionData['showRevalidateForm'][$count_177d90c900672ce483cb7a9520f5ef0e]['error'] = $error;
}
$IPBHTML .= "<h2>{$this->lang->words['rv_title']}</h2>
" . (($error) ? ("
