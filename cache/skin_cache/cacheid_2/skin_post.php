...
{
$count_b7e4bfb5e109a92d302c87bfbfc6a085 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_b7e4bfb5e109a92d302c87bfbfc6a085]['data'] = $data;
}
...
{
$count_a1aa9b42995b657ee45fb90545b84fdd = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_a1aa9b42995b657ee45fb90545b84fdd]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_a1aa9b42995b657ee45fb90545b84fdd]['form'] = $form;
}
...
{
$count_71a9a2877c0eec7c3df7168a61c56639 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_71a9a2877c0eec7c3df7168a61c56639]['data'] = $data;
}
...
{
$count_71c80386530385ea941a84f0f490702a = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_71c80386530385ea941a84f0f490702a]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__b0acda1bbaceffa474d0887d1f36ab6c($posts)."") : ("")) . "
<p class='submit'>
...
function __f__b0acda1bbaceffa474d0887d1f36ab6c($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_235bd7ed55375de47381024e29e5313a = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_235bd7ed55375de47381024e29e5313a]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_235bd7ed55375de47381024e29e5313a]['type'] = $type;
$this->functionData['uploadForm'][$count_235bd7ed55375de47381024e29e5313a]['stats'] = $stats;
$this->functionData['uploadForm'][$count_235bd7ed55375de47381024e29e5313a]['id'] = $id;
$this->functionData['uploadForm'][$count_235bd7ed55375de47381024e29e5313a]['forum_id'] = $forum_id;
}
