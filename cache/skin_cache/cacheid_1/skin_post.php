...
{
$count_6afcd7a258291796c9c8c86b0fc80511 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_6afcd7a258291796c9c8c86b0fc80511]['data'] = $data;
}
...
{
$count_2768061da75876bf47ddbdb0ef47f2e7 = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_2768061da75876bf47ddbdb0ef47f2e7]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_2768061da75876bf47ddbdb0ef47f2e7]['form'] = $form;
}
...
{
$count_87a3c20b67fd1d14fc47bd90a6f03f1b = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_87a3c20b67fd1d14fc47bd90a6f03f1b]['data'] = $data;
}
...
{
$count_b0be6e77dfcf36fe44c1d4903f97836a = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_b0be6e77dfcf36fe44c1d4903f97836a]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__bdc9616f93fdd1a73ed9ce1caae9fceb($posts)."") : ("")) . "
<p class='submit'>
...
function __f__bdc9616f93fdd1a73ed9ce1caae9fceb($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_12e4e6231b7c7e3728360a234cb2d6e1 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_12e4e6231b7c7e3728360a234cb2d6e1]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_12e4e6231b7c7e3728360a234cb2d6e1]['type'] = $type;
$this->functionData['uploadForm'][$count_12e4e6231b7c7e3728360a234cb2d6e1]['stats'] = $stats;
$this->functionData['uploadForm'][$count_12e4e6231b7c7e3728360a234cb2d6e1]['id'] = $id;
$this->functionData['uploadForm'][$count_12e4e6231b7c7e3728360a234cb2d6e1]['forum_id'] = $forum_id;
}
