...
{
$count_fb47b5fac88d3ccfaeefc0a60dcd7a98 = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_fb47b5fac88d3ccfaeefc0a60dcd7a98]['r'] = $r;
$this->functionData['comment'][$count_fb47b5fac88d3ccfaeefc0a60dcd7a98]['parent'] = $parent;
$this->functionData['comment'][$count_fb47b5fac88d3ccfaeefc0a60dcd7a98]['settings'] = $settings;
}
...
{
$count_3fb590e47ba03fd13c953daa45b18757 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_3fb590e47ba03fd13c953daa45b18757]['r'] = $r;
$this->functionData['commentHidden'][$count_3fb590e47ba03fd13c953daa45b18757]['parent'] = $parent;
$this->functionData['commentHidden'][$count_3fb590e47ba03fd13c953daa45b18757]['settings'] = $settings;
}
...
{
$count_d5f3b38b15d4d220e31dc507a7902ca9 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_d5f3b38b15d4d220e31dc507a7902ca9]['comments'] = $comments;
$this->functionData['commentsList'][$count_d5f3b38b15d4d220e31dc507a7902ca9]['settings'] = $settings;
$this->functionData['commentsList'][$count_d5f3b38b15d4d220e31dc507a7902ca9]['pages'] = $pages;
$this->functionData['commentsList'][$count_d5f3b38b15d4d220e31dc507a7902ca9]['parent'] = $parent;
$this->functionData['commentsList'][$count_d5f3b38b15d4d220e31dc507a7902ca9]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__794dfb8856fef41300f90d551814b132($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__794dfb8856fef41300f90d551814b132($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_269336b10362ebe1f34b23cb3d9fd2ca = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_269336b10362ebe1f34b23cb3d9fd2ca]['comment'] = $comment;
$this->functionData['form'][$count_269336b10362ebe1f34b23cb3d9fd2ca]['parent'] = $parent;
$this->functionData['form'][$count_269336b10362ebe1f34b23cb3d9fd2ca]['editor'] = $editor;
$this->functionData['form'][$count_269336b10362ebe1f34b23cb3d9fd2ca]['settings'] = $settings;
$this->functionData['form'][$count_269336b10362ebe1f34b23cb3d9fd2ca]['errors'] = $errors;
$this->functionData['form'][$count_269336b10362ebe1f34b23cb3d9fd2ca]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
