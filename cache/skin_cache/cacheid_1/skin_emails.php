...
{
$count_abe440f6bef6255aa015c16f5c93740c = is_array($this->functionData['forward_form']) ? count($this->functionData['forward_form']) : 0;
$this->functionData['forward_form'][$count_abe440f6bef6255aa015c16f5c93740c]['title'] = $title;
$this->functionData['forward_form'][$count_abe440f6bef6255aa015c16f5c93740c]['text'] = $text;
$this->functionData['forward_form'][$count_abe440f6bef6255aa015c16f5c93740c]['lang'] = $lang;
$this->functionData['forward_form'][$count_abe440f6bef6255aa015c16f5c93740c]['captchaHTML'] = $captchaHTML;
$this->functionData['forward_form'][$count_abe440f6bef6255aa015c16f5c93740c]['msg'] = $msg;
}
					...
					<li class='ipsField clear'>
						...
						<p class='ipsField_content'>
							<select name='lang' class='input_select' id='to_lang'>
								".$this->__f__6d3e69fd5c9f44bc2366174c17849fc8($title,$text,$lang,$captchaHTML,$msg)."							</select>
						</p>
					</li>
				")) . "
				<li class='ipsField clear'>
...
function __f__6d3e69fd5c9f44bc2366174c17849fc8($title="",$text="",$lang="", $captchaHTML='', $msg='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
