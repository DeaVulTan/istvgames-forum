...
{
$count_db055649051dd4df8b50bd892d5ec006 = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_db055649051dd4df8b50bd892d5ec006]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_db055649051dd4df8b50bd892d5ec006]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_db055649051dd4df8b50bd892d5ec006]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_db055649051dd4df8b50bd892d5ec006]['extraData'] = $extraData;
}
...
{
$count_e5054bb2d46f5c346aaf4bfc1d4177a8 = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_e5054bb2d46f5c346aaf4bfc1d4177a8]['formField'] = $formField;
$this->functionData['editor'][$count_e5054bb2d46f5c346aaf4bfc1d4177a8]['content'] = $content;
$this->functionData['editor'][$count_e5054bb2d46f5c346aaf4bfc1d4177a8]['options'] = $options;
$this->functionData['editor'][$count_e5054bb2d46f5c346aaf4bfc1d4177a8]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_e5054bb2d46f5c346aaf4bfc1d4177a8]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_e5054bb2d46f5c346aaf4bfc1d4177a8]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_e5054bb2d46f5c346aaf4bfc1d4177a8]['bbcodeVersion'] = $bbcodeVersion;
$this->functionData['editor'][$count_e5054bb2d46f5c346aaf4bfc1d4177a8]['showEditor'] = $showEditor;
}
...
{
$count_f9bb09235122262d8fd7747dd222a585 = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_f9bb09235122262d8fd7747dd222a585]['options'] = $options;
$this->functionData['editorLoadJs'][$count_f9bb09235122262d8fd7747dd222a585]['inlineLoad'] = $inlineLoad;
}
...
{
$count_aac8160219655c85c8610dc3cec81bc2 = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_aac8160219655c85c8610dc3cec81bc2]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_aac8160219655c85c8610dc3cec81bc2]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_aac8160219655c85c8610dc3cec81bc2]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_aac8160219655c85c8610dc3cec81bc2]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__f8021ac7b4ff81e36d3218a11d44ee13($rows,$pages,$app,$plugin)."		") : ("
...
function __f__f8021ac7b4ff81e36d3218a11d44ee13($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_fb53749a5a4767b31f9809a531a9df3a = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_fb53749a5a4767b31f9809a531a9df3a]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__5fb46d107db8b1f0b702f4c58651e9f9($tabs)."			</ul>
		</div>
...
function __f__5fb46d107db8b1f0b702f4c58651e9f9($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
