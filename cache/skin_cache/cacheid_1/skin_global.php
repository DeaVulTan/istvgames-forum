...
/* CACHE FILE: Generated: Sat, 24 Oct 2015 18:46:37 GMT */
...
{
$count_3b713a0ddcf23f49c95574773af0d798 = is_array($this->functionData['fcRepBar']) ? count($this->functionData['fcRepBar']) : 0;
$this->functionData['fcRepBar'][$count_3b713a0ddcf23f49c95574773af0d798]['author'] = $author;
}
...
{
$count_b2fcabdc52dd657642cee316bfabb73b = is_array($this->functionData['friendsOnline_globalmenu_frindslist']) ? count($this->functionData['friendsOnline_globalmenu_frindslist']) : 0;
$this->functionData['friendsOnline_globalmenu_frindslist'][$count_b2fcabdc52dd657642cee316bfabb73b]['active'] = $active;
$this->functionData['friendsOnline_globalmenu_frindslist'][$count_b2fcabdc52dd657642cee316bfabb73b]['actives'] = $actives;
}
...
<ul class='ipsList_withminiphoto'>
	" . ((is_array( $active ) && count( $active )) ? ("
		".$this->__f__9852f8e4f580c3d626673a75577aa63a($active,$actives)."	") : ("
...
" . (($this->settings['friendsOnline_staff_on']) ? ("<h4 class='ipsType_sectiontitle'>{$this->lang->words['staffOnline']}</h4>
	<ul class='ipsList_withminiphoto'>
		" . ((is_array( $actives ) && count( $actives )) ? ("
			".$this->__f__09daba54273e9eacfa9183152b548ead($active,$actives)."		") : ("
...
function __f__9852f8e4f580c3d626673a75577aa63a($active, $actives)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $active as $r )
...
function __f__09daba54273e9eacfa9183152b548ead($active, $actives)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5097433d771b08b00429ac1576bbc7eb = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_5097433d771b08b00429ac1576bbc7eb]['html'] = $html;
$this->functionData['globalTemplate'][$count_5097433d771b08b00429ac1576bbc7eb]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_5097433d771b08b00429ac1576bbc7eb]['css'] = $css;
$this->functionData['globalTemplate'][$count_5097433d771b08b00429ac1576bbc7eb]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_5097433d771b08b00429ac1576bbc7eb]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_5097433d771b08b00429ac1576bbc7eb]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_5097433d771b08b00429ac1576bbc7eb]['items'] = $items;
$this->functionData['globalTemplate'][$count_5097433d771b08b00429ac1576bbc7eb]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_5097433d771b08b00429ac1576bbc7eb]['stats'] = $stats;
}
...
" . ( method_exists( $this->registry->getClass('output')->getTemplate('global_other'), 'hookYandexGarland' ) ? $this->registry->getClass('output')->getTemplate('global_other')->hookYandexGarland() : '' ) . "
<!-- / CYBER-SYSTEMS.ORG: Yandex Garland -->
				...
				<div class='main_width'>
					<ul class='ipsList_inline' id='community_app_menu'>
						...
						") : ("" . ((is_array($header_items['applications']) AND count($header_items['applications'])) ? ("
								".$this->__f__e1c9c73fe5fbae55a3b917cd61cf3373($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							") : ("")) . "")) . "
			...
			<div id='content' class='clearfix'>
				...
				" . ((count( $items['navigation'] )) ? ("<div id='secondary_navigation' class='clearfix'>
						<ol class='breadcrumb top ipsList_inline left'>
								...
								" . (($this->did_first=1) ? ("") : ("")) . "") : ("")) . "
							".$this->__f__da7000ddaaf9a821c4656e8827c20ee7($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."						</ol>
					</div>
					<br />") : ("")) . "
				<noscript>
				...
				<ol class='breadcrumb bottom ipsList_inline left clearfix clear'>
					" . ((count( $items['navigation'] )) ? ("						" . ((!$this->settings['remove_forums_nav'] OR ipsRegistry::$current_application == 'forums') ? ("<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "act=idx", "public",'' ), "false", "" ) . "'>{$this->settings['board_name']}</a></li>
						...
						".$this->__f__a1cc5e982531dfd74c8c93750ae2bec7($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."") : ("
						<li>&nbsp;</li>
					")) . "
							...
							" . ((count($footer_items['skin_chooser']) > 1) ? ("
								<li>
									...
									<ul id='new_skin_menucontent' class='ipbmenu_content with_checks' style='display: none'>
										".$this->__f__c7fa1ae3655240eb6e05f5b2eceec14f($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."									</ul>
								</li>
							") : ("")) . "")) . "") : ("")) . "
					" . ((! $this->member->is_not_human && count( $footer_items['lang_chooser']['options'] ) > 1) ? ("
						<li>
							...
							<ul id='new_language_menucontent' class='ipbmenu_content with_checks' style='display: none'>
								".$this->__f__46c5c78d71da559b6b70ea6b7c556fa6($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							</ul>
						</li>
					") : ("")) . "
					" . ((( ! $this->member->is_not_human ) && ( $this->memberData['member_id'] || $this->settings['topic_marking_guests'] )) ? ("
						<li>
							...
							<ul id='mark_all_read_menucontent' class='ipbmenu_content' style='display: none'>
								".$this->__f__b097430fd39b04ca3198530becbe4eab($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								<li>
...
function __f__e1c9c73fe5fbae55a3b917cd61cf3373($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__da7000ddaaf9a821c4656e8827c20ee7($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a1cc5e982531dfd74c8c93750ae2bec7($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $items['navigation'] as $idx => $data )
...
function __f__c7fa1ae3655240eb6e05f5b2eceec14f($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__46c5c78d71da559b6b70ea6b7c556fa6($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b097430fd39b04ca3198530becbe4eab($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e6a2a0ba1dc0178b186b75904a63509f = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_e6a2a0ba1dc0178b186b75904a63509f]['css'] = $css;
}

$this->minify = array();
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__c9b0c63b321a544786956deca13efef2($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__89d6496560b40f61ce370097f11d1de1($css)."") : ("")) . "<!--hook.if.skin_global.includeCSS.inlinecss.post.endif-->
<!--[if lte IE 7]>
...
function __f__c9b0c63b321a544786956deca13efef2($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__89d6496560b40f61ce370097f11d1de1($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_135377c96de77d4763471a457fac8f1b = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_135377c96de77d4763471a457fac8f1b]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__901a6a78f46194af8a0d95aad5c76659($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__ea1a2bcbece9fd375ad181006bb2c5d3($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__901a6a78f46194af8a0d95aad5c76659($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__ea1a2bcbece9fd375ad181006bb2c5d3($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_93b385e4a4a9ed0c90045da0a1acf947 = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_93b385e4a4a9ed0c90045da0a1acf947]['jsModules'] = $jsModules;
}
...
{
$count_c6e31acf71f3bfaf253d99598ff6a9dc = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_c6e31acf71f3bfaf253d99598ff6a9dc]['metaTags'] = $metaTags;
}
$IPBHTML .= "" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__921e0d35d8ad0f9d065ee875baf16ba6($metaTags)."") : ("")) . "
<meta property=\"og:image\" content=\"{$this->settings['meta_imagesrc']}\"/>";
return $IPBHTML;
}


function __f__05ddb8637ef686b3b61da15e6186e5aa($metaTags,$tag='',$id='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__921e0d35d8ad0f9d065ee875baf16ba6($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $metaTags as $tag => $id )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__05ddb8637ef686b3b61da15e6186e5aa($metaTags,$tag,$id)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_33839e3389d34ee1e36bf31d1f62fd04 = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__0169ca5721a83deff3a5e8e377904915()."" . (($this->isRtlLang AND is_file( DOC_IPS_ROOT_PATH . '/' . PUBLIC_DIRECTORY . '/style_css/' . $this->registry->output->skin['_csscacheid'] . '/ipb_rtl.css' )) ? ("
...
function __f__0169ca5721a83deff3a5e8e377904915()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_89072eb1cfdc4e8293dcb813d6672a4b = is_array($this->functionData['includeVars']) ? count($this->functionData['includeVars']) : 0;
$this->functionData['includeVars'][$count_89072eb1cfdc4e8293dcb813d6672a4b]['header_items'] = $header_items;
}
...
{
$count_af6cc8c94d4f9223336592864be4bd6b = is_array($this->functionData['inlineLogin']) ? count($this->functionData['inlineLogin']) : 0;
}
				...
				" . ((IPSLib::loginMethod_enabled('facebook') || IPSLib::loginMethod_enabled('twitter') || IPSLib::loginMethod_enabled('live')) ? ("<div class='ipsBox_notice'>
						<ul class='ipsList_inline'>
							...
							" . ((is_array($this->_formFields) AND count($this->_formFields)) ? ("
								".$this->__f__56fb8e359142d76147dc6252ceca6f9c()."							") : ("")) . "
						</ul>
					</div>") : ("")) . "
				<br />
...
function __f__56fb8e359142d76147dc6252ceca6f9c()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_71279ceaed16bcf128f64b0e51d55fc0 = is_array($this->functionData['liveEditJs']) ? count($this->functionData['liveEditJs']) : 0;
}
...
<div class='ipsBox ipsPad'>
	...
	<form action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&module=global&section=meta&do=save", "public",'' ), "", "" ) . "' method='post'>
		...
		<table class='ipb_table'>
			".$this->__f__39ee3a1de37aa68089fbef983f789ea9($tags,$url)."		</table>
		</div>
		<table class='ipb_table'>
			<tr>
...
function __f__39ee3a1de37aa68089fbef983f789ea9($tags, $url)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tags as $k => $v )
...
{
$count_92e12e0ed8bd70ecb30f09e256e7e833 = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_92e12e0ed8bd70ecb30f09e256e7e833]['data'] = $data;
}
...
{
$count_6da3d0705858bcb5ad1409c8b6d2d6cc = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_6da3d0705858bcb5ad1409c8b6d2d6cc]['work'] = $work;
$this->functionData['paginationTemplate'][$count_6da3d0705858bcb5ad1409c8b6d2d6cc]['data'] = $data;
}
$IPBHTML .= "" . (($work['pages'] > 1) ? ("<div class='pagination clearfix left " . ((!$data['showNumbers']) ? ("no_numbers") : ("")) . "'>
		...
		<ul class='ipsList_inline left pages'>
			...
			" . ((is_array( $work['_pageNumbers'] ) && count( $work['_pageNumbers'] )) ? ("
				".$this->__f__b73b031c0ab9bfd01bb137aa537aa36a($work,$data)."			") : ("")) . "
		</ul>
...
function __f__b73b031c0ab9bfd01bb137aa537aa36a($work, $data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0ababc57100ba2c0ab9760d5d54aa3a0 = is_array($this->functionData['quickSearch']) ? count($this->functionData['quickSearch']) : 0;
}
		...
		<fieldset>
			...
			<span id='search_wrap' class='right'>
				...
				<ul id='search_options_menucontent' class='ipbmenu_content ipsPad' style='display: none'>
					...
					".$this->__f__674d931c60d2408a73a48e277cb301f8()."				</ul>
...
function __f__674d931c60d2408a73a48e277cb301f8()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_71d098bd839d6712e0e7e9d8fba72454 = is_array($this->functionData['shareLinks']) ? count($this->functionData['shareLinks']) : 0;
$this->functionData['shareLinks'][$count_71d098bd839d6712e0e7e9d8fba72454]['links'] = $links;
$this->functionData['shareLinks'][$count_71d098bd839d6712e0e7e9d8fba72454]['title'] = $title;
$this->functionData['shareLinks'][$count_71d098bd839d6712e0e7e9d8fba72454]['url'] = $url;
$this->functionData['shareLinks'][$count_71d098bd839d6712e0e7e9d8fba72454]['cssClass'] = $cssClass;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("sharelinks", "0" ) . "
" . ((is_array( $links )) ? ("
	<ul class='{$cssClass} shareButtons ipsList_inline'>
	".$this->__f__dddbbb6aeccf4107a4b9432a7cfcae1f($links,$title,$url,$cssClass)."	</ul>
	<script type=\"text/javascript\">
...
function __f__dddbbb6aeccf4107a4b9432a7cfcae1f($links, $title='', $url='', $cssClass='topic_share left')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_07d924671add3bbdd82d5ebed98def5a = is_array($this->functionData['signature_separator']) ? count($this->functionData['signature_separator']) : 0;
$this->functionData['signature_separator'][$count_07d924671add3bbdd82d5ebed98def5a]['sig'] = $sig;
$this->functionData['signature_separator'][$count_07d924671add3bbdd82d5ebed98def5a]['author_id'] = $author_id;
$this->functionData['signature_separator'][$count_07d924671add3bbdd82d5ebed98def5a]['can_ignore'] = $can_ignore;
}
...
{
$count_31a99b720147c9254b3f4d006161afc6 = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_31a99b720147c9254b3f4d006161afc6]['member'] = $member;
}
...
{
$count_851c749f0cd31b59d776ae6568ba195f = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_851c749f0cd31b59d776ae6568ba195f]['author'] = $author;
$this->functionData['userInfoPane'][$count_851c749f0cd31b59d776ae6568ba195f]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_851c749f0cd31b59d776ae6568ba195f]['options'] = $options;
}
$IPBHTML .= "<div itemscope itemtype=\"http://schema.org/Person\" class='user_details'>
	...
	" . (($author['custom_fields'] != "") ? ("
		<ul class='custom_fields'>
			".$this->__f__2aa66aabdc6b5e0739aa95717380029a($author,$contentid,$options)."		</ul>
...
function __f__9d743d738e7068d5b7144573b66b4844($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2aa66aabdc6b5e0739aa95717380029a($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__9d743d738e7068d5b7144573b66b4844($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_dda9ed0b4debb5838a0af727e53ddbbe = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_dda9ed0b4debb5838a0af727e53ddbbe]['member'] = $member;
}
...
{
$count_7cb117c2a5c406b1fe380002b0a61237 = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_7cb117c2a5c406b1fe380002b0a61237]['warning'] = $warning;
$this->functionData['warnDetails'][$count_7cb117c2a5c406b1fe380002b0a61237]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__e6cdad560a6685b637111bb13403f3ee($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__e6cdad560a6685b637111bb13403f3ee($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
