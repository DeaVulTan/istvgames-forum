...
{
$count_9f6c61edb124ad6b6260fd7ab56a7a70 = is_array($this->functionData['hookActiveUsers']) ? count($this->functionData['hookActiveUsers']) : 0;
$this->functionData['hookActiveUsers'][$count_9f6c61edb124ad6b6260fd7ab56a7a70]['stats'] = $stats;
}
...
{
$count_90cf3ec0fc1a0b1fd81941e70f56d0a4 = is_array($this->functionData['hookActiveUsersSidebar']) ? count($this->functionData['hookActiveUsersSidebar']) : 0;
$this->functionData['hookActiveUsersSidebar'][$count_90cf3ec0fc1a0b1fd81941e70f56d0a4]['stats'] = $stats;
}
...
{
$count_b093e111e5fa118e72ab7d982c3b0685 = is_array($this->functionData['hookGlobalShoutbox']) ? count($this->functionData['hookGlobalShoutbox']) : 0;
$this->functionData['hookGlobalShoutbox'][$count_b093e111e5fa118e72ab7d982c3b0685]['d'] = $d;
}
...
{
$count_7e96c7cac9817d00ffd6dbe197962bdb = is_array($this->functionData['hookGlobalShoutboxEmoticons']) ? count($this->functionData['hookGlobalShoutboxEmoticons']) : 0;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_7e96c7cac9817d00ffd6dbe197962bdb]['emoticons'] = $emoticons;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_7e96c7cac9817d00ffd6dbe197962bdb]['total'] = $total;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_7e96c7cac9817d00ffd6dbe197962bdb]['prev'] = $prev;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_7e96c7cac9817d00ffd6dbe197962bdb]['next'] = $next;
}
...
<table class=\"ipb_table\">
			".$this->__f__8794b2a2b99f3e7197459c6146df19a5($emoticons,$total,$prev,$next)."	" . ((count($emoticons)%$this->settings['shoutbox_emos_perrow']>0) ? ("
				{$extra}
		</tr>
	") : ("")) . "
</table>";
...
function __f__8794b2a2b99f3e7197459c6146df19a5($emoticons=array(), $total=0, $prev=0, $next=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_77f6dddfeb62e66f3bb14866bb7e3158 = is_array($this->functionData['hookGlobalShoutboxSidebar']) ? count($this->functionData['hookGlobalShoutboxSidebar']) : 0;
$this->functionData['hookGlobalShoutboxSidebar'][$count_77f6dddfeb62e66f3bb14866bb7e3158]['d'] = $d;
}
$IPBHTML .= "<!--- ShoutBoxJsLoader --->
<script type='text/javascript'>
/* Setup some value */
...
{
$count_4d336dccf0f091c70d7b0437645679ea = is_array($this->functionData['hookOnlineTab']) ? count($this->functionData['hookOnlineTab']) : 0;
$this->functionData['hookOnlineTab'][$count_4d336dccf0f091c70d7b0437645679ea]['count'] = $count;
}
$IPBHTML .= "" . (($count > 0) ? ("
...
{
$count_eb38e119d00b44cb164ce1a3d2511d99 = is_array($this->functionData['hookVCard']) ? count($this->functionData['hookVCard']) : 0;
$this->functionData['hookVCard'][$count_eb38e119d00b44cb164ce1a3d2511d99]['member'] = $member;
}
...
{
$count_e6881b8bf3f26e50d2925182b760888d = is_array($this->functionData['shoutboxJavascript']) ? count($this->functionData['shoutboxJavascript']) : 0;
}
