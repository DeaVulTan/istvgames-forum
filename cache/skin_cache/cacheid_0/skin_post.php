...
{
$count_99aec8211159381181d78696a26edc5c = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_99aec8211159381181d78696a26edc5c]['data'] = $data;
}
...
{
$count_4035c0421366972122e6eba36ce558ef = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_4035c0421366972122e6eba36ce558ef]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_4035c0421366972122e6eba36ce558ef]['form'] = $form;
}
...
{
$count_76b59986ae39f80908b55ee4530f4006 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_76b59986ae39f80908b55ee4530f4006]['data'] = $data;
}
...
{
$count_c7c9c31fb0bff316d52279c25501dfed = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_c7c9c31fb0bff316d52279c25501dfed]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__26956cf16669daf276ec637a2326dfc7($posts)."") : ("")) . "
<p class='submit'>
...
function __f__26956cf16669daf276ec637a2326dfc7($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_551e068f0f5c768425309a0aeace36a2 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_551e068f0f5c768425309a0aeace36a2]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_551e068f0f5c768425309a0aeace36a2]['type'] = $type;
$this->functionData['uploadForm'][$count_551e068f0f5c768425309a0aeace36a2]['stats'] = $stats;
$this->functionData['uploadForm'][$count_551e068f0f5c768425309a0aeace36a2]['id'] = $id;
$this->functionData['uploadForm'][$count_551e068f0f5c768425309a0aeace36a2]['forum_id'] = $forum_id;
}
