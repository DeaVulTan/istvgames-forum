...
{
$count_b07ff1fff3400783ce7c06a831ea8734 = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_b07ff1fff3400783ce7c06a831ea8734]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_b07ff1fff3400783ce7c06a831ea8734]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_b07ff1fff3400783ce7c06a831ea8734]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_b07ff1fff3400783ce7c06a831ea8734]['extraData'] = $extraData;
}
...
{
$count_548db74c6bf681e11561432bb8da0adb = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_548db74c6bf681e11561432bb8da0adb]['formField'] = $formField;
$this->functionData['editor'][$count_548db74c6bf681e11561432bb8da0adb]['content'] = $content;
$this->functionData['editor'][$count_548db74c6bf681e11561432bb8da0adb]['options'] = $options;
$this->functionData['editor'][$count_548db74c6bf681e11561432bb8da0adb]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_548db74c6bf681e11561432bb8da0adb]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_548db74c6bf681e11561432bb8da0adb]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_548db74c6bf681e11561432bb8da0adb]['bbcodeVersion'] = $bbcodeVersion;
$this->functionData['editor'][$count_548db74c6bf681e11561432bb8da0adb]['showEditor'] = $showEditor;
}
...
{
$count_974e43dceb512ea05fbe5de7c9d07357 = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_974e43dceb512ea05fbe5de7c9d07357]['options'] = $options;
$this->functionData['editorLoadJs'][$count_974e43dceb512ea05fbe5de7c9d07357]['inlineLoad'] = $inlineLoad;
}
...
{
$count_b4b5b603333bfe5b5ea4a0dda0802974 = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_b4b5b603333bfe5b5ea4a0dda0802974]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_b4b5b603333bfe5b5ea4a0dda0802974]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_b4b5b603333bfe5b5ea4a0dda0802974]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_b4b5b603333bfe5b5ea4a0dda0802974]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__f6a8bb9b072193863b62ba93db9be6a3($rows,$pages,$app,$plugin)."		") : ("
...
function __f__f6a8bb9b072193863b62ba93db9be6a3($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_6cff8c520cdfad6a7109d2cf26003839 = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_6cff8c520cdfad6a7109d2cf26003839]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__c5a35f5ef2e6248da44c26916e4122fe($tabs)."			</ul>
		</div>
...
function __f__c5a35f5ef2e6248da44c26916e4122fe($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
