...
{
$count_be568071714eeb4413c95ae5acfe444f = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_be568071714eeb4413c95ae5acfe444f]['r'] = $r;
$this->functionData['comment'][$count_be568071714eeb4413c95ae5acfe444f]['parent'] = $parent;
$this->functionData['comment'][$count_be568071714eeb4413c95ae5acfe444f]['settings'] = $settings;
}
...
{
$count_81e1138e24f2366be84a4be87f70b469 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_81e1138e24f2366be84a4be87f70b469]['r'] = $r;
$this->functionData['commentHidden'][$count_81e1138e24f2366be84a4be87f70b469]['parent'] = $parent;
$this->functionData['commentHidden'][$count_81e1138e24f2366be84a4be87f70b469]['settings'] = $settings;
}
...
{
$count_90907e7fc486719a48b7f5cb0531d543 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_90907e7fc486719a48b7f5cb0531d543]['comments'] = $comments;
$this->functionData['commentsList'][$count_90907e7fc486719a48b7f5cb0531d543]['settings'] = $settings;
$this->functionData['commentsList'][$count_90907e7fc486719a48b7f5cb0531d543]['pages'] = $pages;
$this->functionData['commentsList'][$count_90907e7fc486719a48b7f5cb0531d543]['parent'] = $parent;
$this->functionData['commentsList'][$count_90907e7fc486719a48b7f5cb0531d543]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__5c48859baa6ccefb7c03f340f5aedd2b($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__5c48859baa6ccefb7c03f340f5aedd2b($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2f9f1d787e04ca2f26aae2fa3d066b51 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_2f9f1d787e04ca2f26aae2fa3d066b51]['comment'] = $comment;
$this->functionData['form'][$count_2f9f1d787e04ca2f26aae2fa3d066b51]['parent'] = $parent;
$this->functionData['form'][$count_2f9f1d787e04ca2f26aae2fa3d066b51]['editor'] = $editor;
$this->functionData['form'][$count_2f9f1d787e04ca2f26aae2fa3d066b51]['settings'] = $settings;
$this->functionData['form'][$count_2f9f1d787e04ca2f26aae2fa3d066b51]['errors'] = $errors;
$this->functionData['form'][$count_2f9f1d787e04ca2f26aae2fa3d066b51]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
