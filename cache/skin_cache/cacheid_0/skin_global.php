...
{
$count_4538001c5e6247d6cbec9cc1414d40e7 = is_array($this->functionData['fcRepBar']) ? count($this->functionData['fcRepBar']) : 0;
$this->functionData['fcRepBar'][$count_4538001c5e6247d6cbec9cc1414d40e7]['author'] = $author;
}
...
{
$count_174beb0c1ec0a254b404b10d668989f5 = is_array($this->functionData['friendsOnline_globalmenu_frindslist']) ? count($this->functionData['friendsOnline_globalmenu_frindslist']) : 0;
$this->functionData['friendsOnline_globalmenu_frindslist'][$count_174beb0c1ec0a254b404b10d668989f5]['active'] = $active;
$this->functionData['friendsOnline_globalmenu_frindslist'][$count_174beb0c1ec0a254b404b10d668989f5]['actives'] = $actives;
}
...
<ul class='ipsList_withminiphoto'>
	" . ((is_array( $active ) && count( $active )) ? ("
		".$this->__f__5cb2114fdd6fb5588c06eacd2027e132($active,$actives)."	") : ("
...
" . (($this->settings['friendsOnline_staff_on']) ? ("<h4 class='ipsType_sectiontitle'>{$this->lang->words['staffOnline']}</h4>
	<ul class='ipsList_withminiphoto'>
		" . ((is_array( $actives ) && count( $actives )) ? ("
			".$this->__f__37bf3f03eeedaa17d765473e283b5d73($active,$actives)."		") : ("
...
function __f__5cb2114fdd6fb5588c06eacd2027e132($active, $actives)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $active as $r )
...
function __f__37bf3f03eeedaa17d765473e283b5d73($active, $actives)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e81e2841a2a8b3e4c00fca43e14a9ffa = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_e81e2841a2a8b3e4c00fca43e14a9ffa]['html'] = $html;
$this->functionData['globalTemplate'][$count_e81e2841a2a8b3e4c00fca43e14a9ffa]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_e81e2841a2a8b3e4c00fca43e14a9ffa]['css'] = $css;
$this->functionData['globalTemplate'][$count_e81e2841a2a8b3e4c00fca43e14a9ffa]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_e81e2841a2a8b3e4c00fca43e14a9ffa]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_e81e2841a2a8b3e4c00fca43e14a9ffa]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_e81e2841a2a8b3e4c00fca43e14a9ffa]['items'] = $items;
$this->functionData['globalTemplate'][$count_e81e2841a2a8b3e4c00fca43e14a9ffa]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_e81e2841a2a8b3e4c00fca43e14a9ffa]['stats'] = $stats;
}
				...
				<div class='main_width'>
					<ul class='ipsList_inline' id='community_app_menu'>
						...
						") : ("" . ((is_array($header_items['applications']) AND count($header_items['applications'])) ? ("
								".$this->__f__79da30f9c32b1ddf26bdc6fdac9e77e9($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							") : ("")) . "")) . "
			...
			<div id='content' class='clearfix'>
				...
				" . ((count( $items['navigation'] )) ? ("<div id='secondary_navigation' class='clearfix'>
						<ol class='breadcrumb top ipsList_inline left'>
								...
								" . (($this->did_first=1) ? ("") : ("")) . "") : ("")) . "
							".$this->__f__c10abdef67d40506fcd8673788c9f91d($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."						</ol>
					</div>
					<br />") : ("")) . "
				<noscript>
				...
				<ol class='breadcrumb bottom ipsList_inline left clearfix clear'>
					" . ((count( $items['navigation'] )) ? ("						" . ((!$this->settings['remove_forums_nav'] OR ipsRegistry::$current_application == 'forums') ? ("<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "act=idx", "public",'' ), "false", "" ) . "'>{$this->settings['board_name']}</a></li>
						...
						".$this->__f__58304047503f7ca161765b486ec0df60($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."") : ("
						<li>&nbsp;</li>
					")) . "
							...
							" . ((count($footer_items['skin_chooser']) > 1) ? ("
								<li>
									...
									<ul id='new_skin_menucontent' class='ipbmenu_content with_checks' style='display: none'>
										".$this->__f__eb29a6c656857ed2da2d2cd0f0b78e3f($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."									</ul>
								</li>
							") : ("")) . "")) . "") : ("")) . "
					" . ((! $this->member->is_not_human && count( $footer_items['lang_chooser']['options'] ) > 1) ? ("
						<li>
							...
							<ul id='new_language_menucontent' class='ipbmenu_content with_checks' style='display: none'>
								".$this->__f__b6105c4b15990185b311edfaee7029d9($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							</ul>
						</li>
					") : ("")) . "
					" . ((( ! $this->member->is_not_human ) && ( $this->memberData['member_id'] || $this->settings['topic_marking_guests'] )) ? ("
						<li>
							...
							<ul id='mark_all_read_menucontent' class='ipbmenu_content' style='display: none'>
								".$this->__f__450aff24667ef3e05cb0dac3ef685db8($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								<li>
...
function __f__79da30f9c32b1ddf26bdc6fdac9e77e9($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c10abdef67d40506fcd8673788c9f91d($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__58304047503f7ca161765b486ec0df60($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $items['navigation'] as $idx => $data )
...
function __f__eb29a6c656857ed2da2d2cd0f0b78e3f($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b6105c4b15990185b311edfaee7029d9($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__450aff24667ef3e05cb0dac3ef685db8($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_bd5c70fbaed6a14999e6fe22f62450bb = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_bd5c70fbaed6a14999e6fe22f62450bb]['css'] = $css;
}

$this->minify = array();
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__eb7b1ee4e1abaa6bae2dd3c639d6b9dc($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__211214e9fb5cbcece37bc3e2047a0d59($css)."") : ("")) . "
<!--[if lte IE 7]>
...
function __f__eb7b1ee4e1abaa6bae2dd3c639d6b9dc($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__211214e9fb5cbcece37bc3e2047a0d59($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_79d756b1ce5eb3f7da23689efc453342 = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_79d756b1ce5eb3f7da23689efc453342]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__1ec156c23d4c7171a64cb86f7077b16a($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__4f850ff540fb2fe3f2f16ad0c1c3df2c($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1ec156c23d4c7171a64cb86f7077b16a($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__4f850ff540fb2fe3f2f16ad0c1c3df2c($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_39e08d982a12c74a7f3a5af3a6c1c991 = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_39e08d982a12c74a7f3a5af3a6c1c991]['jsModules'] = $jsModules;
}
...
{
$count_7547d95e43e86d4abf21db934f339e33 = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_7547d95e43e86d4abf21db934f339e33]['metaTags'] = $metaTags;
}
$IPBHTML .= "" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__9841e6abd8b7a0408d06a8e1a1490503($metaTags)."") : ("")) . "
<meta property=\"og:image\" content=\"{$this->settings['meta_imagesrc']}\"/>";
return $IPBHTML;
}


function __f__a81a4cc4d893ab1a9352c478eb10919b($metaTags,$tag='',$id='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__9841e6abd8b7a0408d06a8e1a1490503($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $metaTags as $tag => $id )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__a81a4cc4d893ab1a9352c478eb10919b($metaTags,$tag,$id)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_01b6a3cf2397ebe13aec943e06764bd9 = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__99cf2a2765dcdb5130ecf07d69e8efed()."" . (($this->isRtlLang AND is_file( DOC_IPS_ROOT_PATH . '/' . PUBLIC_DIRECTORY . '/style_css/' . $this->registry->output->skin['_csscacheid'] . '/ipb_rtl.css' )) ? ("
...
function __f__99cf2a2765dcdb5130ecf07d69e8efed()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_bb1649f53c42a9e99b3277ef1a67b733 = is_array($this->functionData['includeVars']) ? count($this->functionData['includeVars']) : 0;
$this->functionData['includeVars'][$count_bb1649f53c42a9e99b3277ef1a67b733]['header_items'] = $header_items;
}
...
{
$count_dd0e464879980d1fef5121d321d88696 = is_array($this->functionData['inlineLogin']) ? count($this->functionData['inlineLogin']) : 0;
}
				...
				" . ((IPSLib::loginMethod_enabled('facebook') || IPSLib::loginMethod_enabled('twitter') || IPSLib::loginMethod_enabled('live')) ? ("<div class='ipsBox_notice'>
						<ul class='ipsList_inline'>
							...
							" . ((is_array($this->_formFields) AND count($this->_formFields)) ? ("
								".$this->__f__06521446948b2b79019f80338ba8a492()."							") : ("")) . "
						</ul>
					</div>") : ("")) . "
				<br />
...
function __f__06521446948b2b79019f80338ba8a492()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6772b0e7d5870cac6d42dc19cbac2831 = is_array($this->functionData['liveEditJs']) ? count($this->functionData['liveEditJs']) : 0;
}
...
<div class='ipsBox ipsPad'>
	...
	<form action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&module=global&section=meta&do=save", "public",'' ), "", "" ) . "' method='post'>
		...
		<table class='ipb_table'>
			".$this->__f__ec953b2d22bdd1e4fc31f3fca99298bd($tags,$url)."		</table>
		</div>
		<table class='ipb_table'>
			<tr>
...
function __f__ec953b2d22bdd1e4fc31f3fca99298bd($tags, $url)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tags as $k => $v )
...
{
$count_1bc95b44e7c4079c51fa038dc6169258 = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_1bc95b44e7c4079c51fa038dc6169258]['data'] = $data;
}
...
{
$count_87416f259cf03edcf38e4aff22116b72 = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_87416f259cf03edcf38e4aff22116b72]['work'] = $work;
$this->functionData['paginationTemplate'][$count_87416f259cf03edcf38e4aff22116b72]['data'] = $data;
}
$IPBHTML .= "" . (($work['pages'] > 1) ? ("<div class='pagination clearfix left " . ((!$data['showNumbers']) ? ("no_numbers") : ("")) . "'>
		...
		<ul class='ipsList_inline left pages'>
			...
			" . ((is_array( $work['_pageNumbers'] ) && count( $work['_pageNumbers'] )) ? ("
				".$this->__f__b94d1eb5dae1e02193322abf60ea1fa7($work,$data)."			") : ("")) . "
		</ul>
...
function __f__b94d1eb5dae1e02193322abf60ea1fa7($work, $data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a48aa74f25d8d9b6175db06bb9daf10c = is_array($this->functionData['quickSearch']) ? count($this->functionData['quickSearch']) : 0;
}
		...
		<fieldset>
			...
			<span id='search_wrap' class='right'>
				...
				<ul id='search_options_menucontent' class='ipbmenu_content ipsPad' style='display: none'>
					...
					".$this->__f__2e6bd2acba325f49b6820ac2ac3957c8()."				</ul>
...
function __f__2e6bd2acba325f49b6820ac2ac3957c8()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_90921214f37785ba79a4f654b6b27823 = is_array($this->functionData['shareLinks']) ? count($this->functionData['shareLinks']) : 0;
$this->functionData['shareLinks'][$count_90921214f37785ba79a4f654b6b27823]['links'] = $links;
$this->functionData['shareLinks'][$count_90921214f37785ba79a4f654b6b27823]['title'] = $title;
$this->functionData['shareLinks'][$count_90921214f37785ba79a4f654b6b27823]['url'] = $url;
$this->functionData['shareLinks'][$count_90921214f37785ba79a4f654b6b27823]['cssClass'] = $cssClass;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("sharelinks", "0" ) . "
" . ((is_array( $links )) ? ("
	<ul class='{$cssClass} shareButtons ipsList_inline'>
	".$this->__f__46a949ea2edd8715c25fbbfbf337223e($links,$title,$url,$cssClass)."	</ul>
	<script type=\"text/javascript\">
...
function __f__46a949ea2edd8715c25fbbfbf337223e($links, $title='', $url='', $cssClass='topic_share left')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0189ef64bc4d49a327d1b42939ff54a4 = is_array($this->functionData['signature_separator']) ? count($this->functionData['signature_separator']) : 0;
$this->functionData['signature_separator'][$count_0189ef64bc4d49a327d1b42939ff54a4]['sig'] = $sig;
$this->functionData['signature_separator'][$count_0189ef64bc4d49a327d1b42939ff54a4]['author_id'] = $author_id;
$this->functionData['signature_separator'][$count_0189ef64bc4d49a327d1b42939ff54a4]['can_ignore'] = $can_ignore;
}
...
{
$count_72a6ea24b54df0d798372dea8886460e = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_72a6ea24b54df0d798372dea8886460e]['member'] = $member;
}
...
{
$count_464846995f7d93e5dae3e80bc7f99f0d = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_464846995f7d93e5dae3e80bc7f99f0d]['author'] = $author;
$this->functionData['userInfoPane'][$count_464846995f7d93e5dae3e80bc7f99f0d]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_464846995f7d93e5dae3e80bc7f99f0d]['options'] = $options;
}
$IPBHTML .= "<div itemscope itemtype=\"http://schema.org/Person\" class='user_details'>
	...
	" . (($author['custom_fields'] != "") ? ("
		<ul class='custom_fields'>
			".$this->__f__91a5f69bcf12d7d1f19c01fa63fd252c($author,$contentid,$options)."		</ul>
	") : ("")) . "
...
function __f__ea6ff9451086465dfa1e717c0a992052($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__91a5f69bcf12d7d1f19c01fa63fd252c($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__ea6ff9451086465dfa1e717c0a992052($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_4ab0aab9b9ae3888da36536708776338 = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_4ab0aab9b9ae3888da36536708776338]['member'] = $member;
}
...
{
$count_ff97f235f9e7497563e19b88fd336db9 = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_ff97f235f9e7497563e19b88fd336db9]['warning'] = $warning;
$this->functionData['warnDetails'][$count_ff97f235f9e7497563e19b88fd336db9]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__3cb349ccb2bc49274441f520af4fa611($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__3cb349ccb2bc49274441f520af4fa611($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
