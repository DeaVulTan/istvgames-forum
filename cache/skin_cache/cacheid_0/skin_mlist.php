...
{
$count_5c3650834d28836164df43b4df831733 = is_array($this->functionData['friendsOnline']) ? count($this->functionData['friendsOnline']) : 0;
$this->functionData['friendsOnline'][$count_5c3650834d28836164df43b4df831733]['active'] = $active;
$this->functionData['friendsOnline'][$count_5c3650834d28836164df43b4df831733]['actives'] = $actives;
}
	  ...
	  <div class='ipsBox_container ipsPad' id='mlist_content'>
			<ul class='ipsMemberList'>
				" . ((is_array( $active ) and count( $active )) ? ("
										".$this->__f__b0e2fdb05f1d9d030abab65eb38bdb07($active,$actives)."				") : ("
		  ...
		  <div class='ipsBox_container ipsPad' id='mlist_content'>
				<ul class='ipsMemberList'>
					" . ((is_array( $actives ) and count( $actives )) ? ("
												".$this->__f__9fda5ed5f2a0f4e1a5f6d3aa8ed24ee8($active,$actives)."					") : ("
						<li class='no_messages'>
...
function __f__b0e2fdb05f1d9d030abab65eb38bdb07($active, $actives)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__9fda5ed5f2a0f4e1a5f6d3aa8ed24ee8($active, $actives)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_91b7dd0338f475e1eb403f60299e48bc = is_array($this->functionData['member_alpha_ru']) ? count($this->functionData['member_alpha_ru']) : 0;
$this->functionData['member_alpha_ru'][$count_91b7dd0338f475e1eb403f60299e48bc]['url'] = $url;
}
$IPBHTML .= "<li id='alpha_switch' class='clickable'>РУС</li>
	...
	<div class='ipsVerticalTabbed_tabs ipsVerticalTabbed_minitabs ipsLayout_left' id='mlist_tabs_ru'>
		<ul>
    		...
    		")) . "
    ".$this->__f__70dd00c792440aca8f473df56b515510($url)."            <li id='alpha_switch_en' class='clickable'>АНГ</li>";
return $IPBHTML;
}


function __f__70dd00c792440aca8f473df56b515510($url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_23f85de9a6906a91952ff3e821ab49d2 = is_array($this->functionData['member_list_show']) ? count($this->functionData['member_list_show']) : 0;
$this->functionData['member_list_show'][$count_23f85de9a6906a91952ff3e821ab49d2]['members'] = $members;
$this->functionData['member_list_show'][$count_23f85de9a6906a91952ff3e821ab49d2]['pages'] = $pages;
$this->functionData['member_list_show'][$count_23f85de9a6906a91952ff3e821ab49d2]['dropdowns'] = $dropdowns;
$this->functionData['member_list_show'][$count_23f85de9a6906a91952ff3e821ab49d2]['defaults'] = $defaults;
$this->functionData['member_list_show'][$count_23f85de9a6906a91952ff3e821ab49d2]['custom_fields'] = $custom_fields;
$this->functionData['member_list_show'][$count_23f85de9a6906a91952ff3e821ab49d2]['url'] = $url;
}
	...
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=members&amp;module=list", "public",'' ), "false", "" ) . "\" method=\"post\">
		...
		<ul id='filters_1'>
			...
			" . ((count( $custom_fields->out_fields )) ? ("
				".$this->__f__1537ac6c2891d63e68d20c4c2360cc19($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			") : ("")) . "			
		</ul>
		<ul id='filters_2'>
			<li class='field'>
		...
		<fieldset class='other_filters row2 altrow'>
			<select name='filter' class='input_select'>
				".$this->__f__e82acc04e5bcaeff3d456fcfb3e69f28($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_by']}
			<select name='sort_key' class='input_select'>
				".$this->__f__a9bff5ea18ef2e0cdadc93f95172e155($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_in']}
			<select name='sort_order' class='input_select'>
				".$this->__f__0653bd5859611430c0db8bebe92b0ad7($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_with']}
			<select name='max_results' class='input_select'>
				".$this->__f__9ba3dabd4c6586b801944e14f9ffb31b($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
	...
	<div class='ipsVerticalTabbed_tabs ipsVerticalTabbed_minitabs ipsLayout_left' id='mlist_tabs'>
		<ul>
			...
			") : ("
				<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=members&amp;module=list", "public",'' ), "false", "members_list" ) . "' title='{$this->lang->words['mlist_view_all_title']}'>{$this->lang->words['mlist_view_all_txt']}</a></li>
			")) . "
			".$this->__f__c555447ac6f3a16c2b942f3ee4e31fd5($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."		</ul>
	</div>
		...
		<div class='ipsBox_container ipsPad' id='mlist_content'>
			<ul class='ipsMemberList'>
				" . ((is_array( $members ) and count( $members )) ? ("
										".$this->__f__715f63b3dd807560e3d18d9dd44ec619($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."				") : ("
					<li class='no_messages'>
...
function __f__1537ac6c2891d63e68d20c4c2360cc19($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e82acc04e5bcaeff3d456fcfb3e69f28($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a9bff5ea18ef2e0cdadc93f95172e155($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0653bd5859611430c0db8bebe92b0ad7($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__9ba3dabd4c6586b801944e14f9ffb31b($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c555447ac6f3a16c2b942f3ee4e31fd5($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__715f63b3dd807560e3d18d9dd44ec619($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
