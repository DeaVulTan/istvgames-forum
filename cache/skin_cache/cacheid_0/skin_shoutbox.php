...
{
$count_d86a6a72e36cf1565028f4d4596a0905 = is_array($this->functionData['archive']) ? count($this->functionData['archive']) : 0;
$this->functionData['archive'][$count_d86a6a72e36cf1565028f4d4596a0905]['d'] = $d;
}
...
$IPBHTML .= "" . ((substr( $action, 0, 4 ) != 'edit') ? ("" . (($action == 'delete') ? ("
	...
	<div class=\"short\">
		...
		<table class=\"ipb_table\">
			...
			".$this->__f__a7394ef77ac187848b270427761486b0($action,$data)."		</table>
		<br />
...
function __f__a7394ef77ac187848b270427761486b0($action='',$data=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_cf0987e10b26c62ffe06995a38e56dcd = is_array($this->functionData['popupWrapper']) ? count($this->functionData['popupWrapper']) : 0;
$this->functionData['popupWrapper'][$count_cf0987e10b26c62ffe06995a38e56dcd]['output'] = $output;
}
...
{
$count_b1dda5296a6e3b05a7a330cf6d62003c = is_array($this->functionData['shout_row']) ? count($this->functionData['shout_row']) : 0;
$this->functionData['shout_row'][$count_b1dda5296a6e3b05a7a330cf6d62003c]['d'] = $d;
$this->functionData['shout_row'][$count_b1dda5296a6e3b05a7a330cf6d62003c]['can_edit'] = $can_edit;
$this->functionData['shout_row'][$count_b1dda5296a6e3b05a7a330cf6d62003c]['ajax'] = $ajax;
}
...
{
$count_588e5aeba5556cfcef460ae8a1218e43 = is_array($this->functionData['shout_row_sidebar']) ? count($this->functionData['shout_row_sidebar']) : 0;
$this->functionData['shout_row_sidebar'][$count_588e5aeba5556cfcef460ae8a1218e43]['d'] = $d;
$this->functionData['shout_row_sidebar'][$count_588e5aeba5556cfcef460ae8a1218e43]['can_edit'] = $can_edit;
$this->functionData['shout_row_sidebar'][$count_588e5aeba5556cfcef460ae8a1218e43]['ajax'] = $ajax;
}
...
{
$count_3e15ffecf5eff81638f7e5390589444e = is_array($this->functionData['shoutbox']) ? count($this->functionData['shoutbox']) : 0;
$this->functionData['shoutbox'][$count_3e15ffecf5eff81638f7e5390589444e]['data'] = $data;
$this->functionData['shoutbox'][$count_3e15ffecf5eff81638f7e5390589444e]['stats'] = $stats;
}
