...
class skin_topic_8 extends skinMaster{
...
$this->_funcHooks['post'] = array('sDeleted','isSolvedCss','postQueued','noRep','posRep','negRep','repIgnored','userIgnoredLang','userIgnoredLangTwo','userIgnored','isNotIgnoring','postMid','hasPages','postModSelected','postModCheckbox','postMember','onlineDetails','isSolvedSausage','accessModCP','postAdmin','postIp','repHighlight','postEditByReason','postEditBy','repButtonsLike','postSignature','canDelete','approveUnapprove','canEdit','controlsForUnapprovedPost','hideNormalControlsForUnapprovedPost','multiquote','replyButton','replyButtonWarn','canDelete','canHide','canEdit','postIsReported','canReportPost','reportedPostData','sDeletedNot','initIgnoredPost','adCodeCheck','sDeletedNotMQ');
...
{
$count_54ebbbac5ea1b0874b489373764cd1cb = is_array($this->functionData['ajaxSharePost']) ? count($this->functionData['ajaxSharePost']) : 0;
$this->functionData['ajaxSharePost'][$count_54ebbbac5ea1b0874b489373764cd1cb]['topic'] = $topic;
$this->functionData['ajaxSharePost'][$count_54ebbbac5ea1b0874b489373764cd1cb]['post'] = $post;
$this->functionData['ajaxSharePost'][$count_54ebbbac5ea1b0874b489373764cd1cb]['url'] = $url;
$this->functionData['ajaxSharePost'][$count_54ebbbac5ea1b0874b489373764cd1cb]['sharelinks'] = $sharelinks;
}
...
{
$count_2efce74caab9a355fc49d0ee967c9bb7 = is_array($this->functionData['announcement_show']) ? count($this->functionData['announcement_show']) : 0;
$this->functionData['announcement_show'][$count_2efce74caab9a355fc49d0ee967c9bb7]['announce'] = $announce;
$this->functionData['announcement_show'][$count_2efce74caab9a355fc49d0ee967c9bb7]['author'] = $author;
}
...
{
$count_8c074b743fbcf13944d30d766dbf8033 = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_8c074b743fbcf13944d30d766dbf8033]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_8c074b743fbcf13944d30d766dbf8033]['forum'] = $forum;
}
...
{
$count_91e0d2aed1571ef8595b74d6d206c8fa = is_array($this->functionData['hookFacebookLike']) ? count($this->functionData['hookFacebookLike']) : 0;
}
...
{
$count_8f8ce477f00fe8e4836ae38b278d9a22 = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_8f8ce477f00fe8e4836ae38b278d9a22]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_8f8ce477f00fe8e4836ae38b278d9a22]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_8f8ce477f00fe8e4836ae38b278d9a22]['opts'] = $opts;
}
...
.pnmessage {
	background-image: url(\"{$this->settings['public_dir']}style_images/master/information.png\");
...
.pnmessage.unspecific {
	background-image: url(\"{$this->settings['public_dir']}style_images/master/note.png\");
...
/* -- pnForm --*/
function pnForm($pid, $action, $post, $ajax) {
$IPBHTML = "";
$IPBHTML .= "<div style=\"padding:10px; width:500px;margin-right:auto;margin-left:auto;\">
...
{
$count_c272aed2dfad4420432a403ef83defc4 = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_c272aed2dfad4420432a403ef83defc4]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_c272aed2dfad4420432a403ef83defc4]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_c272aed2dfad4420432a403ef83defc4]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_c272aed2dfad4420432a403ef83defc4]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_c272aed2dfad4420432a403ef83defc4]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_c272aed2dfad4420432a403ef83defc4]['editPoll'] = $editPoll;
}
...
<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__95a6a76b839deaa8ad1824f5c5cf330e($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__2aec1d66025568e3eab064510fc82975($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='',$choiceID='',$choiceData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__717845759c872ca6f07d842b9febad8a($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							" . (($showResults) ? ("<li>
									...
									" . (($poll['poll_view_voters'] AND is_array( $choiceData['voters'] ) AND $this->settings['poll_allow_public'] AND $choiceData['votes']) ? ("
										<script type='text/javascript'>
											...
											".$this->__f__2aec1d66025568e3eab064510fc82975($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData,$choiceID,$choiceData)."											ipb.topic.poll[ $questionID ][ $choiceID ] = { name: \"{$choiceData['choice']}\", users: users};
										</script>
									") : ("")) . "
...
function __f__95a6a76b839deaa8ad1824f5c5cf330e($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__717845759c872ca6f07d842b9febad8a($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_bd4172e17074fbb16976d20f5ad69da3 = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_bd4172e17074fbb16976d20f5ad69da3]['post'] = $post;
$this->functionData['post'][$count_bd4172e17074fbb16976d20f5ad69da3]['displayData'] = $displayData;
$this->functionData['post'][$count_bd4172e17074fbb16976d20f5ad69da3]['topic'] = $topic;
$this->functionData['post'][$count_bd4172e17074fbb16976d20f5ad69da3]['forum'] = $forum;
}
...
<div class='post_username'>
				...
				" . (($post['author']['_online']) ? ("
                                        <span class=\"tatoffn\">Онлайн</span>
				") : ("
					<span class=\"tatofft\">Оффлайн</span>
				")) . "
...
{
$count_36eaac174bbcdf6379cd9c43e10c9303 = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_36eaac174bbcdf6379cd9c43e10c9303]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_49aed265ed6d7f272f523ebca46a2727 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_49aed265ed6d7f272f523ebca46a2727]['title'] = $title;
$this->functionData['show_attachment_title'][$count_49aed265ed6d7f272f523ebca46a2727]['data'] = $data;
$this->functionData['show_attachment_title'][$count_49aed265ed6d7f272f523ebca46a2727]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__72cca0b2a94b7499cd06a4f506e25143($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__72cca0b2a94b7499cd06a4f506e25143($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c7c664fd75e14ecc91aca94ed88f32da = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_c7c664fd75e14ecc91aca94ed88f32da]['data'] = $data;
}
$IPBHTML .= "<div class=\"attachment-box\">
  ...
  <span class=\"attachment-button\">
    <a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=attach&amp;section=attach&amp;attach_id={$data['attach_id']}", "current",'' ), "", "" ) . "\" title=\"{$this->lang->words['attach_dl']}\">{$this->lang->words['attach_dl']}</a>
  </span>
...
{
$count_f074a7cb90eac394a37afa180443c329 = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_f074a7cb90eac394a37afa180443c329]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_f074a7cb90eac394a37afa180443c329]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_f074a7cb90eac394a37afa180443c329]['topic'] = $topic;
}
...
$IPBHTML .= "<div class='post_block hentry clear moderated' id='post_id_{$post['post']['pid']}'>
	...
	<div class='post_wrap'>
		...
		<div class='post_body' id='postsDelete_{$post['post']['pid']}' style='margin-left:10px;'>
...
$IPBHTML = "";
$IPBHTML .= "".$this->__f__23ed3bea9c2c306864faca6e2d9605b2($topic,$posts)."<br class='clear' />
...
function __f__23ed3bea9c2c306864faca6e2d9605b2($topic, $posts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_97582f0303c58bfb85aed8519b66549d = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_97582f0303c58bfb85aed8519b66549d]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_97582f0303c58bfb85aed8519b66549d]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_97582f0303c58bfb85aed8519b66549d]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_97582f0303c58bfb85aed8519b66549d]['displayData'] = $displayData;
}
...
" . (($displayData['mod_links'] AND ( $this->memberData['is_mod'] OR $this->memberData['member_id'] == $topic['starter_id'] )) ? ("<ul class='ipbmenu_content' id='topic_mod_options_menucontent'  style='display:none'>
	".$this->__f__07c075f4c200b9590125850399d9baba($forum,$topic,$post_data,$displayData)."	" . (($topic['topic_queuedposts'] AND $this->registry->class_forums->canQueuePosts( $forum['id'] )) ? ("
	...
	" . ((is_array( $displayData['multi_mod'] ) AND count( $displayData['multi_mod'] )) ? ("
		".$this->__f__2da50631d80300b40c2cec1f5bf056d7($forum,$topic,$post_data,$displayData)."	") : ("")) . "
</ul>
<script type='text/javascript'>
...
" . (($this->settings['reputation_enabled'] && $this->settings['reputation_point_types'] != 'like' && $this->settings['reputation_show_content'] && $this->memberData['member_id'] != 0 && is_array($this->caches['reputation_levels'])) ? ("<ul id='rep_filter_menucontent' class='ipbmenu_content with_checks' style='display: none'>
		...
		" . ((is_array($this->caches['reputation_levels'])) ? ("
			".$this->__f__fc3b6e70044669fa4e4f8c5516e312f3($forum,$topic,$post_data,$displayData)."		") : ("")) . "
	</ul>
	<script type='text/javascript'>
...
" . ((is_array( $post_data ) AND count( $post_data )) ? ("
	<div>
		<div class='ipsBox_container' id='ips_Posts'>
			".$this->__f__ebceac38df45614bebc4f2b2266554cd($forum,$topic,$post_data,$displayData)."		</div>
	</div>
") : ("")) . "
<hr />
...
" . ((is_array( $displayData['same_tagged'] ) and count( $displayData['same_tagged'] )) ? ("
	...
	<div class='ipsBox'>
		...
		<div class='ipsBox_container'>
			...
			".$this->__f__a1eeb04658f5278dcb658e27d31b7b54($forum,$topic,$post_data,$displayData)."			</table>
		</div>
	</div>
") : ("")) . "
<!-- ACTIVE USERS -->
...
<!--
<div style=\"width:46%;margin:0 auto;padding: 2%;float:right;\">
<h4 class='statistics_head'>Поделиться</h4>
<div class=\"share42init\"></div>
<script type=\"text/javascript\" src=\"{$this->settings['img_url']}/share42.js\"></script>
</div>
</div></div>
<div id=\"content\" style=\"padding:0 !important;margin: 0px;\">
</if>
" . (($this->request['gopid']) ? ("
<script type='text/javascript'>
	var gopid = \"{$this->request['gopid']}\".replace(/&amp;/g, '');
...
-->
" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'include_highlighter' ) ? $this->registry->getClass('output')->getTemplate('global')->include_highlighter(1) : '' ) . "
<!--<div id='multiQuoteInsert' style='display: none;' class='ipsFloatingAction'></div>-->";
return $IPBHTML;
}


function __f__07c075f4c200b9590125850399d9baba($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2da50631d80300b40c2cec1f5bf056d7($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__fc3b6e70044669fa4e4f8c5516e312f3($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ebceac38df45614bebc4f2b2266554cd($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a1eeb04658f5278dcb658e27d31b7b54($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
