...
class skin_global_comments_8 extends skinMaster{
...
{
$count_9175811ae3ff930bfa950cf823a50094 = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_9175811ae3ff930bfa950cf823a50094]['r'] = $r;
$this->functionData['comment'][$count_9175811ae3ff930bfa950cf823a50094]['parent'] = $parent;
$this->functionData['comment'][$count_9175811ae3ff930bfa950cf823a50094]['settings'] = $settings;
}
...
{
$count_f7574f277a250931cf12930ec1d22ccc = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_f7574f277a250931cf12930ec1d22ccc]['r'] = $r;
$this->functionData['commentHidden'][$count_f7574f277a250931cf12930ec1d22ccc]['parent'] = $parent;
$this->functionData['commentHidden'][$count_f7574f277a250931cf12930ec1d22ccc]['settings'] = $settings;
}
...
{
$count_7ff48a9cf8674bad8fb616bcd8bd4adc = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_7ff48a9cf8674bad8fb616bcd8bd4adc]['comments'] = $comments;
$this->functionData['commentsList'][$count_7ff48a9cf8674bad8fb616bcd8bd4adc]['settings'] = $settings;
$this->functionData['commentsList'][$count_7ff48a9cf8674bad8fb616bcd8bd4adc]['pages'] = $pages;
$this->functionData['commentsList'][$count_7ff48a9cf8674bad8fb616bcd8bd4adc]['parent'] = $parent;
$this->functionData['commentsList'][$count_7ff48a9cf8674bad8fb616bcd8bd4adc]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__3808f81f104edee47a940600e3e0337c($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__3808f81f104edee47a940600e3e0337c($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c33f4e944912440cb821d548b31e4d51 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_c33f4e944912440cb821d548b31e4d51]['comment'] = $comment;
$this->functionData['form'][$count_c33f4e944912440cb821d548b31e4d51]['parent'] = $parent;
$this->functionData['form'][$count_c33f4e944912440cb821d548b31e4d51]['editor'] = $editor;
$this->functionData['form'][$count_c33f4e944912440cb821d548b31e4d51]['settings'] = $settings;
$this->functionData['form'][$count_c33f4e944912440cb821d548b31e4d51]['errors'] = $errors;
$this->functionData['form'][$count_c33f4e944912440cb821d548b31e4d51]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
