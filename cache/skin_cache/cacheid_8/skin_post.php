...
class skin_post_8 extends skinMaster{
...
{
$count_82a6b1eb8c456454ceab8eaf243f9c91 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_82a6b1eb8c456454ceab8eaf243f9c91]['data'] = $data;
}
...
{
$count_3e712c27916a128e71b006594ca4e78e = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_3e712c27916a128e71b006594ca4e78e]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_3e712c27916a128e71b006594ca4e78e]['form'] = $form;
}
...
{
$count_23fdfa48a8c71bdcf0f929b9dd454284 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_23fdfa48a8c71bdcf0f929b9dd454284]['data'] = $data;
}
...
{
$count_e079b19b5ae996748a07df65ad21af29 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_e079b19b5ae996748a07df65ad21af29]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__14620969c470599b2bbd860192b687d2($posts)."") : ("")) . "
<p class='submit'>
...
function __f__14620969c470599b2bbd860192b687d2($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e62c279eff3c6a6e46c563ccb35e9b55 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_e62c279eff3c6a6e46c563ccb35e9b55]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_e62c279eff3c6a6e46c563ccb35e9b55]['type'] = $type;
$this->functionData['uploadForm'][$count_e62c279eff3c6a6e46c563ccb35e9b55]['stats'] = $stats;
$this->functionData['uploadForm'][$count_e62c279eff3c6a6e46c563ccb35e9b55]['id'] = $id;
$this->functionData['uploadForm'][$count_e62c279eff3c6a6e46c563ccb35e9b55]['forum_id'] = $forum_id;
}
