...
class skin_mlist_8 extends skinMaster{
...
$this->_funcHooks['friendsOnline'] = array('weAreSupmod','addfriend','notus','sendpm','blog','gallery','rate1','rate2','rate3','rate4','rate5','rating','norep','posrep','negrep','repson','filterViews','members','weAreSupmod','addfriend','notus','sendpm','blog','gallery','rate1','rate2','rate3','rate4','rate5','rating','norep','posrep','negrep','repson','filterViews','members','showmembers','staff');
...
/* -- friendsOnline --*/
function friendsOnline($active, $actives) {
$IPBHTML = "";
if( IPSLib::locationHasHooks( 'skin_mlist', $this->_funcHooks['friendsOnline'] ) )
{
$count_ec8554bdab21a5f3b0c79d5f441c26f2 = is_array($this->functionData['friendsOnline']) ? count($this->functionData['friendsOnline']) : 0;
$this->functionData['friendsOnline'][$count_ec8554bdab21a5f3b0c79d5f441c26f2]['active'] = $active;
$this->functionData['friendsOnline'][$count_ec8554bdab21a5f3b0c79d5f441c26f2]['actives'] = $actives;
}
...
$IPBHTML .= "<h1 class='ipsType_pagetitle'>{$this->lang->words['friendsOnline']}</h1><br />
	  <div class=\"ipsBox ipsVerticalTabbed ipsLayout clearfix\">
	  <div class='ipsLayout_content'>
	  <div class='maintitle ipsFilterbar clear clearfix'>{$this->lang->words['friendsOnline']}</div>
	  <div class='ipsBox_container ipsPad' id='mlist_content'>
			<ul class='ipsMemberList'>
				" . ((is_array( $active ) and count( $active )) ? ("
										".$this->__f__5aa6a2eb1990a73e3db2ed58dfc07e2a($active,$actives)."				") : ("
					<li class='no_messages'>
						{$this->lang->words['friendsOnline_nofriendonline']}
					</li>
				")) . "
			</ul>
		</div>
...
" . (($this->settings['friendsOnline_staff_on']) ? ("<br />
	<h1 class='ipsType_pagetitle'>{$this->lang->words['staffOnline']}</h1><br />
		  <div class=\"ipsBox ipsVerticalTabbed ipsLayout clearfix\">
		  <div class='ipsLayout_content'>
		  <div class='maintitle ipsFilterbar clear clearfix'>{$this->lang->words['staffOnline']}</div>
		  <div class='ipsBox_container ipsPad' id='mlist_content'>
				<ul class='ipsMemberList'>
					" . ((is_array( $actives ) and count( $actives )) ? ("
												".$this->__f__f7fb691b672e8c3e7ae4d81414c40551($active,$actives)."					") : ("
						<li class='no_messages'>
							{$this->lang->words['friendsOnline_nostaffonline']}
						</li>
					")) . "
				</ul>
			</div>
...
function __f__5aa6a2eb1990a73e3db2ed58dfc07e2a($active, $actives)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
						...
						<li id='member_id_{$member['member_id']}' class='ipsPad clearfix member_entry " .  IPSLib::next( $this->registry->templateStriping["memberStripe"] ) . "'>
							...
							<div class='ipsBox_withphoto'>
								...
								<h3 class='ipsType_subtitle'>
									" . ((!$this->settings['friendsOnline_gc']) ? ("" . IPSMember::makeProfileLink($member['members_display_name'], $member['member_id'], $member['members_seo_name'] ) . "") : ("" . IPSMember::makeProfileLink(IPSMember::makeNameFormatted( $member['members_display_name'], $member['member_group_id']), $member['member_id']) . "")) . "" . (($member['login_type'] == 1) ? ("*") : ("")) . "</a>
...
function __f__f7fb691b672e8c3e7ae4d81414c40551($active, $actives)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $actives as $member )
	{
		...
		$_ips___x_retval .= "
							<li id='member_id_{$member['member_id']}' class='ipsPad clearfix member_entry " .  IPSLib::next( $this->registry->templateStriping["memberStripe"] ) . "'>
								...
								<div class='ipsBox_withphoto'>
									...
									<h3 class='ipsType_subtitle'>
										" . ((!$this->settings['friendsOnline_gc']) ? ("" . IPSMember::makeProfileLink($member['members_display_name'], $member['member_id'], $member['members_seo_name'] ) . "") : ("" . IPSMember::makeProfileLink(IPSMember::makeNameFormatted( $member['members_display_name'], $member['member_group_id']), $member['member_id']) . "")) . "" . (($r['login_type'] == 1) ? ("*") : ("")) . "</a>
...
{
$count_1584408da355a33fde851465deb69730 = is_array($this->functionData['member_alpha_ru']) ? count($this->functionData['member_alpha_ru']) : 0;
$this->functionData['member_alpha_ru'][$count_1584408da355a33fde851465deb69730]['url'] = $url;
}
$IPBHTML .= "<li id='alpha_switch' class='clickable'>РУС</li>
	...
	<div class='ipsVerticalTabbed_tabs ipsVerticalTabbed_minitabs ipsLayout_left' id='mlist_tabs_ru'>
		<ul>
    		...
    		")) . "
    ".$this->__f__6b6770d75806e5edbef021dbc91b24a2($url)."            <li id='alpha_switch_en' class='clickable'>АНГ</li>";
return $IPBHTML;
}


function __f__6b6770d75806e5edbef021dbc91b24a2($url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e19ba947c13dcfecbcf2582ef5ee1c9f = is_array($this->functionData['member_list_show']) ? count($this->functionData['member_list_show']) : 0;
$this->functionData['member_list_show'][$count_e19ba947c13dcfecbcf2582ef5ee1c9f]['members'] = $members;
$this->functionData['member_list_show'][$count_e19ba947c13dcfecbcf2582ef5ee1c9f]['pages'] = $pages;
$this->functionData['member_list_show'][$count_e19ba947c13dcfecbcf2582ef5ee1c9f]['dropdowns'] = $dropdowns;
$this->functionData['member_list_show'][$count_e19ba947c13dcfecbcf2582ef5ee1c9f]['defaults'] = $defaults;
$this->functionData['member_list_show'][$count_e19ba947c13dcfecbcf2582ef5ee1c9f]['custom_fields'] = $custom_fields;
$this->functionData['member_list_show'][$count_e19ba947c13dcfecbcf2582ef5ee1c9f]['url'] = $url;
}
	...
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=members&amp;module=list", "public",'' ), "false", "" ) . "\" method=\"post\">
		...
		<ul id='filters_1'>
			...
			" . ((count( $custom_fields->out_fields )) ? ("
				".$this->__f__ebf1b10f2fda2dc3abb8ef1c312f3a0d($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			") : ("")) . "			
		</ul>
		<ul id='filters_2'>
			<li class='field'>
		...
		<fieldset class='other_filters row2 altrow'>
			<select name='filter' class='input_select'>
				".$this->__f__222049ef17598c8a1d920f90e04ee23c($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_by']}
			<select name='sort_key' class='input_select'>
				".$this->__f__505d2f817d0b6691cd93501c0d86af39($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_in']}
			<select name='sort_order' class='input_select'>
				".$this->__f__89cbbb843465edd865af30f07d19d05a($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_with']}
			<select name='max_results' class='input_select'>
				".$this->__f__2168a1b844623379a17ac0dafb1bfd4d($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
	...
	<div class='ipsVerticalTabbed_tabs ipsVerticalTabbed_minitabs ipsLayout_left' id='mlist_tabs'>
		<ul>
			...
			") : ("
				<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=members&amp;module=list", "public",'' ), "false", "members_list" ) . "' title='{$this->lang->words['mlist_view_all_title']}'>{$this->lang->words['mlist_view_all_txt']}</a></li>
			")) . "
			".$this->__f__c5f3d31cbdcbe58ae604cc7484357944($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."		</ul>
	</div>
		...
		<div class='ipsBox_container ipsPad' id='mlist_content'>
			<ul class='ipsMemberList'>
				" . ((is_array( $members ) and count( $members )) ? ("
										".$this->__f__037b90d26fd48e5afdd1f9643bb99d9e($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."				") : ("
					<li class='no_messages'>
...
function __f__ebf1b10f2fda2dc3abb8ef1c312f3a0d($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__222049ef17598c8a1d920f90e04ee23c($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__505d2f817d0b6691cd93501c0d86af39($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__89cbbb843465edd865af30f07d19d05a($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2168a1b844623379a17ac0dafb1bfd4d($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c5f3d31cbdcbe58ae604cc7484357944($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__037b90d26fd48e5afdd1f9643bb99d9e($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
