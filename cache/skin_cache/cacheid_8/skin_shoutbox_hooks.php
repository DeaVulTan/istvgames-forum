...
class skin_shoutbox_hooks_8 extends skinMaster{
...
{
$count_a5e64bb0220891bbf1cd3aaa5377cdb1 = is_array($this->functionData['hookActiveUsers']) ? count($this->functionData['hookActiveUsers']) : 0;
$this->functionData['hookActiveUsers'][$count_a5e64bb0220891bbf1cd3aaa5377cdb1]['stats'] = $stats;
}
...
{
$count_65533a112ff472533b956b84c9fbdb93 = is_array($this->functionData['hookActiveUsersSidebar']) ? count($this->functionData['hookActiveUsersSidebar']) : 0;
$this->functionData['hookActiveUsersSidebar'][$count_65533a112ff472533b956b84c9fbdb93]['stats'] = $stats;
}
...
{
$count_d59ba65d195546dff1bc1fc3c7e61392 = is_array($this->functionData['hookGlobalShoutbox']) ? count($this->functionData['hookGlobalShoutbox']) : 0;
$this->functionData['hookGlobalShoutbox'][$count_d59ba65d195546dff1bc1fc3c7e61392]['d'] = $d;
}
...
{
$count_c14ba4fdcfb96ae36430610655e11c65 = is_array($this->functionData['hookGlobalShoutboxEmoticons']) ? count($this->functionData['hookGlobalShoutboxEmoticons']) : 0;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_c14ba4fdcfb96ae36430610655e11c65]['emoticons'] = $emoticons;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_c14ba4fdcfb96ae36430610655e11c65]['total'] = $total;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_c14ba4fdcfb96ae36430610655e11c65]['prev'] = $prev;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_c14ba4fdcfb96ae36430610655e11c65]['next'] = $next;
}
...
<table class=\"ipb_table\">
			".$this->__f__2945bc457b3b655f23480f3351a035ba($emoticons,$total,$prev,$next)."	" . ((count($emoticons)%$this->settings['shoutbox_emos_perrow']>0) ? ("
				{$extra}
		</tr>
	") : ("")) . "
</table>";
...
function __f__2945bc457b3b655f23480f3351a035ba($emoticons=array(), $total=0, $prev=0, $next=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1cc26c7e39aa1f7b32113918847800ce = is_array($this->functionData['hookGlobalShoutboxSidebar']) ? count($this->functionData['hookGlobalShoutboxSidebar']) : 0;
$this->functionData['hookGlobalShoutboxSidebar'][$count_1cc26c7e39aa1f7b32113918847800ce]['d'] = $d;
}
$IPBHTML .= "<!--- ShoutBoxJsLoader --->
<script type='text/javascript'>
/* Setup some value */
...
{
$count_fbb9e6be0b029d3d583a64d2cc5f5e50 = is_array($this->functionData['hookOnlineTab']) ? count($this->functionData['hookOnlineTab']) : 0;
$this->functionData['hookOnlineTab'][$count_fbb9e6be0b029d3d583a64d2cc5f5e50]['count'] = $count;
}
$IPBHTML .= "" . (($count > 0) ? ("
...
{
$count_c948ea43517cb1036e4185e24c05cfbe = is_array($this->functionData['hookVCard']) ? count($this->functionData['hookVCard']) : 0;
$this->functionData['hookVCard'][$count_c948ea43517cb1036e4185e24c05cfbe]['member'] = $member;
}
...
{
$count_22ebb7385c4c765f247a21ddfae492bf = is_array($this->functionData['shoutboxJavascript']) ? count($this->functionData['shoutboxJavascript']) : 0;
}
