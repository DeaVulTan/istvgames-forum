...
class skin_cmtp_8 extends skinMaster{
...
{
$count_c897e6dc2e75dc5d171809d832c45911 = is_array($this->functionData['group_strip_fix']) ? count($this->functionData['group_strip_fix']) : 0;
$this->functionData['group_strip_fix'][$count_c897e6dc2e75dc5d171809d832c45911]['group'] = $group;
$this->functionData['group_strip_fix'][$count_c897e6dc2e75dc5d171809d832c45911]['members'] = $members;
$this->functionData['group_strip_fix'][$count_c897e6dc2e75dc5d171809d832c45911]['pagination'] = $pagination;
}
...
<table class='ipb_table ipsMemberList'>
	...
	" . ((count($members) AND is_array($members)) ? ("
				".$this->__f__30e9e44f55a664df01adff1cad3ef0af($group,$members,$pagination)."	") : ("")) . "
</table>
" . (($pagination) ? ("
	<div class='topic_controls'>{$pagination}</div>
") : ("")) . "
...
function __f__6d92dd06a861572e2afec648c3d5f2a2($group='', $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__d0e12efb1279771497b631560ee1b718($group='', $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $info['forums'] as $id => $name )
...
function __f__30e9e44f55a664df01adff1cad3ef0af($group='', $members=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
			...
			<tr class='" .  IPSLib::next( $this->registry->templateStriping["staff"] ) . "'>
				...
				<td class='altrow short'>
					" . ((is_array($info['forums'])) ? ("" . ((count( $info['forums'] ) == 1) ? ("
							".$this->__f__6d92dd06a861572e2afec648c3d5f2a2($group,$members,$pagination,$info)."						") : ("
							...
							".$this->__f__d0e12efb1279771497b631560ee1b718($group,$members,$pagination,$info)."							</ul>
