...
class skin_shoutbox_8 extends skinMaster{
...
{
$count_d2af1760bc02a3b36660883e551df6ea = is_array($this->functionData['archive']) ? count($this->functionData['archive']) : 0;
$this->functionData['archive'][$count_d2af1760bc02a3b36660883e551df6ea]['d'] = $d;
}
...
$IPBHTML .= "" . ((substr( $action, 0, 4 ) != 'edit') ? ("" . (($action == 'delete') ? ("
	...
	<div class=\"short\">
		...
		<table class=\"ipb_table\">
			...
			".$this->__f__0584678c6ab6b9a43bb2e3a8879ca553($action,$data)."		</table>
		<br />
...
function __f__0584678c6ab6b9a43bb2e3a8879ca553($action='',$data=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e7c6e5b5074e49fd2f2dd952a5813f3a = is_array($this->functionData['popupWrapper']) ? count($this->functionData['popupWrapper']) : 0;
$this->functionData['popupWrapper'][$count_e7c6e5b5074e49fd2f2dd952a5813f3a]['output'] = $output;
}
...
{
$count_e33ede4ce67c2fab8500e39ea93fff2a = is_array($this->functionData['shout_row']) ? count($this->functionData['shout_row']) : 0;
$this->functionData['shout_row'][$count_e33ede4ce67c2fab8500e39ea93fff2a]['d'] = $d;
$this->functionData['shout_row'][$count_e33ede4ce67c2fab8500e39ea93fff2a]['can_edit'] = $can_edit;
$this->functionData['shout_row'][$count_e33ede4ce67c2fab8500e39ea93fff2a]['ajax'] = $ajax;
}
...
{
$count_22fd79dd9e06203c0f722466fb82013c = is_array($this->functionData['shout_row_sidebar']) ? count($this->functionData['shout_row_sidebar']) : 0;
$this->functionData['shout_row_sidebar'][$count_22fd79dd9e06203c0f722466fb82013c]['d'] = $d;
$this->functionData['shout_row_sidebar'][$count_22fd79dd9e06203c0f722466fb82013c]['can_edit'] = $can_edit;
$this->functionData['shout_row_sidebar'][$count_22fd79dd9e06203c0f722466fb82013c]['ajax'] = $ajax;
}
...
{
$count_45688d5dcfd31fa2411939bebb815d94 = is_array($this->functionData['shoutbox']) ? count($this->functionData['shoutbox']) : 0;
$this->functionData['shoutbox'][$count_45688d5dcfd31fa2411939bebb815d94]['data'] = $data;
$this->functionData['shoutbox'][$count_45688d5dcfd31fa2411939bebb815d94]['stats'] = $stats;
}
