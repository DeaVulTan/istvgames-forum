...
class skin_global_other_8 extends skinMaster{
...
{
$count_08607e4ed4875b48dffffebff0655770 = is_array($this->functionData['ajaxPopUpNoPermission']) ? count($this->functionData['ajaxPopUpNoPermission']) : 0;
$this->functionData['ajaxPopUpNoPermission'][$count_08607e4ed4875b48dffffebff0655770]['msg'] = $msg;
}
...
{
$count_3f2dedfbd4ab12eaba4ab72cab33b80c = is_array($this->functionData['displayBoardOffline']) ? count($this->functionData['displayBoardOffline']) : 0;
$this->functionData['displayBoardOffline'][$count_3f2dedfbd4ab12eaba4ab72cab33b80c]['message'] = $message;
}
...
{
$count_21032c5d7a8fb0acdd2e9350dcc36efa = is_array($this->functionData['displayPopUpWindow']) ? count($this->functionData['displayPopUpWindow']) : 0;
$this->functionData['displayPopUpWindow'][$count_21032c5d7a8fb0acdd2e9350dcc36efa]['documentHeadItems'] = $documentHeadItems;
$this->functionData['displayPopUpWindow'][$count_21032c5d7a8fb0acdd2e9350dcc36efa]['css'] = $css;
$this->functionData['displayPopUpWindow'][$count_21032c5d7a8fb0acdd2e9350dcc36efa]['jsLoaderItems'] = $jsLoaderItems;
$this->functionData['displayPopUpWindow'][$count_21032c5d7a8fb0acdd2e9350dcc36efa]['title'] = $title;
$this->functionData['displayPopUpWindow'][$count_21032c5d7a8fb0acdd2e9350dcc36efa]['output'] = $output;
}
...
<html xml:lang=\"ru\" lang=\"ru\" xmlns=\"http://www.w3.org/1999/xhtml\"> 
	<head>
		...
		" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
			".$this->__f__906153860841c74092f0d0d2cf2a9e85($documentHeadItems,$css,$jsLoaderItems,$title,$output)."			" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
		...
		" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
			".$this->__f__856e139d7649d5dafc4910d3241595b6($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
		<!--[if lte IE 7]>
		...
		" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
			".$this->__f__be2bca8812afb30a8bfe2e1e4977f1f1($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
		<script type='text/javascript'>
		...
		" . ((count($documentHeadItems)) ? ("
			".$this->__f__987c02427895e329191581736fea42f5($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
...
function __f__906153860841c74092f0d0d2cf2a9e85($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__856e139d7649d5dafc4910d3241595b6($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__be2bca8812afb30a8bfe2e1e4977f1f1($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e7c864d039989302a8334d90ad357097($documentHeadItems, $css, $jsLoaderItems, $title="", $output="",$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__987c02427895e329191581736fea42f5($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__e7c864d039989302a8334d90ad357097($documentHeadItems,$css,$jsLoaderItems,$title,$output,$type,$idx)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_f1a9a7174fd97469c36c613de2d4217b = is_array($this->functionData['Error']) ? count($this->functionData['Error']) : 0;
$this->functionData['Error'][$count_f1a9a7174fd97469c36c613de2d4217b]['message'] = $message;
$this->functionData['Error'][$count_f1a9a7174fd97469c36c613de2d4217b]['code'] = $code;
$this->functionData['Error'][$count_f1a9a7174fd97469c36c613de2d4217b]['ad_email_one'] = $ad_email_one;
$this->functionData['Error'][$count_f1a9a7174fd97469c36c613de2d4217b]['ad_email_two'] = $ad_email_two;
$this->functionData['Error'][$count_f1a9a7174fd97469c36c613de2d4217b]['title'] = $title;
}
...
{
$count_7aef7959aa60c6ed2f266d11ce5a12e9 = is_array($this->functionData['facebookPop']) ? count($this->functionData['facebookPop']) : 0;
$this->functionData['facebookPop'][$count_7aef7959aa60c6ed2f266d11ce5a12e9]['user'] = $user;
}
...
{
$count_9f08d21a063f6b20cbd5f93271ecdfe1 = is_array($this->functionData['generateTopicIcon']) ? count($this->functionData['generateTopicIcon']) : 0;
$this->functionData['generateTopicIcon'][$count_9f08d21a063f6b20cbd5f93271ecdfe1]['imgArray'] = $imgArray;
$this->functionData['generateTopicIcon'][$count_9f08d21a063f6b20cbd5f93271ecdfe1]['unreadUrl'] = $unreadUrl;
}
...
{
$count_3bd3bc67b2ac7cd40963918ee1eb0c8a = is_array($this->functionData['globalTemplateMinimal']) ? count($this->functionData['globalTemplateMinimal']) : 0;
$this->functionData['globalTemplateMinimal'][$count_3bd3bc67b2ac7cd40963918ee1eb0c8a]['html'] = $html;
$this->functionData['globalTemplateMinimal'][$count_3bd3bc67b2ac7cd40963918ee1eb0c8a]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplateMinimal'][$count_3bd3bc67b2ac7cd40963918ee1eb0c8a]['css'] = $css;
$this->functionData['globalTemplateMinimal'][$count_3bd3bc67b2ac7cd40963918ee1eb0c8a]['jsModules'] = $jsModules;
$this->functionData['globalTemplateMinimal'][$count_3bd3bc67b2ac7cd40963918ee1eb0c8a]['metaTags'] = $metaTags;
$this->functionData['globalTemplateMinimal'][$count_3bd3bc67b2ac7cd40963918ee1eb0c8a]['header_items'] = $header_items;
$this->functionData['globalTemplateMinimal'][$count_3bd3bc67b2ac7cd40963918ee1eb0c8a]['items'] = $items;
$this->functionData['globalTemplateMinimal'][$count_3bd3bc67b2ac7cd40963918ee1eb0c8a]['footer_items'] = $footer_items;
$this->functionData['globalTemplateMinimal'][$count_3bd3bc67b2ac7cd40963918ee1eb0c8a]['stats'] = $stats;
}
...
/* -- hookSnowstorm --*/
function hookSnowstorm() {
$IPBHTML = "";
$IPBHTML .= "<!-- CYBER-SYSTEMS.ORG: Snowstorm - Template -->
<script type='text/javascript' src='{$this->settings['js_base_url']}js/3rd_party/snowstorm/snowstorm.min.js'></script>
<script type='text/javascript'>
  snowStorm.animationInterval = {$this->settings['csnIPB3_snowStorm_animationInterval']};
  snowStorm.flakeBottom = {$this->settings['csnIPB3_snowStorm_flakeBottom']};
  snowStorm.flakesMax = {$this->settings['csnIPB3_snowStorm_flakesMax']};
  snowStorm.flakesMaxActive = {$this->settings['csnIPB3_snowStorm_flakesMaxActive']};
  snowStorm.followMouse = {$this->settings['csnIPB3_snowStorm_followMouse']};
  snowStorm.freezeOnBlur = {$this->settings['csnIPB3_snowStorm_freezeOnBlur']};
  snowStorm.snowColor = '#{$this->settings['csnIPB3_snowStorm_snowColor']}';
  snowStorm.snowCharacter = '{$this->settings['csnIPB3_snowStorm_snowCharacter']}';
  snowStorm.snowStick = {$this->settings['csnIPB3_snowStorm_snowStick']};
  snowStorm.targetElement = {$this->settings['csnIPB3_snowStorm_targetElement']};
  snowStorm.useMeltEffect = {$this->settings['csnIPB3_snowStorm_useMeltEffect']};
  snowStorm.useTwinkleEffect = {$this->settings['csnIPB3_snowStorm_useTwinkleEffect']};
  snowStorm.usePositionFixed = {$this->settings['csnIPB3_snowStorm_usePositionFixed']};
  snowStorm.vMaxX = {$this->settings['csnIPB3_snowStorm_vMaxX']};
  snowStorm.vMaxY = {$this->settings['csnIPB3_snowStorm_vMaxY']};
</script>
<!-- / CYBER-SYSTEMS.ORG: Snowstorm - Template -->";
return $IPBHTML;
}

/* -- hookYandexGarland --*/
function hookYandexGarland() {
$IPBHTML = "";
$IPBHTML .= "<!-- CYBER-SYSTEMS.ORG: Yandex Garland - Template -->
" . (($this->settings['csnIPB3_yandexGarland_include'] && !IPSMember::isInGroup($this->memberData, explode(',', $this->settings['csnIPB3_yandexGarland_userGroups']))) ? ("
<script type='text/javascript' src='{$this->settings['js_base_url']}js/3rd_party/garland/swfobject.min.js'></script>
<script type='text/javascript'>
js_boardurl = \"{$this->settings['js_base_url']}\";
js_soundenable = 1;
</script>
<script type='text/javascript' src='{$this->settings['js_base_url']}js/3rd_party/garland/newyear.js'></script>
<div class='b-page_newyear'>
  <div class='b-page__content'>
    <div style='background-color: {$this->settings['csnIPB3_yandexGarland_styleBgColor']}; top: {$this->settings['csnIPB3_yandexGarland_styleTop']}px;' class='b-head-decor'>
...
{
$count_c16bfae729d352b21ccb0fd835ad5653 = is_array($this->functionData['inboxList']) ? count($this->functionData['inboxList']) : 0;
$this->functionData['inboxList'][$count_c16bfae729d352b21ccb0fd835ad5653]['topics'] = $topics;
}
...
<ul class='ipsList_withminiphoto'>
	" . ((count($topics)) ? ("
		".$this->__f__6de7ef603b0b151b6e3922b0de42861b($topics)."	") : ("
...
function __f__6de7ef603b0b151b6e3922b0de42861b($topics)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6526c61a9fd75137f481348a3e624d8c = is_array($this->functionData['likeMoreDialogue']) ? count($this->functionData['likeMoreDialogue']) : 0;
$this->functionData['likeMoreDialogue'][$count_6526c61a9fd75137f481348a3e624d8c]['data'] = $data;
$this->functionData['likeMoreDialogue'][$count_6526c61a9fd75137f481348a3e624d8c]['relId'] = $relId;
$this->functionData['likeMoreDialogue'][$count_6526c61a9fd75137f481348a3e624d8c]['cache'] = $cache;
}
$IPBHTML .= "<h3>{$this->lang->words['followed_by']}</h3>
<div class='likepop fixed_inner'>
	" . ((is_array($data) && count($data)) ? ("
		<ul class='ipsList_withminiphoto'>
			".$this->__f__60a93f26df74bf5bbd0efa9d6f065d66($data,$relId,$cache)."		</ul>
	") : ("")) . "
...
function __f__60a93f26df74bf5bbd0efa9d6f065d66($data, $relId, $cache)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		<li class='ipsField ipsField_checkbox'>
			...
			<p class='ipsField_content'>
				...
				<select name=\"freq\" id=\"like_freq\" class=\"input_select\">
					".$this->__f__eb6761e0cf8ce4cfc90144d382f8f0eb($app,$area,$relid,$data)."				</select>
			</p>
		</li>
		<li class='ipsField ipsField_checkbox'>
...
function __f__eb6761e0cf8ce4cfc90144d382f8f0eb($app, $area, $relid, $data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8bb1cb866f8496f73bd74c7d0ac6531d = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_8bb1cb866f8496f73bd74c7d0ac6531d]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_8bb1cb866f8496f73bd74c7d0ac6531d]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_8bb1cb866f8496f73bd74c7d0ac6531d]['opts'] = $opts;
}
...
{
$count_b388c07cbb4bf5d9b9925144551e78c2 = is_array($this->functionData['notificationsList']) ? count($this->functionData['notificationsList']) : 0;
$this->functionData['notificationsList'][$count_b388c07cbb4bf5d9b9925144551e78c2]['notifications'] = $notifications;
}
...
<ul class='ipsList_withminiphoto'>
	" . ((count($notifications)) ? ("
		".$this->__f__508ffd5d56b93d03ef39839cd07c4d9c($notifications)."	") : ("
...
function __f__508ffd5d56b93d03ef39839cd07c4d9c($notifications)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0311a6450244ee5f6629c1eabae81eb0 = is_array($this->functionData['questionAndAnswer']) ? count($this->functionData['questionAndAnswer']) : 0;
$this->functionData['questionAndAnswer'][$count_0311a6450244ee5f6629c1eabae81eb0]['data'] = $data;
}
...
{
$count_07fd328b01b01ef29769751e0f9dd2e5 = is_array($this->functionData['quickNavigationPanel']) ? count($this->functionData['quickNavigationPanel']) : 0;
$this->functionData['quickNavigationPanel'][$count_07fd328b01b01ef29769751e0f9dd2e5]['data'] = $data;
$this->functionData['quickNavigationPanel'][$count_07fd328b01b01ef29769751e0f9dd2e5]['currentApp'] = $currentApp;
}
$IPBHTML .= "<div>
	".$this->__f__fd4a88e26c0db9ade9359fd23043bd92($data,$currentApp)."</div>";
return $IPBHTML;
}


function __f__ccd611e60833385b8640f6d6cc982588($data=array(), $currentApp='',$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__fd4a88e26c0db9ade9359fd23043bd92($data=array(), $currentApp='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $_data )
	{
		...
		" . ((is_array($_data['links']) AND count($_data['links'])) ? ("
			".$this->__f__ccd611e60833385b8640f6d6cc982588($data,$currentApp,$_data)."		") : ("")) . "
		</ul>
...
{
$count_15b1ebbf874db40eeb6a987537d2c2cc = is_array($this->functionData['quickNavigationWrapper']) ? count($this->functionData['quickNavigationWrapper']) : 0;
$this->functionData['quickNavigationWrapper'][$count_15b1ebbf874db40eeb6a987537d2c2cc]['tabs'] = $tabs;
$this->functionData['quickNavigationWrapper'][$count_15b1ebbf874db40eeb6a987537d2c2cc]['data'] = $data;
$this->functionData['quickNavigationWrapper'][$count_15b1ebbf874db40eeb6a987537d2c2cc]['currentApp'] = $currentApp;
}
$IPBHTML .= "<h3>{$this->lang->words['navigation_title']}</h3>
<div class='fixed_inner ipsBox'>
	" . (($this->registry->output->isLargeTouchDevice()) ? ("
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul>
				".$this->__f__91da227203383a127b8b7e5186e7be7c($tabs,$data,$currentApp)."			</ul>
		</div>
...
function __f__91da227203383a127b8b7e5186e7be7c($tabs=array(), $data=array(), $currentApp='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_50c5bbd4ef306ad77c77cba951ff8ca6 = is_array($this->functionData['redirectTemplate']) ? count($this->functionData['redirectTemplate']) : 0;
$this->functionData['redirectTemplate'][$count_50c5bbd4ef306ad77c77cba951ff8ca6]['documentHeadItems'] = $documentHeadItems;
$this->functionData['redirectTemplate'][$count_50c5bbd4ef306ad77c77cba951ff8ca6]['css'] = $css;
$this->functionData['redirectTemplate'][$count_50c5bbd4ef306ad77c77cba951ff8ca6]['jsLoaderItems'] = $jsLoaderItems;
$this->functionData['redirectTemplate'][$count_50c5bbd4ef306ad77c77cba951ff8ca6]['text'] = $text;
$this->functionData['redirectTemplate'][$count_50c5bbd4ef306ad77c77cba951ff8ca6]['url'] = $url;
$this->functionData['redirectTemplate'][$count_50c5bbd4ef306ad77c77cba951ff8ca6]['full'] = $full;
}
$IPBHTML .= "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">
<html xml:lang=\"ru\" lang=\"ru\" xmlns=\"http://www.w3.org/1999/xhtml\"> 
	<head>
		...
		<link rel=\"shortcut icon\" href='" . (($this->registry->output->isHTTPS) ? ("{$this->settings['board_url_https']}") : ("{$this->settings['board_url']}")) . "/favicon.ico' />
		" . ((is_array( $css['import'] )) ? ("
			".$this->__f__96cb05d35bf0cc8a3466957d8809484e($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
			".$this->__f__a772e189600217ebb9e5f1ef98dbb67c($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		<!--[if lte IE 7]>
			<link rel=\"stylesheet\" type=\"text/css\" title='Main' media=\"screen\" href=\"{$this->settings['public_dir']}style_css/{$this->registry->output->skin['_csscacheid']}/ipb_ie.css\" />
		<![endif]-->
		...
		" . ((count($documentHeadItems)) ? ("
			".$this->__f__b01de6af3aa5b153211a4480f92296f1($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		<!--/CSS-->
		<script type='text/javascript'>
		//<![CDATA[
...
function __f__96cb05d35bf0cc8a3466957d8809484e($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $css['import'] as $data )
...
function __f__a772e189600217ebb9e5f1ef98dbb67c($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $css['inline'] as $data )
...
function __f__459d98edf97c8b03dcfdc5ce35c33094($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems[ $type ] as $idx => $data )
...
function __f__b01de6af3aa5b153211a4480f92296f1($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__459d98edf97c8b03dcfdc5ce35c33094($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full,$type,$idx)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_8b4122583839474de8dc6a2235dbaa7b = is_array($this->functionData['repButtons']) ? count($this->functionData['repButtons']) : 0;
$this->functionData['repButtons'][$count_8b4122583839474de8dc6a2235dbaa7b]['member'] = $member;
$this->functionData['repButtons'][$count_8b4122583839474de8dc6a2235dbaa7b]['data'] = $data;
}
...
$IPBHTML .= "" . (($this->settings['reputation_enabled']) ? ("" . ((!( $this->settings['reputation_protected_groups'] && in_array( $member['member_group_id'], explode( ',', $this->settings['reputation_protected_groups'] ) ) )) ? ("" . (($this->settings['reputation_point_types'] == 'like') ? ("<div class='ipsLikeBar right clearfix' id='{$data['domCountId']}'>
                                <ul class='ipsList_inline'>
                                        " . (((!isset($data['hide_text']) OR !$data['hide_text'] )) ? ("<li id=\"{$data['domLikeStripId']}\" class='ipsLikeBar_info' " . ((!$data['likeFormatted']) ? ("") : ("")) . ">
                                                        {$data['likeFormatted']}
                                                </li>") : ("")) . "
                                        " . ((IPSMember::canGiveRep( $data, $member ) !== false && $this->memberData['member_id']) ? ("<li " . ((IPSMember::canRepUp( $data, $member ) === false) ? ("") : ("")) . ">
                                                ...
                                                <li " . ((IPSMember::canRepDown( $data, $member ) === false) ? ("") : ("")) . ">
                                        ...
                                        " . ((IPSMember::canGiveRep( $data, $member ) !== false && $this->memberData['member_id']) ? ("<div class=\"orate-btns\">
                                                <span> " . ((IPSMember::canRepUp( $data, $member ) === false) ? ("") : ("")) . "
...
<div class='likepop fixed_inner'>
        <ul class='ipsList_withminiphoto'>
                ".$this->__f__57d1c7b692170a132c45971ed0718ca2($data,$relId)."        </ul>
</div>";
return $IPBHTML;
}


function __f__57d1c7b692170a132c45971ed0718ca2($data, $relId)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $mid => $data )
...
$IPBHTML .= "<div>
	...
	<div class='ipsPad' style='min-height: 60px'>
		...
		") : ("".$this->__f__9e1c89579653d53d4a6e15e6f8463447($reps)."		")) . "
	</div>
</div>";
return $IPBHTML;
}
...
function __f__9e1c89579653d53d4a6e15e6f8463447($reps)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $reps as $r )
...
{
$count_b1619aeeba0f024e95f6cd9e70967b73 = is_array($this->functionData['socialSharePostStrip']) ? count($this->functionData['socialSharePostStrip']) : 0;
$this->functionData['socialSharePostStrip'][$count_b1619aeeba0f024e95f6cd9e70967b73]['id'] = $id;
}
...
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("facebook", "0" ) . "" . (($this->settings['sm_autoshare'] && IPSMember::canSocialShare()) ? ("<div class='ipsBox_container ipsMargin_top ipsPad_top'>
	<ul class='ipsPad ipsForm_vertical ipsList_inline ipsType_small clearfix'>
		".$this->__f__e0bc65655507289f16815fda199ef64d($id)."		" . ((! $id) ? ("
...
function __f__e0bc65655507289f16815fda199ef64d($id=null)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_69b4f1b2237c1b9abd3fdecbb9279625 = is_array($this->functionData['tagCloud']) ? count($this->functionData['tagCloud']) : 0;
$this->functionData['tagCloud'][$count_69b4f1b2237c1b9abd3fdecbb9279625]['tags'] = $tags;
}
$IPBHTML .= "<h3 class='maintitle'>{$this->lang->words['mob_tags']}</h3>
<div class='ipsBox'>
	<div class='ipsBox_container ipsPad'>
		<ul class='ipsList_inline'>
		".$this->__f__f268afed76667af001a30e29156fdf5f($tags)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__f268afed76667af001a30e29156fdf5f($tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0890056e445c09b9027217e5781d26a3 = is_array($this->functionData['tagEntry']) ? count($this->functionData['tagEntry']) : 0;
$this->functionData['tagEntry'][$count_0890056e445c09b9027217e5781d26a3]['tag'] = $tag;
$this->functionData['tagEntry'][$count_0890056e445c09b9027217e5781d26a3]['noClass'] = $noClass;
$this->functionData['tagEntry'][$count_0890056e445c09b9027217e5781d26a3]['app'] = $app;
$this->functionData['tagEntry'][$count_0890056e445c09b9027217e5781d26a3]['section'] = $section;
}
...
{
$count_21658ba9673799293e144fd229ec787f = is_array($this->functionData['tagPrefix']) ? count($this->functionData['tagPrefix']) : 0;
$this->functionData['tagPrefix'][$count_21658ba9673799293e144fd229ec787f]['tag'] = $tag;
$this->functionData['tagPrefix'][$count_21658ba9673799293e144fd229ec787f]['app'] = $app;
$this->functionData['tagPrefix'][$count_21658ba9673799293e144fd229ec787f]['section'] = $section;
}
...
{
$count_ad2ff709cb7d336e7c7b3453b394c3c2 = is_array($this->functionData['tagTextEntryBox']) ? count($this->functionData['tagTextEntryBox']) : 0;
$this->functionData['tagTextEntryBox'][$count_ad2ff709cb7d336e7c7b3453b394c3c2]['tags'] = $tags;
$this->functionData['tagTextEntryBox'][$count_ad2ff709cb7d336e7c7b3453b394c3c2]['options'] = $options;
$this->functionData['tagTextEntryBox'][$count_ad2ff709cb7d336e7c7b3453b394c3c2]['where'] = $where;
}
