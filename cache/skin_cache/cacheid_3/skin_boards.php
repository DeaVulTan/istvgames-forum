...
{
$count_5edc17d9903c2fcaf9b92eb6284be178 = is_array($this->functionData['boardIndexTemplate']) ? count($this->functionData['boardIndexTemplate']) : 0;
$this->functionData['boardIndexTemplate'][$count_5edc17d9903c2fcaf9b92eb6284be178]['lastvisit'] = $lastvisit;
$this->functionData['boardIndexTemplate'][$count_5edc17d9903c2fcaf9b92eb6284be178]['stats'] = $stats;
$this->functionData['boardIndexTemplate'][$count_5edc17d9903c2fcaf9b92eb6284be178]['cat_data'] = $cat_data;
$this->functionData['boardIndexTemplate'][$count_5edc17d9903c2fcaf9b92eb6284be178]['show_side_blocks'] = $show_side_blocks;
$this->functionData['boardIndexTemplate'][$count_5edc17d9903c2fcaf9b92eb6284be178]['side_blocks'] = $side_blocks;
}
...
" . ((is_array( $cat_data ) AND count( $cat_data )) ? ("
		<categories>
		".$this->__f__6132ccb8361230bb037514d27bd4687e($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."		</categories>
	") : ("")) . "
		<statistics>
...
function __f__7ec3a5805d2dbd11121f7413b656700e($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__8c790bb435c874e54380800929c607fa($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $_data['forum_data'] as $forum_id => $forum_data )
	{
		...
		$_ips___x_retval .= "
					<forum>
						...
						<subforums>
											".$this->__f__7ec3a5805d2dbd11121f7413b656700e($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data,$forum_id,$forum_data)."						</subforums>
						") : ("")) . "
					</forum>
...
function __f__6132ccb8361230bb037514d27bd4687e($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $cat_data as $_data )
	{
		...
		$_ips___x_retval .= "
			...
			<category>
				...
				<forums>
						".$this->__f__8c790bb435c874e54380800929c607fa($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data)."				</forums>
			</category>
			") : ("")) . "
...
{
$count_16cf37c35d03331fdc76e745d950e2ba = is_array($this->functionData['hookFacebookActivity']) ? count($this->functionData['hookFacebookActivity']) : 0;
}
$IPBHTML .= "<!-- NoData -->";
return $IPBHTML;
}
...
{
$count_276b1f9618e49fed6c1e5d1a87b0f01f = is_array($this->functionData['hookRecentTopics']) ? count($this->functionData['hookRecentTopics']) : 0;
$this->functionData['hookRecentTopics'][$count_276b1f9618e49fed6c1e5d1a87b0f01f]['topics'] = $topics;
}
$IPBHTML .= "<!-- NoData -->";
return $IPBHTML;
}
...
{
$count_88cecd1a5894dad9053d06affce6809c = is_array($this->functionData['hookTagCloud']) ? count($this->functionData['hookTagCloud']) : 0;
$this->functionData['hookTagCloud'][$count_88cecd1a5894dad9053d06affce6809c]['tags'] = $tags;
}
$IPBHTML .= "<!-- NoData -->";
return $IPBHTML;
}
...
{
$count_ab94ae6f8a9efe87bb65424cd135b90a = is_array($this->functionData['statusReplies']) ? count($this->functionData['statusReplies']) : 0;
$this->functionData['statusReplies'][$count_ab94ae6f8a9efe87bb65424cd135b90a]['replies'] = $replies;
}
$IPBHTML .= "<!-- NoData -->";
return $IPBHTML;
}
...
{
$count_131410378b65c6b089cd5badbc8299da = is_array($this->functionData['statusUpdates']) ? count($this->functionData['statusUpdates']) : 0;
$this->functionData['statusUpdates'][$count_131410378b65c6b089cd5badbc8299da]['updates'] = $updates;
$this->functionData['statusUpdates'][$count_131410378b65c6b089cd5badbc8299da]['smallSpace'] = $smallSpace;
$this->functionData['statusUpdates'][$count_131410378b65c6b089cd5badbc8299da]['latestOnly'] = $latestOnly;
}
$IPBHTML .= "<!-- NoData -->";
return $IPBHTML;
}
