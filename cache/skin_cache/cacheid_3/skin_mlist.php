...
{
$count_b3ebf75b54cf57f0882fce0bb5d1c472 = is_array($this->functionData['member_alpha_ru']) ? count($this->functionData['member_alpha_ru']) : 0;
$this->functionData['member_alpha_ru'][$count_b3ebf75b54cf57f0882fce0bb5d1c472]['url'] = $url;
}
...
{
$count_0e4ff7c0e2be3659b5ddec5537843b08 = is_array($this->functionData['member_list_show']) ? count($this->functionData['member_list_show']) : 0;
$this->functionData['member_list_show'][$count_0e4ff7c0e2be3659b5ddec5537843b08]['members'] = $members;
$this->functionData['member_list_show'][$count_0e4ff7c0e2be3659b5ddec5537843b08]['pages'] = $pages;
$this->functionData['member_list_show'][$count_0e4ff7c0e2be3659b5ddec5537843b08]['dropdowns'] = $dropdowns;
$this->functionData['member_list_show'][$count_0e4ff7c0e2be3659b5ddec5537843b08]['defaults'] = $defaults;
$this->functionData['member_list_show'][$count_0e4ff7c0e2be3659b5ddec5537843b08]['custom_fields'] = $custom_fields;
$this->functionData['member_list_show'][$count_0e4ff7c0e2be3659b5ddec5537843b08]['url'] = $url;
}
$IPBHTML .= "<template>memberList</template>
{$pages}
" . ((is_array( $members ) and count( $members )) ? ("
	<members>
	".$this->__f__9b4b1ffd188df1af7eb3c4e24328fb5b($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."	</members>
") : ("")) . "";
return $IPBHTML;
}


function __f__9b4b1ffd188df1af7eb3c4e24328fb5b($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
