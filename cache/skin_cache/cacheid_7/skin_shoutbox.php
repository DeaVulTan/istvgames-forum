...
class skin_shoutbox_7 extends skinMaster{
...
{
$count_73d3ab6338dcdb4d3c702fbbcb58fe21 = is_array($this->functionData['archive']) ? count($this->functionData['archive']) : 0;
$this->functionData['archive'][$count_73d3ab6338dcdb4d3c702fbbcb58fe21]['d'] = $d;
}
...
$IPBHTML .= "" . ((substr( $action, 0, 4 ) != 'edit') ? ("" . (($action == 'delete') ? ("
	...
	<div class=\"short\">
		...
		<table class=\"ipb_table\">
			...
			".$this->__f__e2bece3261beb5737f990d81ed6dfadd($action,$data)."		</table>
		<br />
...
function __f__e2bece3261beb5737f990d81ed6dfadd($action='',$data=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d1b9965f6c06aeb358efd8e1d8aefbb8 = is_array($this->functionData['popupWrapper']) ? count($this->functionData['popupWrapper']) : 0;
$this->functionData['popupWrapper'][$count_d1b9965f6c06aeb358efd8e1d8aefbb8]['output'] = $output;
}
...
{
$count_c5840d6ebf8f378a7ea76857adb80c98 = is_array($this->functionData['shout_row']) ? count($this->functionData['shout_row']) : 0;
$this->functionData['shout_row'][$count_c5840d6ebf8f378a7ea76857adb80c98]['d'] = $d;
$this->functionData['shout_row'][$count_c5840d6ebf8f378a7ea76857adb80c98]['can_edit'] = $can_edit;
$this->functionData['shout_row'][$count_c5840d6ebf8f378a7ea76857adb80c98]['ajax'] = $ajax;
}
...
{
$count_703f1b035b43c5b3356d124f37f376a4 = is_array($this->functionData['shout_row_sidebar']) ? count($this->functionData['shout_row_sidebar']) : 0;
$this->functionData['shout_row_sidebar'][$count_703f1b035b43c5b3356d124f37f376a4]['d'] = $d;
$this->functionData['shout_row_sidebar'][$count_703f1b035b43c5b3356d124f37f376a4]['can_edit'] = $can_edit;
$this->functionData['shout_row_sidebar'][$count_703f1b035b43c5b3356d124f37f376a4]['ajax'] = $ajax;
}
...
{
$count_ddc120a7743099358f3659d818ff0179 = is_array($this->functionData['shoutbox']) ? count($this->functionData['shoutbox']) : 0;
$this->functionData['shoutbox'][$count_ddc120a7743099358f3659d818ff0179]['data'] = $data;
$this->functionData['shoutbox'][$count_ddc120a7743099358f3659d818ff0179]['stats'] = $stats;
}
