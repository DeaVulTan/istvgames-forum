...
{
$count_54bc39c720e456e053237eb4f3a28a2e = is_array($this->functionData['boardIndexTemplate']) ? count($this->functionData['boardIndexTemplate']) : 0;
$this->functionData['boardIndexTemplate'][$count_54bc39c720e456e053237eb4f3a28a2e]['lastvisit'] = $lastvisit;
$this->functionData['boardIndexTemplate'][$count_54bc39c720e456e053237eb4f3a28a2e]['stats'] = $stats;
$this->functionData['boardIndexTemplate'][$count_54bc39c720e456e053237eb4f3a28a2e]['cat_data'] = $cat_data;
$this->functionData['boardIndexTemplate'][$count_54bc39c720e456e053237eb4f3a28a2e]['show_side_blocks'] = $show_side_blocks;
$this->functionData['boardIndexTemplate'][$count_54bc39c720e456e053237eb4f3a28a2e]['side_blocks'] = $side_blocks;
}
...
<div id='board_index' class='ipsLayout " . (($this->templateVars['sidebar_enabled']) ? ("ipsLayout_withright") : ("")) . " ipsLayout_largeright clearfix " . ((IPSCookie::get('hide_sidebar') == '1') ? ("no_sidebar") : ("")) . "'>	
	...
	<!-- CATS AND FORUMS -->
		" . ((is_array( $cat_data ) AND count( $cat_data )) ? ("
			".$this->__f__6118adb8df032cf57a50d72feffeb454($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."		") : ("")) . "
	</div>
...
<div class='ipsSideBlock clearfix'>
	...
	<div class='_sbcollapsable'>
		<center><iframe src=\"http://forum.istvgames.uz/monitorings/dota2mon/status.php\" width=\"230\" height=\"250\" frameborder=\"0\" scrolling=\"no\"></iframe></center>
	</div>
</div>
<!-- End -->
<!-- Begin -->
<div class='ipsSideBlock clearfix'>
	<h3 class='csbNoCollapse'>Мониторинг<br/>Counter-Strike: Global Offensive</h3>
	<div class='_sbcollapsable'>
		<center><iframe src=\"http://forum.istvgames.uz/monitorings/csgomon/status.php\" width=\"255\" height=\"300\" frameborder=\"0\" scrolling=\"no\"></iframe></center>
	</div>
</div>
<!-- End -->
<!-- Begin -->
...
<!-- /Мониторинги -->
			".$this->__f__3a83ace544497163dd81b137bc763ec9($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."		</div>
...
//<![CDATA[
	...
	" . ((is_array( $cat_data ) AND count( $cat_data )) ? ("
		".$this->__f__1d80a94d3458e6f65fb69a3c7d311b9c($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."	") : ("")) . "
//]]>
</script>
...
function __f__b885d3b73a893484212b22cf74f08d7c($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__f7d6659a781293a1707cfdb6e84b876d($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
$imageURL = "{$this->settings['img_url']}";
		...
		$_ips___x_retval .= "
										" . (($forum_data['redirect_on']) ? ("<tr class='redirect_forum forumHover' id='f_{$forum_data['id']}'>
												...
												<td class='col_c_icon'>	 " . (($forum_data['_has_unread']) ? ("<a id='forum_img_{$forum_data['id']}' href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&module=forums&section=markasread&marktype=forum&forumid={$forum_data['id']}&returntoforumid={$this->request['f']}&i=1", "public",'' ), "", "" ) . "\" data-tooltip=\"{$this->lang->words['bi_markread']}\" class='forum_marker'>" . (($forum_data['icon'] != '' AND $forum_data['icon'] !='0') ? ("{$forum_data['icon']}") : ("<img src='{$this->settings['img_url']}/f_icon.png' />")) . "</a") : ("" . (($forum_data['icon'] != '' AND $forum_data['icon'] !='0') ? ("{$forum_data['icon']}") : ("<img src='{$this->settings['img_url']}/f_icon_read.png' />")) . "")) . " </td>
												<td class='col_c_forum'>
													...
													<h4 class='forum_name'>
														...
														") : ("")) . "
														<strong class='highlight_unread'><a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showforum={$forum_data['id']}", "public",'' ), "{$forum_data['name_seo']}", "showforum" ) . "\" title='{$forum_data['name']}'>" . (($forum_data['_name']) ? ("{$forum_data['_name']}") : ("{$forum_data['name']}")) . "</a></strong> " . (($this->settings['customForumIcons']=='yes') ? ("" . (($forum_data['_has_unread']) ? ("<span class='ipsBadge ipsBadge_orange' style='vertical-align: top; margin-left: 5px;'>NEW</span>") : ("")) . "") : ("")) . "
													</h4>
...
" . (($this->settings['removeStatsColumn']=='yes') ? ("<div class='forum_stats'><span>{$this->lang->words['topics']}:</span> {$forum_data['topics']}  &nbsp; <span>{$this->lang->words['replies']}:</span> {$forum_data['posts']}</div>") : ("")) . "	
													...
													" . (($forum_data['show_subforums'] AND count( $forum_data['subforums'] ) AND $forum_data['show_subforums']) ? ("
														<ol class='ipsList_inline ipsType_small subforums' id='subforums_{$forum_data['id']}'>
															".$this->__f__b885d3b73a893484212b22cf74f08d7c($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data,$forum_id,$forum_data)."														</ol>
													") : ("")) . "
...
function __f__6118adb8df032cf57a50d72feffeb454($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $cat_data as $_data )
	{
		...
		$_ips___x_retval .= "
				" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("<div id='category_{$_data['cat_data']['id']}' class='category_block block_wrap'>
						" . $this->registry->getClass('output')->getReplacement("header_start") . "<a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showforum={$_data['cat_data']['id']}", "public",'' ), "{$_data['cat_data']['name_seo']}", "showforum" ) . "\" title='" . sprintf( $this->lang->words['view_cat'], IPSText::striptags( IPSText::htmlspecialchars($_data['cat_data']['name'] ) ) ) . "'><h3 class='maintitle' style='background-image:url(http://forum.istvgames.uz/imgs/{$_data['cat_data']['id']}.gif);background-repeat:no-repeat; background-position:left;' >
							<a class='toggle right' href='#' title=\"" . sprintf( $this->lang->words['toggle_cat'], IPSText::striptags( IPSText::htmlspecialchars($_data['cat_data']['name'] ) ) ) . "\">" . sprintf( $this->lang->words['toggle_cat'], $_data['cat_data']['name'] ) . "</a> 
						</h3></a>" . $this->registry->getClass('output')->getReplacement("header_end") . "
						<div class='ipsBox table_wrap removeDefault'>
							<div class='ipsBox_container'>
								<table class='ipb_table' summary=\"{$this->lang->words['forums_in_cat']} '{$_data['cat_data']['name']}'\">
									...
									<!-- / CAT HEADER -->
									".$this->__f__f7d6659a781293a1707cfdb6e84b876d($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data)."								</table>
							</div>
...
function __f__3a83ace544497163dd81b137bc763ec9($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
...
function __f__cb3db9ad00527139eb1b48057f9a4ede($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $_data['forum_data'] as $forum_id => $forum_data )
...
function __f__1d80a94d3458e6f65fb69a3c7d311b9c($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $cat_data as $_data )
	{
		...
		$_ips___x_retval .= "
			" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("
				".$this->__f__cb3db9ad00527139eb1b48057f9a4ede($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data)."			") : ("")) . "
...
{
$count_7e44a8abe86a568b4acadb44f6803b03 = is_array($this->functionData['hookFacebookActivity']) ? count($this->functionData['hookFacebookActivity']) : 0;
}
...
{
$count_376a80bfe53ed0719b45586802137e82 = is_array($this->functionData['hookGroupNameIndicator']) ? count($this->functionData['hookGroupNameIndicator']) : 0;
$this->functionData['hookGroupNameIndicator'][$count_376a80bfe53ed0719b45586802137e82]['groups'] = $groups;
}
...
{
$count_27a02d5b344de5551b255e08dbdc35ac = is_array($this->functionData['hookLikesThisLeaders']) ? count($this->functionData['hookLikesThisLeaders']) : 0;
$this->functionData['hookLikesThisLeaders'][$count_27a02d5b344de5551b255e08dbdc35ac]['ltl'] = $ltl;
}
...
<div class='ipsSideBlock clearfix'>
	...
	<div class='_sbcollapsable'>
		...
		".$this->__f__bf23c3af5ec9824c263da6ba5b84386d($ltl)."		</ul>
	</div>
</div>
") : ("")) . "";
return $IPBHTML;
...
function __f__bf23c3af5ec9824c263da6ba5b84386d($ltl)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $ltl as $r )
...
{
$count_0f0d23a2285a7f4740b671b0be13c6d9 = is_array($this->functionData['hookRecentTopics']) ? count($this->functionData['hookRecentTopics']) : 0;
$this->functionData['hookRecentTopics'][$count_0f0d23a2285a7f4740b671b0be13c6d9]['topics'] = $topics;
}
...
<div class='ipsSideBlock clearfix'>
	...
	<div class='_sbcollapsable'>
		<ul class='ipsList_withminiphoto'>
		".$this->__f__15275333c1d6a88884d7863d959f71cd($topics)."		</ul>
	</div>
</div>
") : ("")) . "";
return $IPBHTML;
...
function __f__15275333c1d6a88884d7863d959f71cd($topics)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $topics as $r )
...
{
$count_1b8093bf5a3de28ec38717e82f4d9bdc = is_array($this->functionData['hookTagCloud']) ? count($this->functionData['hookTagCloud']) : 0;
$this->functionData['hookTagCloud'][$count_1b8093bf5a3de28ec38717e82f4d9bdc]['tags'] = $tags;
}
$IPBHTML .= "<div class='ipsSideBlock clearfix'>
	<h3>{$this->lang->words['popular_tags']}</h3>
	<div class='_sbcollapsable'>
		<ul class='ipsList_inline'>
		".$this->__f__022cc8735aecd413372a9c43d5f46017($tags)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__022cc8735aecd413372a9c43d5f46017($tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e18033475a1e23ec4da54581bbc9ff0e = is_array($this->functionData['recentPosts']) ? count($this->functionData['recentPosts']) : 0;
$this->functionData['recentPosts'][$count_e18033475a1e23ec4da54581bbc9ff0e]['recentPosts'] = $recentPosts;
}
$IPBHTML .= "" . ((is_array($recentPosts) && count($recentPosts)) ? ("
  <div class='ipsSideBlock'>
	<h3>{$this->lang->words['recentposts_title']}</h3>
    <ul class='ipsList'> 
      ".$this->__f__9c2b5eacc293a33f4bc2444d246dafa0($recentPosts)."    </ul>
  </div>
  <br />
") : ("")) . "";
return $IPBHTML;
...
function __f__9c2b5eacc293a33f4bc2444d246dafa0($recentPosts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_dce39ca776efb6498fa908be375a4a9b = is_array($this->functionData['statusReplies']) ? count($this->functionData['statusReplies']) : 0;
$this->functionData['statusReplies'][$count_dce39ca776efb6498fa908be375a4a9b]['replies'] = $replies;
}
$IPBHTML .= "".$this->__f__ff969d6fe2560afe36f768d33e09ad43($replies)."";
return $IPBHTML;
}


function __f__ff969d6fe2560afe36f768d33e09ad43($replies=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_cf2d04fbc57806b22880aa039842f72a = is_array($this->functionData['statusUpdates']) ? count($this->functionData['statusUpdates']) : 0;
$this->functionData['statusUpdates'][$count_cf2d04fbc57806b22880aa039842f72a]['updates'] = $updates;
$this->functionData['statusUpdates'][$count_cf2d04fbc57806b22880aa039842f72a]['smallSpace'] = $smallSpace;
$this->functionData['statusUpdates'][$count_cf2d04fbc57806b22880aa039842f72a]['latestOnly'] = $latestOnly;
}
$IPBHTML .= "<script type=\"text/javascript\">
...
</script>".$this->__f__deed3aee2dd73b4dda8993f6bda5e9d2($updates,$smallSpace,$latestOnly)."";
return $IPBHTML;
}


function __f__deed3aee2dd73b4dda8993f6bda5e9d2($updates=array(), $smallSpace=0, $latestOnly=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
