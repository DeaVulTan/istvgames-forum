...
{
$count_8c120acc287454379999dc5824e64e22 = is_array($this->functionData['ajax__inlineLogInForm']) ? count($this->functionData['ajax__inlineLogInForm']) : 0;
}
...
{
$count_60c609322844880c286c01be4fb3d342 = is_array($this->functionData['showLogInForm']) ? count($this->functionData['showLogInForm']) : 0;
$this->functionData['showLogInForm'][$count_60c609322844880c286c01be4fb3d342]['message'] = $message;
$this->functionData['showLogInForm'][$count_60c609322844880c286c01be4fb3d342]['referer'] = $referer;
$this->functionData['showLogInForm'][$count_60c609322844880c286c01be4fb3d342]['extra_form'] = $extra_form;
$this->functionData['showLogInForm'][$count_60c609322844880c286c01be4fb3d342]['login_methods'] = $login_methods;
$this->functionData['showLogInForm'][$count_60c609322844880c286c01be4fb3d342]['facebookOpts'] = $facebookOpts;
}
				...
				<div class='right ipsPad_double' id='other_signin'>
					<ul class='ipsList_data clear ipsType_small'>
						...
						" . ((is_array($extra_form) AND count($extra_form)) ? ("
							".$this->__f__63e13ef7f74a6fdc5b1f2471e0c581f8($message,$referer,$extra_form,$login_methods,$facebookOpts)."						") : ("")) . "
					</ul>
				</div>
			</div>
			" . ((IPSLib::loginMethod_enabled('live')) ? ("
...
function __f__63e13ef7f74a6fdc5b1f2471e0c581f8($message="",$referer="",$extra_form="", $login_methods=array(), $facebookOpts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
