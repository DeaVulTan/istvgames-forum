...
class skin_shoutbox_hooks_7 extends skinMaster{
...
{
$count_fd6dc7db715ae166362bc723138fc048 = is_array($this->functionData['hookActiveUsers']) ? count($this->functionData['hookActiveUsers']) : 0;
$this->functionData['hookActiveUsers'][$count_fd6dc7db715ae166362bc723138fc048]['stats'] = $stats;
}
...
{
$count_60fc8079852867c36939a49814723ccf = is_array($this->functionData['hookActiveUsersSidebar']) ? count($this->functionData['hookActiveUsersSidebar']) : 0;
$this->functionData['hookActiveUsersSidebar'][$count_60fc8079852867c36939a49814723ccf]['stats'] = $stats;
}
...
{
$count_b699dccc2cf2be558004adec79e15c1c = is_array($this->functionData['hookGlobalShoutbox']) ? count($this->functionData['hookGlobalShoutbox']) : 0;
$this->functionData['hookGlobalShoutbox'][$count_b699dccc2cf2be558004adec79e15c1c]['d'] = $d;
}
...
{
$count_3a584e9580d333ffb102fba1b3fecfd2 = is_array($this->functionData['hookGlobalShoutboxEmoticons']) ? count($this->functionData['hookGlobalShoutboxEmoticons']) : 0;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_3a584e9580d333ffb102fba1b3fecfd2]['emoticons'] = $emoticons;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_3a584e9580d333ffb102fba1b3fecfd2]['total'] = $total;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_3a584e9580d333ffb102fba1b3fecfd2]['prev'] = $prev;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_3a584e9580d333ffb102fba1b3fecfd2]['next'] = $next;
}
...
<table class=\"ipb_table\">
			".$this->__f__fb7e179d4a0588ff87ea749a5298b63b($emoticons,$total,$prev,$next)."	" . ((count($emoticons)%$this->settings['shoutbox_emos_perrow']>0) ? ("
				{$extra}
		</tr>
	") : ("")) . "
</table>";
...
function __f__fb7e179d4a0588ff87ea749a5298b63b($emoticons=array(), $total=0, $prev=0, $next=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_692bd8fe27b5e59d9a12684064abdd3e = is_array($this->functionData['hookGlobalShoutboxSidebar']) ? count($this->functionData['hookGlobalShoutboxSidebar']) : 0;
$this->functionData['hookGlobalShoutboxSidebar'][$count_692bd8fe27b5e59d9a12684064abdd3e]['d'] = $d;
}
$IPBHTML .= "<!--- ShoutBoxJsLoader --->
<script type='text/javascript'>
/* Setup some value */
...
{
$count_9ac586ddac41a2ec3d7e48f52278bf02 = is_array($this->functionData['hookOnlineTab']) ? count($this->functionData['hookOnlineTab']) : 0;
$this->functionData['hookOnlineTab'][$count_9ac586ddac41a2ec3d7e48f52278bf02]['count'] = $count;
}
$IPBHTML .= "" . (($count > 0) ? ("
...
{
$count_d94092c61e8b25395f4d1c17de48ccf9 = is_array($this->functionData['hookVCard']) ? count($this->functionData['hookVCard']) : 0;
$this->functionData['hookVCard'][$count_d94092c61e8b25395f4d1c17de48ccf9]['member'] = $member;
}
...
{
$count_99eac3b5749fe37d6449210ef39c1b10 = is_array($this->functionData['shoutboxJavascript']) ? count($this->functionData['shoutboxJavascript']) : 0;
}
