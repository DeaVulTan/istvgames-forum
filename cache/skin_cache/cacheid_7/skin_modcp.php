...
{
$count_a404bd10404cc777df1727fe75982dd2 = is_array($this->functionData['deletedPosts']) ? count($this->functionData['deletedPosts']) : 0;
$this->functionData['deletedPosts'][$count_a404bd10404cc777df1727fe75982dd2]['posts'] = $posts;
$this->functionData['deletedPosts'][$count_a404bd10404cc777df1727fe75982dd2]['other_data'] = $other_data;
$this->functionData['deletedPosts'][$count_a404bd10404cc777df1727fe75982dd2]['pagelinks'] = $pagelinks;
}
...
<div class='clearfix'>
	" . ((is_array( $posts ) AND count( $posts )) ? ("
		<div id='ips_Posts'>
			".$this->__f__ca10925cfbbdafa74b1130d7291b7376($posts,$other_data,$pagelinks)."		</div>
	") : ("
...
function __f__ca10925cfbbdafa74b1130d7291b7376($posts, $other_data=array(), $pagelinks='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8ac904f9b3691ce128f436b284342969 = is_array($this->functionData['deletedTopics']) ? count($this->functionData['deletedTopics']) : 0;
$this->functionData['deletedTopics'][$count_8ac904f9b3691ce128f436b284342969]['topics'] = $topics;
$this->functionData['deletedTopics'][$count_8ac904f9b3691ce128f436b284342969]['sdelete'] = $sdelete;
$this->functionData['deletedTopics'][$count_8ac904f9b3691ce128f436b284342969]['pagelinks'] = $pagelinks;
}
...
{
$count_f4b7d496be9c41639d467e1091116f65 = is_array($this->functionData['editUserForm']) ? count($this->functionData['editUserForm']) : 0;
$this->functionData['editUserForm'][$count_f4b7d496be9c41639d467e1091116f65]['profile'] = $profile;
$this->functionData['editUserForm'][$count_f4b7d496be9c41639d467e1091116f65]['custom_fields'] = $custom_fields;
}
	...
	<fieldset>
		...
		" . ((count($custom_fields->out_fields)) ? ("
			...
			<ul class='ipsForm ipsForm_horizontal'>
				...
				".$this->__f__3a9eeadc70335caa5372429f17928a15($profile,$custom_fields)."			</ul>
		") : ("")) . "
...
function __f__3a9eeadc70335caa5372429f17928a15($profile, $custom_fields=null)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ae251ceac67322ef5a8bd019a2d8d219 = is_array($this->functionData['latestWarnLogs']) ? count($this->functionData['latestWarnLogs']) : 0;
$this->functionData['latestWarnLogs'][$count_ae251ceac67322ef5a8bd019a2d8d219]['warnings'] = $warnings;
$this->functionData['latestWarnLogs'][$count_ae251ceac67322ef5a8bd019a2d8d219]['pagelinks'] = $pagelinks;
}
...
<div class='clearfix'>
	<table class='ipb_table'>
		...
		" . ((is_array( $warnings ) AND count( $warnings )) ? ("
						".$this->__f__a7020e0fcb6e8a734117f94b5e1bbde8($warnings,$pagelinks)."		") : ("
			<tr>
...
function __f__a7020e0fcb6e8a734117f94b5e1bbde8($warnings, $pagelinks)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e487c8bf0530d6488f325356b4cc6225 = is_array($this->functionData['memberLookup']) ? count($this->functionData['memberLookup']) : 0;
}
...
{
$count_64eab0447ad8404e1210b74f829518dd = is_array($this->functionData['membersList']) ? count($this->functionData['membersList']) : 0;
$this->functionData['membersList'][$count_64eab0447ad8404e1210b74f829518dd]['type'] = $type;
$this->functionData['membersList'][$count_64eab0447ad8404e1210b74f829518dd]['members'] = $members;
$this->functionData['membersList'][$count_64eab0447ad8404e1210b74f829518dd]['pagelinks'] = $pagelinks;
}
		...
		<div id='member_wrap'>
			<ul class='ipsMemberList'>
				" . ((is_array( $members ) and count( $members )) ? ("
										".$this->__f__d875c129546c0d64e58ad25ec9c75f72($type,$members,$pagelinks)."				") : ("
...
function __f__d875c129546c0d64e58ad25ec9c75f72($type, $members, $pagelinks='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f9d5337bcf93f754d81bd26979a36b2e = is_array($this->functionData['membersModIPForm']) ? count($this->functionData['membersModIPForm']) : 0;
$this->functionData['membersModIPForm'][$count_f9d5337bcf93f754d81bd26979a36b2e]['ip'] = $ip;
$this->functionData['membersModIPForm'][$count_f9d5337bcf93f754d81bd26979a36b2e]['inlineMsg'] = $inlineMsg;
}
...
{
$count_ee2e2cd18ff1c1d0f05b459a43a54152 = is_array($this->functionData['membersModIPFormMembers']) ? count($this->functionData['membersModIPFormMembers']) : 0;
$this->functionData['membersModIPFormMembers'][$count_ee2e2cd18ff1c1d0f05b459a43a54152]['pages'] = $pages;
$this->functionData['membersModIPFormMembers'][$count_ee2e2cd18ff1c1d0f05b459a43a54152]['members'] = $members;
}
...
<table class='ipb_table'>
	...
	" . ((is_array( $members ) AND count( $members )) ? ("
				".$this->__f__bb5c5ec88874d494c5078edd3e193134($pages,$members)."	") : ("")) . "
</table>
<br />
...
function __f__bb5c5ec88874d494c5078edd3e193134($pages="",$members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4c63e9b980f95723bdede9b73db57bc0 = is_array($this->functionData['membersModIPFormPosts']) ? count($this->functionData['membersModIPFormPosts']) : 0;
$this->functionData['membersModIPFormPosts'][$count_4c63e9b980f95723bdede9b73db57bc0]['count'] = $count;
$this->functionData['membersModIPFormPosts'][$count_4c63e9b980f95723bdede9b73db57bc0]['pageLinks'] = $pageLinks;
$this->functionData['membersModIPFormPosts'][$count_4c63e9b980f95723bdede9b73db57bc0]['results'] = $results;
}
...
<br />
" . ((count($results)) ? ("
		".$this->__f__a48918540bd3ceb4e95fbae5d02eb673($count,$pageLinks,$results)."") : ("")) . "
<br />
<div class='topic_controls'>
	{$pageLinks}
</div>";
...
function __f__a48918540bd3ceb4e95fbae5d02eb673($count=0, $pageLinks='', $results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_715f290aacfcdf4437032f811bb1b057 = is_array($this->functionData['modAnnounceForm']) ? count($this->functionData['modAnnounceForm']) : 0;
$this->functionData['modAnnounceForm'][$count_715f290aacfcdf4437032f811bb1b057]['announce'] = $announce;
$this->functionData['modAnnounceForm'][$count_715f290aacfcdf4437032f811bb1b057]['forum_html'] = $forum_html;
$this->functionData['modAnnounceForm'][$count_715f290aacfcdf4437032f811bb1b057]['type'] = $type;
$this->functionData['modAnnounceForm'][$count_715f290aacfcdf4437032f811bb1b057]['editor_html'] = $editor_html;
$this->functionData['modAnnounceForm'][$count_715f290aacfcdf4437032f811bb1b057]['msg'] = $msg;
}
...
{
$count_f6adbbf4602d116fade9b995996f363f = is_array($this->functionData['modAnnouncements']) ? count($this->functionData['modAnnouncements']) : 0;
$this->functionData['modAnnouncements'][$count_f6adbbf4602d116fade9b995996f363f]['announcements'] = $announcements;
}
...
<div class='topic_buttons'>
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_announcements']}\">
		...
		" . ((is_array( $announcements ) AND count( $announcements )) ? ("
						".$this->__f__af46ad77f884c4689d112312c664fed0($announcements)."		") : ("
			<tr>
...
function __f__7991e56f98822c86b4dc3c6b56e389f0($announcements,$announce='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__af46ad77f884c4689d112312c664fed0($announcements)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
					...
					<td>
						<div class=\"forumdesc\">
							...
							") : ("" . ((is_array( $announce['_forums'] ) and count( $announce['_forums'] )) ? ("
									<ul>
									".$this->__f__7991e56f98822c86b4dc3c6b56e389f0($announcements,$announce)."									</ul>
								") : ("
...
{
$count_b834d7f47636369cb52063ff4a16570f = is_array($this->functionData['modControls']) ? count($this->functionData['modControls']) : 0;
$this->functionData['modControls'][$count_b834d7f47636369cb52063ff4a16570f]['editmember'] = $editmember;
$this->functionData['modControls'][$count_b834d7f47636369cb52063ff4a16570f]['warnpanel'] = $warnpanel;
$this->functionData['modControls'][$count_b834d7f47636369cb52063ff4a16570f]['warnlogs'] = $warnlogs;
$this->functionData['modControls'][$count_b834d7f47636369cb52063ff4a16570f]['noteForm'] = $noteForm;
$this->functionData['modControls'][$count_b834d7f47636369cb52063ff4a16570f]['return'] = $return;
}
...
{
$count_c10843cacf4bc5f0e0ced2b4eea355c8 = is_array($this->functionData['modcpMessage']) ? count($this->functionData['modcpMessage']) : 0;
$this->functionData['modcpMessage'][$count_c10843cacf4bc5f0e0ced2b4eea355c8]['message'] = $message;
}
...
{
$count_3ac094f8a61c809094b93ac4364cc80e = is_array($this->functionData['modCPpost']) ? count($this->functionData['modCPpost']) : 0;
$this->functionData['modCPpost'][$count_3ac094f8a61c809094b93ac4364cc80e]['post'] = $post;
$this->functionData['modCPpost'][$count_3ac094f8a61c809094b93ac4364cc80e]['displayData'] = $displayData;
$this->functionData['modCPpost'][$count_3ac094f8a61c809094b93ac4364cc80e]['topic'] = $topic;
$this->functionData['modCPpost'][$count_3ac094f8a61c809094b93ac4364cc80e]['type'] = $type;
}
...
{
$count_555d7e3ba0bed01419280bc2511c0f02 = is_array($this->functionData['modCPtopic']) ? count($this->functionData['modCPtopic']) : 0;
$this->functionData['modCPtopic'][$count_555d7e3ba0bed01419280bc2511c0f02]['topics'] = $topics;
$this->functionData['modCPtopic'][$count_555d7e3ba0bed01419280bc2511c0f02]['pagelinks'] = $pagelinks;
$this->functionData['modCPtopic'][$count_555d7e3ba0bed01419280bc2511c0f02]['type'] = $type;
$this->functionData['modCPtopic'][$count_555d7e3ba0bed01419280bc2511c0f02]['sdelete'] = $sdelete;
}
$IPBHTML .= "".$this->__f__de632da0c7baeefa4788d694f97aa512($topics,$pagelinks,$type,$sdelete)."";
return $IPBHTML;
}


function __f__725485b1458ea926323d746d314a73eb($topics, $pagelinks, $type, $sdelete=array(),$tid='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__de632da0c7baeefa4788d694f97aa512($topics, $pagelinks, $type, $sdelete=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	<tr class='__topic' id='trow_{$data['tid']}' data-tid=\"{$data['tid']}\">
		<td class='__tid{$data['tid']} with_mod_links'>	
			...
			" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
				...
				".$this->__f__725485b1458ea926323d746d314a73eb($topics,$pagelinks,$type,$sdelete,$tid,$data)."				</ul>
			") : ("")) . "
			<br />
...
{
$count_793fae29a1d5f3f3e9ca8a4791f61e80 = is_array($this->functionData['overview']) ? count($this->functionData['overview']) : 0;
}
$IPBHTML .= "<div class='clearfix '>
	<div class='ipsBox_container ipsPad'>
		<p>{$this->lang->words['intro_blurb']}</p>
...
{
$count_e838b844b38fb75dafec112702d7dcde = is_array($this->functionData['portalPage']) ? count($this->functionData['portalPage']) : 0;
$this->functionData['portalPage'][$count_e838b844b38fb75dafec112702d7dcde]['output'] = $output;
$this->functionData['portalPage'][$count_e838b844b38fb75dafec112702d7dcde]['tabs'] = $tabs;
$this->functionData['portalPage'][$count_e838b844b38fb75dafec112702d7dcde]['_activeNav'] = $_activeNav;
}
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left' id='modcp_tabs'>
			<ul class='clear'>
				...
				".$this->__f__dff568655fcf983bc1316ce1ebcf89fe($output,$tabs,$_activeNav)."			</ul>
		</div>
...
function __f__dff568655fcf983bc1316ce1ebcf89fe($output, $tabs=array(), $_activeNav=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_41018e3a91d0a1ead19f583d57052986 = is_array($this->functionData['subTabLoop']) ? count($this->functionData['subTabLoop']) : 0;
}
$IPBHTML .= "".$this->__f__49df2fbd3414f5b1dfd31f934cbfe0ec()."";
return $IPBHTML;
}


function __f__09d7bd82d78ba3d1c52740a5bbbb6ca0($mainTabKey='',$subTabs='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__49df2fbd3414f5b1dfd31f934cbfe0ec()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	" . (($mainTabKey == $this->templateVars['activeNav']['primary']) ? ("" . ((count( $subTabs ) > 1) ? ("
			<div class='maintitle ipsFilterbar clear'>
				<ul class='ipsList_inline'>									
					".$this->__f__09d7bd82d78ba3d1c52740a5bbbb6ca0($mainTabKey,$subTabs)."				</ul>
			</div>
		") : ("")) . "") : ("")) . "
...
{
$count_5724d3b0d3dfc71a8a6f9a52243852e3 = is_array($this->functionData['unapprovedPosts']) ? count($this->functionData['unapprovedPosts']) : 0;
$this->functionData['unapprovedPosts'][$count_5724d3b0d3dfc71a8a6f9a52243852e3]['posts'] = $posts;
$this->functionData['unapprovedPosts'][$count_5724d3b0d3dfc71a8a6f9a52243852e3]['pagelinks'] = $pagelinks;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("topic", "0" ) . "
" . ((!$this->settings['disable_lightbox']) ? ("
" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'include_lightbox' ) ? $this->registry->getClass('output')->getTemplate('global')->include_lightbox() : '' ) . "
...
<div class='clearfix'>
	" . ((is_array( $posts ) AND count( $posts )) ? ("
		<div id='ips_Posts2'>
			".$this->__f__98ed09aeb99845c67a844d41bccc7778($posts,$pagelinks)."		</div>
	") : ("
		<div class='no_messages'>
...
function __f__98ed09aeb99845c67a844d41bccc7778($posts, $pagelinks)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $posts as $post )
...
{
$count_73b7925d0d47bf9b937935205806ede8 = is_array($this->functionData['unapprovedTopics']) ? count($this->functionData['unapprovedTopics']) : 0;
$this->functionData['unapprovedTopics'][$count_73b7925d0d47bf9b937935205806ede8]['topics'] = $topics;
$this->functionData['unapprovedTopics'][$count_73b7925d0d47bf9b937935205806ede8]['pagelinks'] = $pagelinks;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("forums", "0" ) . "
<div>{$pagelinks}</div>
" . ( method_exists( $this->registry->getClass('output')->getTemplate('modcp'), 'subTabLoop' ) ? $this->registry->getClass('output')->getTemplate('modcp')->subTabLoop() : '' ) . "
...
{
$count_3b80953d2d01cb747068946fa8fde7ea = is_array($this->functionData['warn_view_log']) ? count($this->functionData['warn_view_log']) : 0;
$this->functionData['warn_view_log'][$count_3b80953d2d01cb747068946fa8fde7ea]['member'] = $member;
$this->functionData['warn_view_log'][$count_3b80953d2d01cb747068946fa8fde7ea]['rows'] = $rows;
$this->functionData['warn_view_log'][$count_3b80953d2d01cb747068946fa8fde7ea]['links'] = $links;
}
...
$IPBHTML .= "" . (($this->request['module']=='ajax') ? ("
	...
	") : ("")) . "
		<table class='ipb_table'>
			...
			") : ("
								".$this->__f__9237da44784a189c40a97a4144d0fb27($member,$rows,$links)."			")) . "
		</table>
...
function __f__9237da44784a189c40a97a4144d0fb27($member, $rows, $links='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
{
$count_2dcdcec8b3e36d3ccbcc8d84ffdd28da = is_array($this->functionData['warnForm']) ? count($this->functionData['warnForm']) : 0;
$this->functionData['warnForm'][$count_2dcdcec8b3e36d3ccbcc8d84ffdd28da]['member'] = $member;
$this->functionData['warnForm'][$count_2dcdcec8b3e36d3ccbcc8d84ffdd28da]['errors'] = $errors;
$this->functionData['warnForm'][$count_2dcdcec8b3e36d3ccbcc8d84ffdd28da]['modque'] = $modque;
$this->functionData['warnForm'][$count_2dcdcec8b3e36d3ccbcc8d84ffdd28da]['postque'] = $postque;
$this->functionData['warnForm'][$count_2dcdcec8b3e36d3ccbcc8d84ffdd28da]['ban'] = $ban;
$this->functionData['warnForm'][$count_2dcdcec8b3e36d3ccbcc8d84ffdd28da]['editor_html'] = $editor_html;
}
