...
{
$count_a4aa49a46f9b995041fdeff82cfc993d = is_array($this->functionData['forumAttachments']) ? count($this->functionData['forumAttachments']) : 0;
$this->functionData['forumAttachments'][$count_a4aa49a46f9b995041fdeff82cfc993d]['title'] = $title;
$this->functionData['forumAttachments'][$count_a4aa49a46f9b995041fdeff82cfc993d]['rows'] = $rows;
$this->functionData['forumAttachments'][$count_a4aa49a46f9b995041fdeff82cfc993d]['pages'] = $pages;
}
...
<table class='ipb_table'>
	<tr class='header'>
		...
		" . ((count($rows)) ? ("".$this->__f__01d07f92999be60cd2c924df5411a1e9($title,$rows,$pages)."	") : ("")) . "
</table>
" . (($pages) ? ("
	<br />
	<div class='topic_controls'>{$pages}</div>
...
function __f__01d07f92999be60cd2c924df5411a1e9($title, $rows, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9ad46e33f1b13b501908cfb0f21dcab2 = is_array($this->functionData['forumIndexTemplate']) ? count($this->functionData['forumIndexTemplate']) : 0;
$this->functionData['forumIndexTemplate'][$count_9ad46e33f1b13b501908cfb0f21dcab2]['forum_data'] = $forum_data;
$this->functionData['forumIndexTemplate'][$count_9ad46e33f1b13b501908cfb0f21dcab2]['announce_data'] = $announce_data;
$this->functionData['forumIndexTemplate'][$count_9ad46e33f1b13b501908cfb0f21dcab2]['topic_data'] = $topic_data;
$this->functionData['forumIndexTemplate'][$count_9ad46e33f1b13b501908cfb0f21dcab2]['other_data'] = $other_data;
$this->functionData['forumIndexTemplate'][$count_9ad46e33f1b13b501908cfb0f21dcab2]['multi_mod_data'] = $multi_mod_data;
$this->functionData['forumIndexTemplate'][$count_9ad46e33f1b13b501908cfb0f21dcab2]['sub_forum_data'] = $sub_forum_data;
$this->functionData['forumIndexTemplate'][$count_9ad46e33f1b13b501908cfb0f21dcab2]['footer_filter'] = $footer_filter;
$this->functionData['forumIndexTemplate'][$count_9ad46e33f1b13b501908cfb0f21dcab2]['active_user_data'] = $active_user_data;
$this->functionData['forumIndexTemplate'][$count_9ad46e33f1b13b501908cfb0f21dcab2]['mod_data'] = $mod_data;
$this->functionData['forumIndexTemplate'][$count_9ad46e33f1b13b501908cfb0f21dcab2]['inforum'] = $inforum;
}
...
" . ((is_array( $announce_data ) AND count( $announce_data )) ? ("
	<div class='content_border'><table class='ipb_table topic_list hover_rows' summary='{$this->lang->words['forum_topic_list']} \"{$forum_data['name']}\"' id='announcements'>
		".$this->__f__f4c34c1a8c7d789adf48f86e75b3abff($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."	</table></div>
	<br />	
") : ("")) . "
<!-- __-SUBFORUMS-__ -->
		...
		<div class='ipsBox table_wrap removeDefault'>
			<div class='ipsBox_container'>
				<table class='ipb_table' summary=\"{$this->lang->words['cat_subforums']} '{$forum_data['name']}'\">
					".$this->__f__ea22b82445e9cf2e192531081733f0b4($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."				</table>
			</div>
		...
		<div class='ipsBox_container'>
			<table class='ipb_table topic_list hover_rows " . (($this->memberData['is_mod'] == 1) ? ("is_mod") : ("")) . "' summary='{$this->lang->words['forum_topic_list']} \"{$forum_data['name']}\"' id='forum_table'>
				...
				" . ((is_array( $topic_data ) AND count( $topic_data )) ? ("
					".$this->__f__df23cd0c366e243cf31faccea39c9b0a($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."				") : ("<tr> 
						" . (($this->memberData['is_mod'] == 1) ? ("
	...
	<div id='forum_footer' class='statistics clear clearfix'>
		" . ((is_array( $mod_data ) AND count( $mod_data )) ? ("
			<div id='forum_led_by' class='right ipsType_small'>
				...
				".$this->__f__976ce97fa305afd5bdf0571198dafff2($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."			</div>
		") : ("")) . "
...
" . ((is_array( $multi_mod_data ) AND count( $multi_mod_data )) ? ("
    ".$this->__f__207a7bc22e10afefc569fbbb5de34a19($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."") : ("")) . "
</select>";
return $IPBHTML;
}


function __f__f4c34c1a8c7d789adf48f86e75b3abff($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5592a47018c704407f27b5057e10d43b($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__11a2ec721214e31f2c66bbaf97c93889($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
$imageURL = "{$this->settings['img_url']}";
		...
		$_ips___x_retval .= "
								" . (($forum_data['redirect_on']) ? ("<tr class='redirect_forum' id='f_{$forum_data['id']}'>
										...
										<td class='col_c_icon'> " . (($forum_data['_has_unread']) ? ("<a id='forum_img_{$forum_data['id']}' href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&module=forums&section=markasread&marktype=forum&forumid={$forum_data['id']}&returntoforumid={$this->request['f']}&i=1", "public",'' ), "", "" ) . "\" data-tooltip=\"{$this->lang->words['bi_markread']}\" class='forum_marker'>" . (($forum_data['icon'] != '' AND $forum_data['icon'] !='0') ? ("{$forum_data['icon']}") : ("<img src='{$this->settings['img_url']}/f_icon.png' />")) . "</a> <script type='text/javascript'> " . (($this->settings['dp3_fi_mode'] == 'replace') ? ("var unreadIcon = \"{$forum_data['icon_read']}\";") : ("")) . " ipb.global.registerMarker( \"forum_img_{$forum_data['id']}\", \"{$forum_data['img_new_post']}\", markerURL + \"&forumid={$forum_data['id']}\" ); </script>") : ("" . (($forum_data['icon'] != '' AND $forum_data['icon'] !='0') ? ("{$forum_data['icon']}") : ("<img src='{$this->settings['img_url']}/f_icon_read.png' />")) . "")) . " </td>
										<td class='col_c_forum'>									
											...
											" . (($forum_data['show_subforums'] AND count( $forum_data['subforums'] ) AND $forum_data['show_subforums']) ? ("
												<ol class='ipsList_inline ipsType_small subforums' id='subforums_{$forum_data['id']}'>
													".$this->__f__5592a47018c704407f27b5057e10d43b($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data,$forum_id,$forum_data)."												</ol>
											") : ("")) . "
...
function __f__ea22b82445e9cf2e192531081733f0b4($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sub_forum_data as $_data )
	{
		...
		$_ips___x_retval .= "
						" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("
							".$this->__f__11a2ec721214e31f2c66bbaf97c93889($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data)."						") : ("")) . "
...
function __f__df23cd0c366e243cf31faccea39c9b0a($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__976ce97fa305afd5bdf0571198dafff2($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__207a7bc22e10afefc569fbbb5de34a19($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c8d202d834b12779adf9e90a3ea36efa = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_c8d202d834b12779adf9e90a3ea36efa]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_c8d202d834b12779adf9e90a3ea36efa]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_c8d202d834b12779adf9e90a3ea36efa]['opts'] = $opts;
}
...
/* -- moderators_index_forums --*/
function moderators_index_forums($fid) {
$IPBHTML = "";
$IPBHTML .= "" . (($this->settings['moderatorsindex_onoff'] AND $this->registry->getClass('class_forums')->forumsGetModerators( $fid )) ? ("<div id='forum_led_by' class='ipsType_small'>
		" . (($this->settings['moderatorsindex_showgif'] == 1) ? ("<img src='{$this->settings['img_url']}/icon_users.png' /> &nbsp;") : ("")) . "{$this->lang->words['forum_led_by']}
		".$this->__f__ec8847bb6a41e0e67b838ab80c7398ea($fid)."	</div>
<br />") : ("")) . "";
return $IPBHTML;
}


function __f__ec8847bb6a41e0e67b838ab80c7398ea($fid)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->registry->getClass('class_forums')->forumsGetModerators( $fid ) as $p => $r )
	{
		
		$__iteratorCount++;
		$_ips___x_retval .= "
			<a href='{$r[0]}' title='{$this->lang->words['view_profile']}'>{$r[1]}</a>" . (($r[2]) ? ("") : ("")) . "" . (($p + 1 != count( $this->registry->getClass('class_forums')->forumsGetModerators( $fid ) )) ? (",") : ("")) . "
...
{
$count_20687c1e03cda595accda3ce95229fb3 = is_array($this->functionData['topic']) ? count($this->functionData['topic']) : 0;
$this->functionData['topic'][$count_20687c1e03cda595accda3ce95229fb3]['data'] = $data;
$this->functionData['topic'][$count_20687c1e03cda595accda3ce95229fb3]['forum_data'] = $forum_data;
$this->functionData['topic'][$count_20687c1e03cda595accda3ce95229fb3]['other_data'] = $other_data;
$this->functionData['topic'][$count_20687c1e03cda595accda3ce95229fb3]['inforum'] = $inforum;
}
...
" . (($data['_answeredPid'] !== false) ? ("
		...
		") : ("")) . "
		" . ((! $inforum && $data['nav']) ? ("
            ".$this->__f__fd611d0776ddc0507128096658ba7f11($data,$forum_data,$other_data,$inforum)."        ") : ("")) . "
        <h4>
            {$data['prefix']}
		...
		" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
			...
			".$this->__f__31e01a721bb14f09f138a40abfbb6382($data,$forum_data,$other_data,$inforum)."			</ul>
		") : ("")) . "
	</td>
...
function __f__fd611d0776ddc0507128096658ba7f11($data, $forum_data, $other_data, $inforum)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__31e01a721bb14f09f138a40abfbb6382($data, $forum_data, $other_data, $inforum)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f28eb237ae3d84d1d9bf242d4bb1fe9b = is_array($this->functionData['topic_rating_image']) ? count($this->functionData['topic_rating_image']) : 0;
$this->functionData['topic_rating_image'][$count_f28eb237ae3d84d1d9bf242d4bb1fe9b]['rating_id'] = $rating_id;
}
$IPBHTML .= "<span class='mini_rate'>".$this->__f__2248983ce021618917d057007b1c4c17($rating_id)."</span>";
return $IPBHTML;
}


function __f__2248983ce021618917d057007b1c4c17($rating_id=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a64f283f26792bc49086460243d9703b = is_array($this->functionData['topicPrefixWrap']) ? count($this->functionData['topicPrefixWrap']) : 0;
$this->functionData['topicPrefixWrap'][$count_a64f283f26792bc49086460243d9703b]['text'] = $text;
}
$IPBHTML .= "" . (($text) ? ("
