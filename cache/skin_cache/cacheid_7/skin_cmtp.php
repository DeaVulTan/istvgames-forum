...
{
$count_60ae736da757c75ec3964ade7054e4c9 = is_array($this->functionData['group_strip_fix']) ? count($this->functionData['group_strip_fix']) : 0;
$this->functionData['group_strip_fix'][$count_60ae736da757c75ec3964ade7054e4c9]['group'] = $group;
$this->functionData['group_strip_fix'][$count_60ae736da757c75ec3964ade7054e4c9]['members'] = $members;
$this->functionData['group_strip_fix'][$count_60ae736da757c75ec3964ade7054e4c9]['pagination'] = $pagination;
}
...
<table class='ipb_table ipsMemberList'>
	...
	" . ((count($members) AND is_array($members)) ? ("
				".$this->__f__5c1729f9c73d18a540ad4e19536dbe84($group,$members,$pagination)."	") : ("")) . "
</table>
" . (($pagination) ? ("
	<div class='topic_controls'>{$pagination}</div>
") : ("")) . "
...
function __f__3dbd41c180652caf099f91400d0077e4($group='', $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2bcb770e3660f427ed5b7b245c2fb2c4($group='', $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $info['forums'] as $id => $name )
...
function __f__5c1729f9c73d18a540ad4e19536dbe84($group='', $members=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
			...
			<tr class='" .  IPSLib::next( $this->registry->templateStriping["staff"] ) . "'>
				...
				<td class='altrow short'>
					" . ((is_array($info['forums'])) ? ("" . ((count( $info['forums'] ) == 1) ? ("
							".$this->__f__3dbd41c180652caf099f91400d0077e4($group,$members,$pagination,$info)."						") : ("
							...
							".$this->__f__2bcb770e3660f427ed5b7b245c2fb2c4($group,$members,$pagination,$info)."							</ul>
