...
{
$count_ece3ae200c1d0e8d4e8763896d99029e = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_ece3ae200c1d0e8d4e8763896d99029e]['r'] = $r;
$this->functionData['comment'][$count_ece3ae200c1d0e8d4e8763896d99029e]['parent'] = $parent;
$this->functionData['comment'][$count_ece3ae200c1d0e8d4e8763896d99029e]['settings'] = $settings;
}
...
{
$count_bca0f0c7c90c84c03ffd99cc150b2880 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_bca0f0c7c90c84c03ffd99cc150b2880]['r'] = $r;
$this->functionData['commentHidden'][$count_bca0f0c7c90c84c03ffd99cc150b2880]['parent'] = $parent;
$this->functionData['commentHidden'][$count_bca0f0c7c90c84c03ffd99cc150b2880]['settings'] = $settings;
}
...
{
$count_a955ab122c76a8e4264b1a9795a1b02f = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_a955ab122c76a8e4264b1a9795a1b02f]['comments'] = $comments;
$this->functionData['commentsList'][$count_a955ab122c76a8e4264b1a9795a1b02f]['settings'] = $settings;
$this->functionData['commentsList'][$count_a955ab122c76a8e4264b1a9795a1b02f]['pages'] = $pages;
$this->functionData['commentsList'][$count_a955ab122c76a8e4264b1a9795a1b02f]['parent'] = $parent;
$this->functionData['commentsList'][$count_a955ab122c76a8e4264b1a9795a1b02f]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__b53a80c5c0a483c0a4e3a9be5587755c($comments,$settings,$pages,$parent,$preReply)."</div>
...
function __f__b53a80c5c0a483c0a4e3a9be5587755c($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_556eaf3867ec85739e57e68caed67954 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_556eaf3867ec85739e57e68caed67954]['comment'] = $comment;
$this->functionData['form'][$count_556eaf3867ec85739e57e68caed67954]['parent'] = $parent;
$this->functionData['form'][$count_556eaf3867ec85739e57e68caed67954]['editor'] = $editor;
$this->functionData['form'][$count_556eaf3867ec85739e57e68caed67954]['settings'] = $settings;
$this->functionData['form'][$count_556eaf3867ec85739e57e68caed67954]['errors'] = $errors;
$this->functionData['form'][$count_556eaf3867ec85739e57e68caed67954]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
