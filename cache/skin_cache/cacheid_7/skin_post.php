...
{
$count_18b22c6aa345138b6f9b4f0b57b66193 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_18b22c6aa345138b6f9b4f0b57b66193]['data'] = $data;
}
...
{
$count_75b27e88b558dfe10581d84bc4d1f076 = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_75b27e88b558dfe10581d84bc4d1f076]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_75b27e88b558dfe10581d84bc4d1f076]['form'] = $form;
}
...
{
$count_a33a290bf603823bcd2a7a609fdbcb22 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_a33a290bf603823bcd2a7a609fdbcb22]['data'] = $data;
}
...
{
$count_e994b92c10526cd4a356be90d8a75cdf = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_e994b92c10526cd4a356be90d8a75cdf]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__4844cbdef40b2b6344b983bd13b887f5($posts)."") : ("")) . "
<p class='submit'>
...
function __f__4844cbdef40b2b6344b983bd13b887f5($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0db1497be0ad199ece1d22e9492c76bb = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_0db1497be0ad199ece1d22e9492c76bb]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_0db1497be0ad199ece1d22e9492c76bb]['type'] = $type;
$this->functionData['uploadForm'][$count_0db1497be0ad199ece1d22e9492c76bb]['stats'] = $stats;
$this->functionData['uploadForm'][$count_0db1497be0ad199ece1d22e9492c76bb]['id'] = $id;
$this->functionData['uploadForm'][$count_0db1497be0ad199ece1d22e9492c76bb]['forum_id'] = $forum_id;
}
