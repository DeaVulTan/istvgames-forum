...
/* CACHE FILE: Generated: Mon, 28 Dec 2015 21:23:45 GMT */
...
$IPBHTML = "";
$IPBHTML .= "" . (($this->settings['textLogo']=='yes') ? ("
<a href='{$this->settings['board_url']}' class='textLogo' title='{$this->lang->words['go_home']}' rel=\"home\" accesskey='1'>IstvGames.uz</a>
") : ("
...
{
$count_0978ec2481f37827f1fdc71fffbc8112 = is_array($this->functionData['fcRepBar']) ? count($this->functionData['fcRepBar']) : 0;
$this->functionData['fcRepBar'][$count_0978ec2481f37827f1fdc71fffbc8112]['author'] = $author;
}
...
{
$count_1bf8d03f7b6d1647264b0d356ac13665 = is_array($this->functionData['friendsOnline_globalmenu_frindslist']) ? count($this->functionData['friendsOnline_globalmenu_frindslist']) : 0;
$this->functionData['friendsOnline_globalmenu_frindslist'][$count_1bf8d03f7b6d1647264b0d356ac13665]['active'] = $active;
$this->functionData['friendsOnline_globalmenu_frindslist'][$count_1bf8d03f7b6d1647264b0d356ac13665]['actives'] = $actives;
}
...
<ul class='ipsList_withminiphoto'>
	" . ((is_array( $active ) && count( $active )) ? ("
		".$this->__f__da9ec88dbb017bc8db8397ccfb8b564f($active,$actives)."	") : ("
...
" . (($this->settings['friendsOnline_staff_on']) ? ("<h4 class='ipsType_sectiontitle'>{$this->lang->words['staffOnline']}</h4>
	<ul class='ipsList_withminiphoto'>
		" . ((is_array( $actives ) && count( $actives )) ? ("
			".$this->__f__cb20a89c80a6219842ce8d0b38e844c6($active,$actives)."		") : ("
...
function __f__da9ec88dbb017bc8db8397ccfb8b564f($active, $actives)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $active as $r )
...
function __f__cb20a89c80a6219842ce8d0b38e844c6($active, $actives)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_874c333973a8844c04bab2c5a5558e56 = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_874c333973a8844c04bab2c5a5558e56]['html'] = $html;
$this->functionData['globalTemplate'][$count_874c333973a8844c04bab2c5a5558e56]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_874c333973a8844c04bab2c5a5558e56]['css'] = $css;
$this->functionData['globalTemplate'][$count_874c333973a8844c04bab2c5a5558e56]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_874c333973a8844c04bab2c5a5558e56]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_874c333973a8844c04bab2c5a5558e56]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_874c333973a8844c04bab2c5a5558e56]['items'] = $items;
$this->functionData['globalTemplate'][$count_874c333973a8844c04bab2c5a5558e56]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_874c333973a8844c04bab2c5a5558e56]['stats'] = $stats;
}
...
$IPBHTML .= "<!DOCTYPE html>
	...
	<head>
		...
		<script type='text/javascript'>!window.jQuery && document.write('<script src=\"/public/js/jquery.min.js\"><\\/script>')</script>
...
<li class=‘left’><a href='http://img.istvgames.uz' target=\"_blank\">Хостинг изображений</a></li>
	                    ...
	                    " . ((!empty($header_items['primary_navigation_menu'])) ? ("
	                        ...
	                        ".$this->__f__74da769ffaa221695b1e941a6afd0038($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."	                    ") : ("")) . "")) . "
			...
			<div id='content' class='clearfix'>
                ...
                <div id='secondary_navigation' class='clearfix'>
                    <ol class='breadcrumb top ipsList_inline left' id='breadcrumb'>
                            ...
                            " . (($this->did_first=1) ? ("") : ("")) . "") : ("")) . "
                        ".$this->__f__16c66c43d63e9adfe6e8063e0a04ce43($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."                    </ol>
...
Зарегистрируйтесь, чтобы получить доступ до полного функционала форума. Эта надпись пропадет после авторизации на форуме.<br />
<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=global&amp;section=login", "public",'' ), "", "" ) . "' class='guestButton'>Авторизоваться</a> <a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=global&amp;section=register", "public",'' ), "", "" ) . "' class='guestButton'>Зарегистрироваться</a>
                </div>
                ") : ("")) . "
				...
				" . (($items['adHeaderCode']) ? ("
					<div class='ipsAd'>{$items['adHeaderCode']}</div><br>
				") : ("")) . "
				...
				<ol class='breadcrumb bottom ipsList_inline left clearfix clear'>
					" . ((count( $items['navigation'] )) ? ("						" . ((!$this->settings['remove_forums_nav'] OR ipsRegistry::$current_application == 'forums') ? ("<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "act=idx", "public",'' ), "false", "" ) . "'>{$this->settings['board_name']}</a></li>
						...
						".$this->__f__0082002adb7ae99f9e89bd5fd92dc73b($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."") : ("
						<li>&nbsp;</li>
					")) . "
				</ol>
			...
			<div id='footer_utilities' class='clearfix clear'>
				...
				<p id=\"copyright\"><a href=\"http://istv.uz/\" target=\"_blank\" >© ISTV.UZ 2015</a>  </p>
				<ul class='ipsList_inline left'>
<!--
					<li>
						...
						" . ((count($footer_items['skin_chooser']) > 1) ? ("
							<li>
								...
								<ul id='new_skin_menucontent' class='ipbmenu_content with_checks' style='display: none'>
									".$this->__f__8ed2d6cf4a93ac65879d908375916120($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								</ul>
							</li>
						") : ("")) . "")) . "") : ("")) . "
					" . ((! $this->member->is_not_human && count( $footer_items['lang_chooser']['options'] ) > 1) ? ("
						<li>
							...
							<ul id='new_language_menucontent' class='ipbmenu_content with_checks' style='display: none'>
								".$this->__f__25f93e9b671c42ef203f812c7f52992a($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							</ul>
						</li>
					") : ("")) . "
					" . ((( ! $this->member->is_not_human ) && ( $this->memberData['member_id'] || $this->settings['topic_marking_guests'] )) ? ("
						<li>
							...
							<ul id='mark_all_read_menucontent' class='ipbmenu_content' style='display: none'>
								".$this->__f__02c5d5ca1b5e7088e0090056ba9e7596($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								<li>
...
function __f__74da769ffaa221695b1e941a6afd0038($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__16c66c43d63e9adfe6e8063e0a04ce43($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0082002adb7ae99f9e89bd5fd92dc73b($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $items['navigation'] as $idx => $data )
...
function __f__8ed2d6cf4a93ac65879d908375916120($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__25f93e9b671c42ef203f812c7f52992a($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__02c5d5ca1b5e7088e0090056ba9e7596($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_07cc572f3267a2dc7e9f4c0ef60ca221 = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_07cc572f3267a2dc7e9f4c0ef60ca221]['css'] = $css;
}

$this->minify = array();
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__170e6d4b4768dbc23a3c975033e08a29($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__760b26ab10fad7ca67be354298466258($css)."") : ("")) . "<!--hook.if.skin_global.includeCSS.inlinecss.post.endif-->
<!--[if lte IE 7]>
...
function __f__170e6d4b4768dbc23a3c975033e08a29($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__760b26ab10fad7ca67be354298466258($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f2c83c216b8b74d3367bcb9c6f55bae9 = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_f2c83c216b8b74d3367bcb9c6f55bae9]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__44f37d76379db34e1407780d8fa3d0ad($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__84c6d48889a52a0bfac35729919cca85($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__44f37d76379db34e1407780d8fa3d0ad($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__84c6d48889a52a0bfac35729919cca85($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_5e287bf2696f08de43f566d73669b54f = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_5e287bf2696f08de43f566d73669b54f]['jsModules'] = $jsModules;
}
...
{
$count_714732479e8074f3bd7e7691aed79c6a = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_714732479e8074f3bd7e7691aed79c6a]['metaTags'] = $metaTags;
}
$IPBHTML .= "" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__658bc33568b3b6af7d5f328852638dca($metaTags)."") : ("")) . "
<meta property=\"og:image\" content=\"{$this->settings['meta_imagesrc']}\"/>";
return $IPBHTML;
}


function __f__54d62dab339641eddf432c84a4c66a5f($metaTags,$tag='',$id='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__658bc33568b3b6af7d5f328852638dca($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $metaTags as $tag => $id )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__54d62dab339641eddf432c84a4c66a5f($metaTags,$tag,$id)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_d5547868cf783045ddc90d4828494fb6 = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__242372a7cc043316519ccb623947d401()."" . (($this->isRtlLang AND is_file( DOC_IPS_ROOT_PATH . '/' . PUBLIC_DIRECTORY . '/style_css/' . $this->registry->output->skin['_csscacheid'] . '/ipb_rtl.css' )) ? ("
...
function __f__242372a7cc043316519ccb623947d401()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1c973c92c307230bd529d0b3e2b83816 = is_array($this->functionData['includeVars']) ? count($this->functionData['includeVars']) : 0;
$this->functionData['includeVars'][$count_1c973c92c307230bd529d0b3e2b83816]['header_items'] = $header_items;
}
...
{
$count_691dc24e8247fa3a2950005060bb98ae = is_array($this->functionData['inlineLogin']) ? count($this->functionData['inlineLogin']) : 0;
}
					...
					<ul class='ipsList_inline'>
						...
						") : ("")) . "
							" . ((is_array($this->_formFields) AND count($this->_formFields)) ? ("
								".$this->__f__d2362f25dd533593912bdcf77db2a171()."							") : ("")) . "
					</ul>
				</div>") : ("")) . "
...
function __f__d2362f25dd533593912bdcf77db2a171()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ee88c317d500fc636cbcbc1aeadcc0b9 = is_array($this->functionData['liveEditJs']) ? count($this->functionData['liveEditJs']) : 0;
}
...
<div class='ipsBox ipsPad'>
	...
	<form action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&module=global&section=meta&do=save", "public",'' ), "", "" ) . "' method='post'>
		...
		<table class='ipb_table'>
			".$this->__f__cecdbd8fb76cedb228ef56230d8b6ddd($tags,$url)."		</table>
		</div>
		<table class='ipb_table'>
			<tr>
...
function __f__cecdbd8fb76cedb228ef56230d8b6ddd($tags, $url)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tags as $k => $v )
...
{
$count_3f34ac023b8d3ac09a887f72901ff18f = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_3f34ac023b8d3ac09a887f72901ff18f]['data'] = $data;
}
...
{
$count_7acb168fb4a64d856cad2dced89b6571 = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_7acb168fb4a64d856cad2dced89b6571]['work'] = $work;
$this->functionData['paginationTemplate'][$count_7acb168fb4a64d856cad2dced89b6571]['data'] = $data;
}
$IPBHTML .= "" . (($work['pages'] > 1) ? ("<div class='pagination clearfix left " . ((!$data['showNumbers']) ? ("no_numbers") : ("")) . "'>
		...
		<ul class='ipsList_inline left pages'>
			...
			" . ((is_array( $work['_pageNumbers'] ) && count( $work['_pageNumbers'] )) ? ("
				".$this->__f__241da04a62305ce87286c17dd341127c($work,$data)."			") : ("")) . "
		</ul>
...
function __f__241da04a62305ce87286c17dd341127c($work, $data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d733d2576ff1dd681ea2960520d11227 = is_array($this->functionData['quickSearch']) ? count($this->functionData['quickSearch']) : 0;
}
...
function __f__2676521ef644bfd562396d712734161d()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ff89952f953fcf632e0467cd6c10a896 = is_array($this->functionData['signature_separator']) ? count($this->functionData['signature_separator']) : 0;
$this->functionData['signature_separator'][$count_ff89952f953fcf632e0467cd6c10a896]['sig'] = $sig;
$this->functionData['signature_separator'][$count_ff89952f953fcf632e0467cd6c10a896]['author_id'] = $author_id;
$this->functionData['signature_separator'][$count_ff89952f953fcf632e0467cd6c10a896]['can_ignore'] = $can_ignore;
}
...
{
$count_56f3abb17e80c87b0355d01d9af190df = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_56f3abb17e80c87b0355d01d9af190df]['member'] = $member;
}
...
{
$count_c16189c977b3925467fe94074c6679c0 = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_c16189c977b3925467fe94074c6679c0]['author'] = $author;
$this->functionData['userInfoPane'][$count_c16189c977b3925467fe94074c6679c0]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_c16189c977b3925467fe94074c6679c0]['options'] = $options;
}
...
" . ((($this->settings['horizontalTopicView']=='yes') AND $this->request['section'] == 'topics') ? ("<div class='horizontalAvatar left'>
	...
	" . (($author['custom_fields'] != "") ? ("
		<ul class='horizontalInfoList custom_fields'>
			".$this->__f__0d08502d750bef5d603dd499eb0ab5eb($author,$contentid,$options)."		</ul>
	...
	" . (($author['custom_fields'] != "") ? ("
		<ul class='custom_fields'>
			".$this->__f__7b59c0d2c28367bef70c44184fe3614a($author,$contentid,$options)."		</ul>
	") : ("")) . "<!--hook.if.skin_global.userInfoPane.authorcfields.post.endif-->")) . "
...
function __f__774b70cef1321117c552bc8c49f83693($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0d08502d750bef5d603dd499eb0ab5eb($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__774b70cef1321117c552bc8c49f83693($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
function __f__8b239c6e9b2863a1731ed8700479e861($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'][ $group ] as $field )
...
function __f__7b59c0d2c28367bef70c44184fe3614a($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__8b239c6e9b2863a1731ed8700479e861($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_ec5e3b22eb9f74615c583c7cccba7191 = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_ec5e3b22eb9f74615c583c7cccba7191]['member'] = $member;
}
...
{
$count_3a54dcacaf4187ea334643c78a0db7dc = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_3a54dcacaf4187ea334643c78a0db7dc]['warning'] = $warning;
$this->functionData['warnDetails'][$count_3a54dcacaf4187ea334643c78a0db7dc]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__db365ff81c6f88c23731a508666e82c5($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__db365ff81c6f88c23731a508666e82c5($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
