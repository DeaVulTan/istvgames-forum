...
{
$count_5cd4bce8d3809a7d4ca04289a4cdf747 = is_array($this->functionData['friendsOnline']) ? count($this->functionData['friendsOnline']) : 0;
$this->functionData['friendsOnline'][$count_5cd4bce8d3809a7d4ca04289a4cdf747]['active'] = $active;
$this->functionData['friendsOnline'][$count_5cd4bce8d3809a7d4ca04289a4cdf747]['actives'] = $actives;
}
	  ...
	  <div class='ipsBox_container ipsPad' id='mlist_content'>
			<ul class='ipsMemberList'>
				" . ((is_array( $active ) and count( $active )) ? ("
										".$this->__f__d6c2d38087d37e040b8dc816b7a9c50d($active,$actives)."				") : ("
		  ...
		  <div class='ipsBox_container ipsPad' id='mlist_content'>
				<ul class='ipsMemberList'>
					" . ((is_array( $actives ) and count( $actives )) ? ("
												".$this->__f__f4b9d6bed3b71edb44f6805c53c88a02($active,$actives)."					") : ("
						<li class='no_messages'>
...
function __f__d6c2d38087d37e040b8dc816b7a9c50d($active, $actives)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__f4b9d6bed3b71edb44f6805c53c88a02($active, $actives)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1826fb8fb24c2381e32035ee87df7a0b = is_array($this->functionData['member_alpha_ru']) ? count($this->functionData['member_alpha_ru']) : 0;
$this->functionData['member_alpha_ru'][$count_1826fb8fb24c2381e32035ee87df7a0b]['url'] = $url;
}
$IPBHTML .= "<li id='alpha_switch' class='clickable'>РУС</li>
	...
	<div class='ipsVerticalTabbed_tabs ipsVerticalTabbed_minitabs ipsLayout_left' id='mlist_tabs_ru'>
		<ul>
    		...
    		")) . "
    ".$this->__f__635c23bfdcb16997f216c25a8512e193($url)."            <li id='alpha_switch_en' class='clickable'>АНГ</li>";
return $IPBHTML;
}


function __f__635c23bfdcb16997f216c25a8512e193($url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7406779dec60c813b4e4ddcf3c3a4bfd = is_array($this->functionData['member_list_show']) ? count($this->functionData['member_list_show']) : 0;
$this->functionData['member_list_show'][$count_7406779dec60c813b4e4ddcf3c3a4bfd]['members'] = $members;
$this->functionData['member_list_show'][$count_7406779dec60c813b4e4ddcf3c3a4bfd]['pages'] = $pages;
$this->functionData['member_list_show'][$count_7406779dec60c813b4e4ddcf3c3a4bfd]['dropdowns'] = $dropdowns;
$this->functionData['member_list_show'][$count_7406779dec60c813b4e4ddcf3c3a4bfd]['defaults'] = $defaults;
$this->functionData['member_list_show'][$count_7406779dec60c813b4e4ddcf3c3a4bfd]['custom_fields'] = $custom_fields;
$this->functionData['member_list_show'][$count_7406779dec60c813b4e4ddcf3c3a4bfd]['url'] = $url;
}
...
" . (($this->settings['pp_allow_member_rate']) ? ("<li class='field'>
			...
			" . ((count( $custom_fields->out_fields )) ? ("
				".$this->__f__38fe97638e3f555eb676633b805e1629($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			") : ("")) . "			
		</ul>
		<ul id='filters_2'>
			<li class='field'>
		...
		<fieldset class='other_filters'>
			<select name='filter' class='input_select'>
				".$this->__f__5693dda3cfba17c4b9c59bbd0d143be2($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_by']}
			<select name='sort_key' class='input_select'>
				".$this->__f__4797cd7441d2fc388721da8c13aeb2c3($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_in']}
			<select name='sort_order' class='input_select'>
				".$this->__f__a5252451dd5e4d3f9226e8983e82ea1d($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_with']}
			<select name='max_results' class='input_select'>
				".$this->__f__1f40eff5489eb32efa0a6ea86db86b69($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
	...
	<div class='ipsVerticalTabbed_tabs ipsVerticalTabbed_minitabs ipsLayout_left' id='mlist_tabs'>
		<ul>
			...
			") : ("
				<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=members&amp;module=list", "public",'' ), "false", "members_list" ) . "' title='{$this->lang->words['mlist_view_all_title']}'>{$this->lang->words['mlist_view_all_txt']}</a></li>
			")) . "
			".$this->__f__c0984d4de32f19b2bf2d3bfdbadc229c($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."		</ul>
	</div>
	<div class='ipsVerticalTabbed_content ipsLayout_content'>
		<div class='ipsBox_container ipsPad' id='mlist_content'>
			<ul class='ipsMemberList'>
				" . ((is_array( $members ) and count( $members )) ? ("
										".$this->__f__a2d3bb405f5bae58ad3238036ba43758($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."				") : ("
					<li class='no_messages'>
...
function __f__38fe97638e3f555eb676633b805e1629($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5693dda3cfba17c4b9c59bbd0d143be2($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__4797cd7441d2fc388721da8c13aeb2c3($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a5252451dd5e4d3f9226e8983e82ea1d($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1f40eff5489eb32efa0a6ea86db86b69($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c0984d4de32f19b2bf2d3bfdbadc229c($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a2d3bb405f5bae58ad3238036ba43758($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
