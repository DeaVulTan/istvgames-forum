...
class skin_cmtp_16 extends skinMaster{
...
{
$count_668166f13ec4e52eef89a1d2bf4c9403 = is_array($this->functionData['group_strip_fix']) ? count($this->functionData['group_strip_fix']) : 0;
$this->functionData['group_strip_fix'][$count_668166f13ec4e52eef89a1d2bf4c9403]['group'] = $group;
$this->functionData['group_strip_fix'][$count_668166f13ec4e52eef89a1d2bf4c9403]['members'] = $members;
$this->functionData['group_strip_fix'][$count_668166f13ec4e52eef89a1d2bf4c9403]['pagination'] = $pagination;
}
...
<table class='ipb_table ipsMemberList'>
	...
	" . ((count($members) AND is_array($members)) ? ("
				".$this->__f__576be7054402b96bc2a739864063bf62($group,$members,$pagination)."	") : ("")) . "
</table>
" . (($pagination) ? ("
	<div class='topic_controls'>{$pagination}</div>
") : ("")) . "
...
function __f__06db2ac29dd57954a82d452a62e7a107($group='', $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1df938c52bd02a6e18d40517c23a260a($group='', $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $info['forums'] as $id => $name )
...
function __f__576be7054402b96bc2a739864063bf62($group='', $members=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
			...
			<tr class='" .  IPSLib::next( $this->registry->templateStriping["staff"] ) . "'>
				...
				<td class='altrow short'>
					" . ((is_array($info['forums'])) ? ("" . ((count( $info['forums'] ) == 1) ? ("
							".$this->__f__06db2ac29dd57954a82d452a62e7a107($group,$members,$pagination,$info)."						") : ("
							...
							".$this->__f__1df938c52bd02a6e18d40517c23a260a($group,$members,$pagination,$info)."							</ul>
