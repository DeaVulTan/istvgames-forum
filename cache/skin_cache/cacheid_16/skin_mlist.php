...
{
$count_32fd1074923cff849b93d49b3da82e1f = is_array($this->functionData['friendsOnline']) ? count($this->functionData['friendsOnline']) : 0;
$this->functionData['friendsOnline'][$count_32fd1074923cff849b93d49b3da82e1f]['active'] = $active;
$this->functionData['friendsOnline'][$count_32fd1074923cff849b93d49b3da82e1f]['actives'] = $actives;
}
	  ...
	  <div class='ipsBox_container ipsPad' id='mlist_content'>
			<ul class='ipsMemberList'>
				" . ((is_array( $active ) and count( $active )) ? ("
										".$this->__f__10868f3bc43d81361fd6bcdc0d2a93c4($active,$actives)."				") : ("
		  ...
		  <div class='ipsBox_container ipsPad' id='mlist_content'>
				<ul class='ipsMemberList'>
					" . ((is_array( $actives ) and count( $actives )) ? ("
												".$this->__f__5878af52a3d58564a5dba2ac025e78a1($active,$actives)."					") : ("
						<li class='no_messages'>
...
function __f__10868f3bc43d81361fd6bcdc0d2a93c4($active, $actives)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5878af52a3d58564a5dba2ac025e78a1($active, $actives)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_153ab9ef0675f2fcf30d8a69632953d7 = is_array($this->functionData['member_alpha_ru']) ? count($this->functionData['member_alpha_ru']) : 0;
$this->functionData['member_alpha_ru'][$count_153ab9ef0675f2fcf30d8a69632953d7]['url'] = $url;
}
$IPBHTML .= "<li id='alpha_switch' class='clickable'>РУС</li>
	...
	<div class='ipsVerticalTabbed_tabs ipsVerticalTabbed_minitabs ipsLayout_left' id='mlist_tabs_ru'>
		<ul>
    		...
    		")) . "
    ".$this->__f__0820c8925d959ba2d2f34f0feb863b3a($url)."            <li id='alpha_switch_en' class='clickable'>АНГ</li>";
return $IPBHTML;
}


function __f__0820c8925d959ba2d2f34f0feb863b3a($url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0c24d08cc5f455c309e36278258d32a2 = is_array($this->functionData['member_list_show']) ? count($this->functionData['member_list_show']) : 0;
$this->functionData['member_list_show'][$count_0c24d08cc5f455c309e36278258d32a2]['members'] = $members;
$this->functionData['member_list_show'][$count_0c24d08cc5f455c309e36278258d32a2]['pages'] = $pages;
$this->functionData['member_list_show'][$count_0c24d08cc5f455c309e36278258d32a2]['dropdowns'] = $dropdowns;
$this->functionData['member_list_show'][$count_0c24d08cc5f455c309e36278258d32a2]['defaults'] = $defaults;
$this->functionData['member_list_show'][$count_0c24d08cc5f455c309e36278258d32a2]['custom_fields'] = $custom_fields;
$this->functionData['member_list_show'][$count_0c24d08cc5f455c309e36278258d32a2]['url'] = $url;
}
...
" . (($this->settings['pp_allow_member_rate']) ? ("<li class='field'>
			...
			" . ((count( $custom_fields->out_fields )) ? ("
				".$this->__f__b4afbc4e34dc0f6b1abeecc184175534($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			") : ("")) . "			
		</ul>
		<ul id='filters_2'>
			<li class='field'>
		...
		<fieldset class='other_filters'>
			<select name='filter' class='input_select'>
				".$this->__f__b21ac0599b4153419b506628dd237aec($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_by']}
			<select name='sort_key' class='input_select'>
				".$this->__f__a3557febc8c94b141b4fa8059e2ac4f5($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_in']}
			<select name='sort_order' class='input_select'>
				".$this->__f__c3cc9b18323f2880cdd822a8bc87103e($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_with']}
			<select name='max_results' class='input_select'>
				".$this->__f__6860749d8d94bce59dacfafe8122213a($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
	...
	<div class='ipsVerticalTabbed_tabs ipsVerticalTabbed_minitabs ipsLayout_left' id='mlist_tabs'>
		<ul>
			...
			") : ("
				<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=members&amp;module=list", "public",'' ), "false", "members_list" ) . "' title='{$this->lang->words['mlist_view_all_title']}'>{$this->lang->words['mlist_view_all_txt']}</a></li>
			")) . "
			".$this->__f__55cb764f3763a8938ce54a4eb0a08a39($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."		</ul>
	</div>
	<div class='ipsVerticalTabbed_content ipsLayout_content'>
		<div class='ipsBox_container ipsPad' id='mlist_content'>
			<ul class='ipsMemberList'>
				" . ((is_array( $members ) and count( $members )) ? ("
										".$this->__f__fefab626f54d0f5f8f94c714dc68cc7b($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."				") : ("
					<li class='no_messages'>
...
function __f__b4afbc4e34dc0f6b1abeecc184175534($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b21ac0599b4153419b506628dd237aec($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a3557febc8c94b141b4fa8059e2ac4f5($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c3cc9b18323f2880cdd822a8bc87103e($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__6860749d8d94bce59dacfafe8122213a($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__55cb764f3763a8938ce54a4eb0a08a39($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__fefab626f54d0f5f8f94c714dc68cc7b($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
