...
{
$count_fd833ecc1fb64fc070d2b2de5b4775a2 = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_fd833ecc1fb64fc070d2b2de5b4775a2]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_fd833ecc1fb64fc070d2b2de5b4775a2]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_fd833ecc1fb64fc070d2b2de5b4775a2]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_fd833ecc1fb64fc070d2b2de5b4775a2]['extraData'] = $extraData;
}
...
{
$count_3efb8c307b05566802888c630d1d3014 = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_3efb8c307b05566802888c630d1d3014]['formField'] = $formField;
$this->functionData['editor'][$count_3efb8c307b05566802888c630d1d3014]['content'] = $content;
$this->functionData['editor'][$count_3efb8c307b05566802888c630d1d3014]['options'] = $options;
$this->functionData['editor'][$count_3efb8c307b05566802888c630d1d3014]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_3efb8c307b05566802888c630d1d3014]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_3efb8c307b05566802888c630d1d3014]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_3efb8c307b05566802888c630d1d3014]['bbcodeVersion'] = $bbcodeVersion;
$this->functionData['editor'][$count_3efb8c307b05566802888c630d1d3014]['showEditor'] = $showEditor;
}
...
{
$count_e57c10a6825daba8304ac10ac33f578f = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_e57c10a6825daba8304ac10ac33f578f]['options'] = $options;
$this->functionData['editorLoadJs'][$count_e57c10a6825daba8304ac10ac33f578f]['inlineLoad'] = $inlineLoad;
}
...
{
$count_08c06bce3eb782b6936db29915b5afa8 = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_08c06bce3eb782b6936db29915b5afa8]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_08c06bce3eb782b6936db29915b5afa8]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_08c06bce3eb782b6936db29915b5afa8]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_08c06bce3eb782b6936db29915b5afa8]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__de998ad44ae102d5c7d7ff28d3bb2e31($rows,$pages,$app,$plugin)."		") : ("
...
function __f__de998ad44ae102d5c7d7ff28d3bb2e31($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_a64bc9f0a05148bca1dac8f779628208 = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_a64bc9f0a05148bca1dac8f779628208]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__536c83179d1cdfc74b4e6c0dfa56d41b($tabs)."			</ul>
		</div>
...
function __f__536c83179d1cdfc74b4e6c0dfa56d41b($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
