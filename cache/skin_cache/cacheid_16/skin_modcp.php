...
{
$count_8642fc563c28e8daffb96f3500ff3bc3 = is_array($this->functionData['deletedPosts']) ? count($this->functionData['deletedPosts']) : 0;
$this->functionData['deletedPosts'][$count_8642fc563c28e8daffb96f3500ff3bc3]['posts'] = $posts;
$this->functionData['deletedPosts'][$count_8642fc563c28e8daffb96f3500ff3bc3]['other_data'] = $other_data;
$this->functionData['deletedPosts'][$count_8642fc563c28e8daffb96f3500ff3bc3]['pagelinks'] = $pagelinks;
}
...
<div class='clearfix'>
	" . ((is_array( $posts ) AND count( $posts )) ? ("
		<div id='ips_Posts'>
			".$this->__f__b06e0db5ef071b2ff8bb902e2936becb($posts,$other_data,$pagelinks)."		</div>
	") : ("
...
function __f__b06e0db5ef071b2ff8bb902e2936becb($posts, $other_data=array(), $pagelinks='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8d788af6768d67ec73a77922b2427e2e = is_array($this->functionData['deletedTopics']) ? count($this->functionData['deletedTopics']) : 0;
$this->functionData['deletedTopics'][$count_8d788af6768d67ec73a77922b2427e2e]['topics'] = $topics;
$this->functionData['deletedTopics'][$count_8d788af6768d67ec73a77922b2427e2e]['sdelete'] = $sdelete;
$this->functionData['deletedTopics'][$count_8d788af6768d67ec73a77922b2427e2e]['pagelinks'] = $pagelinks;
}
...
{
$count_a05b0f54092bd881b800b174c64809cc = is_array($this->functionData['editUserForm']) ? count($this->functionData['editUserForm']) : 0;
$this->functionData['editUserForm'][$count_a05b0f54092bd881b800b174c64809cc]['profile'] = $profile;
$this->functionData['editUserForm'][$count_a05b0f54092bd881b800b174c64809cc]['custom_fields'] = $custom_fields;
}
	...
	<fieldset>
		...
		" . ((count($custom_fields->out_fields)) ? ("
			...
			<ul class='ipsForm ipsForm_horizontal'>
				...
				".$this->__f__85c186c749ea16c550ef7b41b3d90880($profile,$custom_fields)."			</ul>
		") : ("")) . "
...
function __f__85c186c749ea16c550ef7b41b3d90880($profile, $custom_fields=null)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8f7e18ddbdce65576675ff4a93b81448 = is_array($this->functionData['latestWarnLogs']) ? count($this->functionData['latestWarnLogs']) : 0;
$this->functionData['latestWarnLogs'][$count_8f7e18ddbdce65576675ff4a93b81448]['warnings'] = $warnings;
$this->functionData['latestWarnLogs'][$count_8f7e18ddbdce65576675ff4a93b81448]['pagelinks'] = $pagelinks;
}
...
<div class='clearfix'>
	<table class='ipb_table'>
		...
		" . ((is_array( $warnings ) AND count( $warnings )) ? ("
						".$this->__f__34108798ba9d71966f21d35cdb107cd2($warnings,$pagelinks)."		") : ("
			<tr>
...
function __f__34108798ba9d71966f21d35cdb107cd2($warnings, $pagelinks)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_473842178472c6032e31ea85d5db6e0a = is_array($this->functionData['memberLookup']) ? count($this->functionData['memberLookup']) : 0;
}
...
{
$count_dba1a51111cb1d25e73e77d9139b0670 = is_array($this->functionData['membersList']) ? count($this->functionData['membersList']) : 0;
$this->functionData['membersList'][$count_dba1a51111cb1d25e73e77d9139b0670]['type'] = $type;
$this->functionData['membersList'][$count_dba1a51111cb1d25e73e77d9139b0670]['members'] = $members;
$this->functionData['membersList'][$count_dba1a51111cb1d25e73e77d9139b0670]['pagelinks'] = $pagelinks;
}
		...
		<div id='member_wrap'>
			<ul class='ipsMemberList'>
				" . ((is_array( $members ) and count( $members )) ? ("
										".$this->__f__189941350a4dffdda82d220dbb808c42($type,$members,$pagelinks)."				") : ("
...
function __f__189941350a4dffdda82d220dbb808c42($type, $members, $pagelinks='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_efccb2ea58be93c4c4fa34773a12479d = is_array($this->functionData['membersModIPForm']) ? count($this->functionData['membersModIPForm']) : 0;
$this->functionData['membersModIPForm'][$count_efccb2ea58be93c4c4fa34773a12479d]['ip'] = $ip;
$this->functionData['membersModIPForm'][$count_efccb2ea58be93c4c4fa34773a12479d]['inlineMsg'] = $inlineMsg;
}
...
{
$count_e698b57b693d5d9e78760489d532ff47 = is_array($this->functionData['membersModIPFormMembers']) ? count($this->functionData['membersModIPFormMembers']) : 0;
$this->functionData['membersModIPFormMembers'][$count_e698b57b693d5d9e78760489d532ff47]['pages'] = $pages;
$this->functionData['membersModIPFormMembers'][$count_e698b57b693d5d9e78760489d532ff47]['members'] = $members;
}
...
<table class='ipb_table'>
	...
	" . ((is_array( $members ) AND count( $members )) ? ("
				".$this->__f__f7f61d13e9aa0d95e25e898cd86da818($pages,$members)."	") : ("")) . "
</table>
<br />
...
function __f__f7f61d13e9aa0d95e25e898cd86da818($pages="",$members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_73fe5747cac93afed925a21bd9d943b1 = is_array($this->functionData['membersModIPFormPosts']) ? count($this->functionData['membersModIPFormPosts']) : 0;
$this->functionData['membersModIPFormPosts'][$count_73fe5747cac93afed925a21bd9d943b1]['count'] = $count;
$this->functionData['membersModIPFormPosts'][$count_73fe5747cac93afed925a21bd9d943b1]['pageLinks'] = $pageLinks;
$this->functionData['membersModIPFormPosts'][$count_73fe5747cac93afed925a21bd9d943b1]['results'] = $results;
}
...
<br />
" . ((count($results)) ? ("
		".$this->__f__c7815192f1776d43bf104e8b412e233d($count,$pageLinks,$results)."") : ("")) . "
<br />
<div class='topic_controls'>
	{$pageLinks}
</div>";
...
function __f__c7815192f1776d43bf104e8b412e233d($count=0, $pageLinks='', $results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c32b0532f9821ef4a039f5bc7072d8d5 = is_array($this->functionData['modAnnounceForm']) ? count($this->functionData['modAnnounceForm']) : 0;
$this->functionData['modAnnounceForm'][$count_c32b0532f9821ef4a039f5bc7072d8d5]['announce'] = $announce;
$this->functionData['modAnnounceForm'][$count_c32b0532f9821ef4a039f5bc7072d8d5]['forum_html'] = $forum_html;
$this->functionData['modAnnounceForm'][$count_c32b0532f9821ef4a039f5bc7072d8d5]['type'] = $type;
$this->functionData['modAnnounceForm'][$count_c32b0532f9821ef4a039f5bc7072d8d5]['editor_html'] = $editor_html;
$this->functionData['modAnnounceForm'][$count_c32b0532f9821ef4a039f5bc7072d8d5]['msg'] = $msg;
}
...
{
$count_df50effda04794ca4f227812999acdd9 = is_array($this->functionData['modAnnouncements']) ? count($this->functionData['modAnnouncements']) : 0;
$this->functionData['modAnnouncements'][$count_df50effda04794ca4f227812999acdd9]['announcements'] = $announcements;
}
...
<div class='topic_buttons'>
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_announcements']}\">
		...
		" . ((is_array( $announcements ) AND count( $announcements )) ? ("
						".$this->__f__a2756a1fbdf350295df1c64b74f4eb4f($announcements)."		") : ("
			<tr>
...
function __f__c78001073cb0487d62f237fa949b3c0a($announcements,$announce='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a2756a1fbdf350295df1c64b74f4eb4f($announcements)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
					...
					<td>
						<div class=\"forumdesc\">
							...
							") : ("" . ((is_array( $announce['_forums'] ) and count( $announce['_forums'] )) ? ("
									<ul>
									".$this->__f__c78001073cb0487d62f237fa949b3c0a($announcements,$announce)."									</ul>
								") : ("
...
{
$count_98fccced5ccb400b7c5ca1328c5bb9fa = is_array($this->functionData['modControls']) ? count($this->functionData['modControls']) : 0;
$this->functionData['modControls'][$count_98fccced5ccb400b7c5ca1328c5bb9fa]['editmember'] = $editmember;
$this->functionData['modControls'][$count_98fccced5ccb400b7c5ca1328c5bb9fa]['warnpanel'] = $warnpanel;
$this->functionData['modControls'][$count_98fccced5ccb400b7c5ca1328c5bb9fa]['warnlogs'] = $warnlogs;
$this->functionData['modControls'][$count_98fccced5ccb400b7c5ca1328c5bb9fa]['noteForm'] = $noteForm;
$this->functionData['modControls'][$count_98fccced5ccb400b7c5ca1328c5bb9fa]['return'] = $return;
}
...
{
$count_6269d589c8e82c0f6cd113c03b3fca51 = is_array($this->functionData['modcpMessage']) ? count($this->functionData['modcpMessage']) : 0;
$this->functionData['modcpMessage'][$count_6269d589c8e82c0f6cd113c03b3fca51]['message'] = $message;
}
...
{
$count_30e4ebb77f3e5a02e8a8565e19310fdb = is_array($this->functionData['modCPpost']) ? count($this->functionData['modCPpost']) : 0;
$this->functionData['modCPpost'][$count_30e4ebb77f3e5a02e8a8565e19310fdb]['post'] = $post;
$this->functionData['modCPpost'][$count_30e4ebb77f3e5a02e8a8565e19310fdb]['displayData'] = $displayData;
$this->functionData['modCPpost'][$count_30e4ebb77f3e5a02e8a8565e19310fdb]['topic'] = $topic;
$this->functionData['modCPpost'][$count_30e4ebb77f3e5a02e8a8565e19310fdb]['type'] = $type;
}
...
{
$count_4b3da34cf32a9fda9e5e3e15898be0e4 = is_array($this->functionData['modCPtopic']) ? count($this->functionData['modCPtopic']) : 0;
$this->functionData['modCPtopic'][$count_4b3da34cf32a9fda9e5e3e15898be0e4]['topics'] = $topics;
$this->functionData['modCPtopic'][$count_4b3da34cf32a9fda9e5e3e15898be0e4]['pagelinks'] = $pagelinks;
$this->functionData['modCPtopic'][$count_4b3da34cf32a9fda9e5e3e15898be0e4]['type'] = $type;
$this->functionData['modCPtopic'][$count_4b3da34cf32a9fda9e5e3e15898be0e4]['sdelete'] = $sdelete;
}
$IPBHTML .= "".$this->__f__09eca8bb282b66949dab67fe69e6f78b($topics,$pagelinks,$type,$sdelete)."";
return $IPBHTML;
}


function __f__a6be5109b3ee7986392ac78414c569bf($topics, $pagelinks, $type, $sdelete=array(),$tid='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__09eca8bb282b66949dab67fe69e6f78b($topics, $pagelinks, $type, $sdelete=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	<tr class='__topic' id='trow_{$data['tid']}' data-tid=\"{$data['tid']}\">
		<td class='__tid{$data['tid']} with_mod_links'>	
			...
			" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
				...
				".$this->__f__a6be5109b3ee7986392ac78414c569bf($topics,$pagelinks,$type,$sdelete,$tid,$data)."				</ul>
			") : ("")) . "
			<br />
...
{
$count_076467b9acdff32c7a7eeaeb2faeafb2 = is_array($this->functionData['overview']) ? count($this->functionData['overview']) : 0;
}
$IPBHTML .= "<div class='clearfix '>
	<div class='ipsBox_container ipsPad'>
		<p>{$this->lang->words['intro_blurb']}</p>
...
{
$count_0878a85ab89c039affbc49f36abfbe63 = is_array($this->functionData['portalPage']) ? count($this->functionData['portalPage']) : 0;
$this->functionData['portalPage'][$count_0878a85ab89c039affbc49f36abfbe63]['output'] = $output;
$this->functionData['portalPage'][$count_0878a85ab89c039affbc49f36abfbe63]['tabs'] = $tabs;
$this->functionData['portalPage'][$count_0878a85ab89c039affbc49f36abfbe63]['_activeNav'] = $_activeNav;
}
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left' id='modcp_tabs'>
			<ul class='clear'>
				...
				".$this->__f__8bb04821c2057701f1b613e326c40b0b($output,$tabs,$_activeNav)."			</ul>
		</div>
...
function __f__8bb04821c2057701f1b613e326c40b0b($output, $tabs=array(), $_activeNav=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4929fb938f05904682a5cb4d6f13a5cc = is_array($this->functionData['subTabLoop']) ? count($this->functionData['subTabLoop']) : 0;
}
$IPBHTML .= "".$this->__f__2a997fdf04effa8102c7a5fa620caf82()."";
return $IPBHTML;
}


function __f__2812e8724cd611d3c36aae7ef91de8ec($mainTabKey='',$subTabs='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2a997fdf04effa8102c7a5fa620caf82()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	" . (($mainTabKey == $this->templateVars['activeNav']['primary']) ? ("" . ((count( $subTabs ) > 1) ? ("
			<div class='maintitle ipsFilterbar clear'>
				<ul class='ipsList_inline'>									
					".$this->__f__2812e8724cd611d3c36aae7ef91de8ec($mainTabKey,$subTabs)."				</ul>
			</div>
		") : ("")) . "") : ("")) . "
...
{
$count_59dcc5e219de38f153a99be04e7532a1 = is_array($this->functionData['unapprovedPosts']) ? count($this->functionData['unapprovedPosts']) : 0;
$this->functionData['unapprovedPosts'][$count_59dcc5e219de38f153a99be04e7532a1]['posts'] = $posts;
$this->functionData['unapprovedPosts'][$count_59dcc5e219de38f153a99be04e7532a1]['pagelinks'] = $pagelinks;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("topic", "0" ) . "
" . ((!$this->settings['disable_lightbox']) ? ("
" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'include_lightbox' ) ? $this->registry->getClass('output')->getTemplate('global')->include_lightbox() : '' ) . "
...
<div class='clearfix'>
	" . ((is_array( $posts ) AND count( $posts )) ? ("
		<div id='ips_Posts2'>
			".$this->__f__975298e1fde9002b499f310d4f6ceb85($posts,$pagelinks)."		</div>
	") : ("
		<div class='no_messages'>
...
function __f__975298e1fde9002b499f310d4f6ceb85($posts, $pagelinks)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $posts as $post )
...
{
$count_1762c0064469edd77b6e4a229d46b140 = is_array($this->functionData['unapprovedTopics']) ? count($this->functionData['unapprovedTopics']) : 0;
$this->functionData['unapprovedTopics'][$count_1762c0064469edd77b6e4a229d46b140]['topics'] = $topics;
$this->functionData['unapprovedTopics'][$count_1762c0064469edd77b6e4a229d46b140]['pagelinks'] = $pagelinks;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("forums", "0" ) . "
<div>{$pagelinks}</div>
" . ( method_exists( $this->registry->getClass('output')->getTemplate('modcp'), 'subTabLoop' ) ? $this->registry->getClass('output')->getTemplate('modcp')->subTabLoop() : '' ) . "
...
{
$count_e06476b20120d36584c44b6e7bf42c58 = is_array($this->functionData['warn_view_log']) ? count($this->functionData['warn_view_log']) : 0;
$this->functionData['warn_view_log'][$count_e06476b20120d36584c44b6e7bf42c58]['member'] = $member;
$this->functionData['warn_view_log'][$count_e06476b20120d36584c44b6e7bf42c58]['rows'] = $rows;
$this->functionData['warn_view_log'][$count_e06476b20120d36584c44b6e7bf42c58]['links'] = $links;
}
...
$IPBHTML .= "" . (($this->request['module']=='ajax') ? ("
	...
	") : ("")) . "
		<table class='ipb_table'>
			...
			") : ("
								".$this->__f__88c1c7e5927b4983d29d09140af95f8a($member,$rows,$links)."			")) . "
		</table>
...
function __f__88c1c7e5927b4983d29d09140af95f8a($member, $rows, $links='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
{
$count_9c561466e97bef4ae2a514d5dda51247 = is_array($this->functionData['warnForm']) ? count($this->functionData['warnForm']) : 0;
$this->functionData['warnForm'][$count_9c561466e97bef4ae2a514d5dda51247]['member'] = $member;
$this->functionData['warnForm'][$count_9c561466e97bef4ae2a514d5dda51247]['errors'] = $errors;
$this->functionData['warnForm'][$count_9c561466e97bef4ae2a514d5dda51247]['modque'] = $modque;
$this->functionData['warnForm'][$count_9c561466e97bef4ae2a514d5dda51247]['postque'] = $postque;
$this->functionData['warnForm'][$count_9c561466e97bef4ae2a514d5dda51247]['ban'] = $ban;
$this->functionData['warnForm'][$count_9c561466e97bef4ae2a514d5dda51247]['editor_html'] = $editor_html;
}
