...
/* CACHE FILE: Generated: Tue, 29 Dec 2015 18:48:59 GMT */
...
{
$count_dfb9e1007d26ba410f533ee98934e43d = is_array($this->functionData['boardIndexTemplate']) ? count($this->functionData['boardIndexTemplate']) : 0;
$this->functionData['boardIndexTemplate'][$count_dfb9e1007d26ba410f533ee98934e43d]['lastvisit'] = $lastvisit;
$this->functionData['boardIndexTemplate'][$count_dfb9e1007d26ba410f533ee98934e43d]['stats'] = $stats;
$this->functionData['boardIndexTemplate'][$count_dfb9e1007d26ba410f533ee98934e43d]['cat_data'] = $cat_data;
$this->functionData['boardIndexTemplate'][$count_dfb9e1007d26ba410f533ee98934e43d]['show_side_blocks'] = $show_side_blocks;
$this->functionData['boardIndexTemplate'][$count_dfb9e1007d26ba410f533ee98934e43d]['side_blocks'] = $side_blocks;
}
...
<div id='board_index' class='ipsLayout " . (($this->templateVars['sidebar_enabled']) ? ("ipsLayout_withright") : ("")) . " ipsLayout_largeright clearfix " . ((IPSCookie::get('hide_sidebar') == '1') ? ("no_sidebar") : ("")) . "'>	
	...
	<!-- CATS AND FORUMS -->
		" . ((is_array( $cat_data ) AND count( $cat_data )) ? ("
			".$this->__f__68941d6874aeb2983774d9b9583673a5($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."		") : ("")) . "
	</div>
	" . (($this->templateVars['sidebar_enabled']) ? ("<div id='index_stats' class='ipsLayout_right clearfix' " . ((IPSCookie::get('hide_sidebar') == '1') ? ("style='display: none'") : ("")) . ">
			".$this->__f__1a56e4a7c496b770450588b731343dde($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."		</div>
...
//<![CDATA[
	...
	" . ((is_array( $cat_data ) AND count( $cat_data )) ? ("
		".$this->__f__eb82bf8dc37d17eda0104c34e77e0c2e($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."	") : ("")) . "
//]]>
</script>
...
function __f__7f0350ff0985db4600f647ae2f49266e($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b68b1931643cd19d38dfe0a50a2957f0($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $forum_data['subforums'] as $__id => $__data )
...
function __f__881938ffe5db5bd84f60e02cce0a9449($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
" . (($this->settings['removeStatsColumn']=='yes') ? ("<div class='forum_stats'><span>{$this->lang->words['topics']}:</span> {$forum_data['topics']}  &nbsp; <span>{$this->lang->words['replies']}:</span> {$forum_data['posts']}</div>") : ("")) . "	
													...
													" . (($forum_data['show_subforums'] AND count( $forum_data['subforums'] ) AND $forum_data['show_subforums']) ? ("
														<ol class='ipsList_inline ipsType_small subforums2' id='subforums_{$forum_data['id']}'>".$this->__f__7f0350ff0985db4600f647ae2f49266e($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data,$forum_id,$forum_data)."</ol> <ol class='ipsList_inline ipsType_small subforums' id='subforums_{$forum_data['id']}'>".$this->__f__b68b1931643cd19d38dfe0a50a2957f0($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data,$forum_id,$forum_data)."</ol>
													") : ("")) . "
																					
												</td>

" . (($_data['cat_data']['id'] != 3) ? ("" . (($this->settings['removeStatsColumn']=='no') ? ("<td class='col_c_stats ipsType_small'>
													<ul>
...
function __f__68941d6874aeb2983774d9b9583673a5($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $cat_data as $_data )
	{
		...
		$_ips___x_retval .= "
				" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("<div id='category_{$_data['cat_data']['id']}' class='category_block block_wrap'>
						...
						<div class='ipsBox clearfix'><div class='ipsBox table_wrap removeDefault'>
							<div class='ipsBox_container' style='border: 1px solid rgba(255,255,255,0.15);'>
								<table class='ipb_table' summary=\"{$this->lang->words['forums_in_cat']} '{$_data['cat_data']['name']}'\">
									...
									<!-- / CAT HEADER -->
									".$this->__f__881938ffe5db5bd84f60e02cce0a9449($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data)."								</table>
							</div></div>
...
function __f__1a56e4a7c496b770450588b731343dde($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
...
function __f__f7511bc306439168a9845e3c0dec1dc4($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $_data['forum_data'] as $forum_id => $forum_data )
...
function __f__eb82bf8dc37d17eda0104c34e77e0c2e($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $cat_data as $_data )
	{
		...
		$_ips___x_retval .= "
			" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("
				".$this->__f__f7511bc306439168a9845e3c0dec1dc4($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data)."			") : ("")) . "
...
{
$count_bfa939292833dab1aa236754e504bec1 = is_array($this->functionData['hookFacebookActivity']) ? count($this->functionData['hookFacebookActivity']) : 0;
}
...
{
$count_baed2dfb2dcc82dfa155799b1f95bce3 = is_array($this->functionData['hookGroupNameIndicator']) ? count($this->functionData['hookGroupNameIndicator']) : 0;
$this->functionData['hookGroupNameIndicator'][$count_baed2dfb2dcc82dfa155799b1f95bce3]['groups'] = $groups;
}
$IPBHTML .= "" . ((count( $groups )) ? ("
				<br />
				<ul>
<h4 class=\"statistics_head clearfix\"><right>LEGENDĂ</right></h4>
					<li>" . implode( " ≈ ", $groups ) . "</li>
				</ul>
") : ("")) . "
<small><a href=http://zonecs.ro/forum/index.php?/topic/329-atribuțiile-fiecărui-grad-grup-de-pe-comunitate/#entry492>Atribuțiile fiecărui grad asupra comunității</a></small><br><br>
<h4 class=\"statistics_head clearfix\"><right>PARTNERSHIPS</right></h4><br>
<a href=\"http://zonecs.ro/forum\" alt=\"ZoneCS Community\"><img src=\"http://i.imgur.com/UlefRE6.gif\"></a> <a href=\"http://cs18.ro/forum\"><img src=\"http://i.imgur.com/rdgBfRt.gif\" title=\"CS18 ROMÂNIA\" /></a> <a href=\"http://www.tunned.ro/forum\" target=\"_blank\"><img src=\"http://s7.postimg.org/ppi5k59tz/ETUEU.png\" border=\"0\" alt=\"\"></a><br>";
return $IPBHTML;
}
...
{
$count_bcb02e6b13e530342c539031b007b790 = is_array($this->functionData['hookLikesThisLeaders']) ? count($this->functionData['hookLikesThisLeaders']) : 0;
$this->functionData['hookLikesThisLeaders'][$count_bcb02e6b13e530342c539031b007b790]['ltl'] = $ltl;
}
...
<div class='ipsSideBlock clearfix'>
	...
	<div class='_sbcollapsable'>
		...
		".$this->__f__4f27134addac675360926a31b3a265d7($ltl)."		</ul>
	</div>
</div>
") : ("")) . "";
return $IPBHTML;
...
function __f__4f27134addac675360926a31b3a265d7($ltl)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $ltl as $r )
...
{
$count_b788b8b283df7e83d7781de1d1291269 = is_array($this->functionData['hookRecentTopics']) ? count($this->functionData['hookRecentTopics']) : 0;
$this->functionData['hookRecentTopics'][$count_b788b8b283df7e83d7781de1d1291269]['topics'] = $topics;
}
...
<div class='ipsSideBlock clearfix'>
	...
	<div class='_sbcollapsable'>
		<ul class='ipsList_withminiphoto'>
		".$this->__f__b7b53f62da2441cdf2945d6d89167555($topics)."		</ul>
	</div>
</div>
") : ("")) . "";
return $IPBHTML;
...
function __f__b7b53f62da2441cdf2945d6d89167555($topics)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $topics as $r )
...
{
$count_db6f2bda3d571c39b1233352add4d0d4 = is_array($this->functionData['hookTagCloud']) ? count($this->functionData['hookTagCloud']) : 0;
$this->functionData['hookTagCloud'][$count_db6f2bda3d571c39b1233352add4d0d4]['tags'] = $tags;
}
$IPBHTML .= "<div class='ipsSideBlock clearfix'>
	<h3>{$this->lang->words['popular_tags']}</h3>
	<div class='_sbcollapsable'>
		<ul class='ipsList_inline'>
		".$this->__f__2b35bdf04c813436f8e9fef50b8313d4($tags)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__2b35bdf04c813436f8e9fef50b8313d4($tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0cdc417f758ff5775175aebefdae57f5 = is_array($this->functionData['recentPosts']) ? count($this->functionData['recentPosts']) : 0;
$this->functionData['recentPosts'][$count_0cdc417f758ff5775175aebefdae57f5]['recentPosts'] = $recentPosts;
}
$IPBHTML .= "" . ((is_array($recentPosts) && count($recentPosts)) ? ("
  <div class='ipsSideBlock'>
	<h3>{$this->lang->words['recentposts_title']}</h3>
    <ul class='ipsList'> 
      ".$this->__f__a6d2a67b3cd77c965e76b8869314252b($recentPosts)."    </ul>
  </div>
  <br />
") : ("")) . "";
return $IPBHTML;
...
function __f__a6d2a67b3cd77c965e76b8869314252b($recentPosts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_bcf98a96aaad5352b84ecdb030576af0 = is_array($this->functionData['statusReplies']) ? count($this->functionData['statusReplies']) : 0;
$this->functionData['statusReplies'][$count_bcf98a96aaad5352b84ecdb030576af0]['replies'] = $replies;
}
$IPBHTML .= "".$this->__f__b75a8c8e686b056e03e6c548042cac9f($replies)."";
return $IPBHTML;
}


function __f__b75a8c8e686b056e03e6c548042cac9f($replies=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f142c40dcef8411e76b86b857f199092 = is_array($this->functionData['statusUpdates']) ? count($this->functionData['statusUpdates']) : 0;
$this->functionData['statusUpdates'][$count_f142c40dcef8411e76b86b857f199092]['updates'] = $updates;
$this->functionData['statusUpdates'][$count_f142c40dcef8411e76b86b857f199092]['smallSpace'] = $smallSpace;
$this->functionData['statusUpdates'][$count_f142c40dcef8411e76b86b857f199092]['latestOnly'] = $latestOnly;
}
$IPBHTML .= "<script type=\"text/javascript\">
...
</script>".$this->__f__19586ea40a0d6631accf8c5c0b40b16a($updates,$smallSpace,$latestOnly)."";
return $IPBHTML;
}


function __f__19586ea40a0d6631accf8c5c0b40b16a($updates=array(), $smallSpace=0, $latestOnly=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
