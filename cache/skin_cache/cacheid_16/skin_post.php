...
{
$count_dff55c29e270a42a34bea406964fa94d = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_dff55c29e270a42a34bea406964fa94d]['data'] = $data;
}
...
{
$count_e1771a70d1693c0ed8393a95948dae75 = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_e1771a70d1693c0ed8393a95948dae75]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_e1771a70d1693c0ed8393a95948dae75]['form'] = $form;
}
...
{
$count_be06e613e5f974ac737ebc0b050b1d39 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_be06e613e5f974ac737ebc0b050b1d39]['data'] = $data;
}
...
{
$count_1004647e070b60caebb4cf893d9f1755 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_1004647e070b60caebb4cf893d9f1755]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__d086a5d1fdd75b45075e8a9b900842da($posts)."") : ("")) . "
<p class='submit'>
...
function __f__d086a5d1fdd75b45075e8a9b900842da($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_82b9c357b95cfe75bc7f569937d22c22 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_82b9c357b95cfe75bc7f569937d22c22]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_82b9c357b95cfe75bc7f569937d22c22]['type'] = $type;
$this->functionData['uploadForm'][$count_82b9c357b95cfe75bc7f569937d22c22]['stats'] = $stats;
$this->functionData['uploadForm'][$count_82b9c357b95cfe75bc7f569937d22c22]['id'] = $id;
$this->functionData['uploadForm'][$count_82b9c357b95cfe75bc7f569937d22c22]['forum_id'] = $forum_id;
}
