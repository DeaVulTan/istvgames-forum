...
{
$count_ba52daba3570ea80097508d765d62032 = is_array($this->functionData['group_strip']) ? count($this->functionData['group_strip']) : 0;
$this->functionData['group_strip'][$count_ba52daba3570ea80097508d765d62032]['group'] = $group;
$this->functionData['group_strip'][$count_ba52daba3570ea80097508d765d62032]['members'] = $members;
$this->functionData['group_strip'][$count_ba52daba3570ea80097508d765d62032]['pagination'] = $pagination;
}
...
<table class='ipb_table ipsMemberList'>
	...
	" . ((count($members) AND is_array($members)) ? ("
				".$this->__f__fc836eeece27644aff02012242db73b6($group,$members,$pagination)."	") : ("")) . "
...
function __f__df30425c9c6796dcb93e4de836e6fb6d($group="", $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0ff2079f9009f370a3aacc149ab07537($group="", $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $info['forums'] as $id => $name )
...
function __f__fc836eeece27644aff02012242db73b6($group="", $members=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
			...
			<tr class='" .  IPSLib::next( $this->registry->templateStriping["staff"] ) . "'>
				...
				<td class='altrow short'>
					" . ((is_array($info['forums'])) ? ("" . ((empty( $info['forums'] )) ? ("
							--
						") : ("" . ((count( $info['forums'] ) == 1) ? ("
								".$this->__f__df30425c9c6796dcb93e4de836e6fb6d($group,$members,$pagination,$info)."							") : ("
								...
								".$this->__f__0ff2079f9009f370a3aacc149ab07537($group,$members,$pagination,$info)."								</ul>
...
{
$count_b373d84001940ca16b34ddaeae7eef33 = is_array($this->functionData['top_posters']) ? count($this->functionData['top_posters']) : 0;
$this->functionData['top_posters'][$count_b373d84001940ca16b34ddaeae7eef33]['rows'] = $rows;
}
...
<table class='ipb_table ipsMemberList'>
	...
	") : ("
				".$this->__f__b8608195896a881dc5166235ced890ae($rows)."	")) . "
</table>
...
function __f__b8608195896a881dc5166235ced890ae($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_134c2edd0e54d34a0ffe831b771854f9 = is_array($this->functionData['whoPosted']) ? count($this->functionData['whoPosted']) : 0;
$this->functionData['whoPosted'][$count_134c2edd0e54d34a0ffe831b771854f9]['tid'] = $tid;
$this->functionData['whoPosted'][$count_134c2edd0e54d34a0ffe831b771854f9]['title'] = $title;
$this->functionData['whoPosted'][$count_134c2edd0e54d34a0ffe831b771854f9]['rows'] = $rows;
}
...
<div class='fixed_inner'>
	<table class='ipb_table'>
		...
		" . ((count($rows) AND is_array($rows)) ? ("
						".$this->__f__d417cad269e2579c3b114e6345469497($tid,$title,$rows)."		") : ("")) . "
	</table>
</div>
...
function __f__d417cad269e2579c3b114e6345469497($tid=0, $title="", $rows=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
