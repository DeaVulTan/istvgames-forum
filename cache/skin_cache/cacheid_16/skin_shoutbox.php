...
class skin_shoutbox_16 extends skinMaster{
...
{
$count_eaa93a8a5da4d8d516fea942a9987280 = is_array($this->functionData['archive']) ? count($this->functionData['archive']) : 0;
$this->functionData['archive'][$count_eaa93a8a5da4d8d516fea942a9987280]['d'] = $d;
}
...
$IPBHTML .= "" . ((substr( $action, 0, 4 ) != 'edit') ? ("" . (($action == 'delete') ? ("
	...
	<div class=\"short\">
		...
		<table class=\"ipb_table\">
			...
			".$this->__f__a808a157e639d38e661e567c6dc82461($action,$data)."		</table>
		<br />
...
function __f__a808a157e639d38e661e567c6dc82461($action='',$data=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_73addf67abf907635c20c0b4c8734dde = is_array($this->functionData['popupWrapper']) ? count($this->functionData['popupWrapper']) : 0;
$this->functionData['popupWrapper'][$count_73addf67abf907635c20c0b4c8734dde]['output'] = $output;
}
...
{
$count_14429f9b5cf8a460f8f22ff93c53fdd8 = is_array($this->functionData['shout_row']) ? count($this->functionData['shout_row']) : 0;
$this->functionData['shout_row'][$count_14429f9b5cf8a460f8f22ff93c53fdd8]['d'] = $d;
$this->functionData['shout_row'][$count_14429f9b5cf8a460f8f22ff93c53fdd8]['can_edit'] = $can_edit;
$this->functionData['shout_row'][$count_14429f9b5cf8a460f8f22ff93c53fdd8]['ajax'] = $ajax;
}
...
{
$count_15e2939567aec7687a81e367719603c5 = is_array($this->functionData['shout_row_sidebar']) ? count($this->functionData['shout_row_sidebar']) : 0;
$this->functionData['shout_row_sidebar'][$count_15e2939567aec7687a81e367719603c5]['d'] = $d;
$this->functionData['shout_row_sidebar'][$count_15e2939567aec7687a81e367719603c5]['can_edit'] = $can_edit;
$this->functionData['shout_row_sidebar'][$count_15e2939567aec7687a81e367719603c5]['ajax'] = $ajax;
}
...
{
$count_877de02586e64d8c10c02c5b10c46cb1 = is_array($this->functionData['shoutbox']) ? count($this->functionData['shoutbox']) : 0;
$this->functionData['shoutbox'][$count_877de02586e64d8c10c02c5b10c46cb1]['data'] = $data;
$this->functionData['shoutbox'][$count_877de02586e64d8c10c02c5b10c46cb1]['stats'] = $stats;
}
