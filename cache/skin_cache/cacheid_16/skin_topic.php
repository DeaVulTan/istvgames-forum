...
{
$count_54f15041fd138f1edfaee3681bbffd9d = is_array($this->functionData['ajaxSharePost']) ? count($this->functionData['ajaxSharePost']) : 0;
$this->functionData['ajaxSharePost'][$count_54f15041fd138f1edfaee3681bbffd9d]['topic'] = $topic;
$this->functionData['ajaxSharePost'][$count_54f15041fd138f1edfaee3681bbffd9d]['post'] = $post;
$this->functionData['ajaxSharePost'][$count_54f15041fd138f1edfaee3681bbffd9d]['url'] = $url;
$this->functionData['ajaxSharePost'][$count_54f15041fd138f1edfaee3681bbffd9d]['sharelinks'] = $sharelinks;
}
...
{
$count_718199dd13aa2afa1d82f98231eeae69 = is_array($this->functionData['announcement_show']) ? count($this->functionData['announcement_show']) : 0;
$this->functionData['announcement_show'][$count_718199dd13aa2afa1d82f98231eeae69]['announce'] = $announce;
$this->functionData['announcement_show'][$count_718199dd13aa2afa1d82f98231eeae69]['author'] = $author;
}
...
{
$count_32258d737a4b1d5183099aa221628ef6 = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_32258d737a4b1d5183099aa221628ef6]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_32258d737a4b1d5183099aa221628ef6]['forum'] = $forum;
}
...
{
$count_3034a9631837d6fad793911a4cf23e5e = is_array($this->functionData['hookFacebookLike']) ? count($this->functionData['hookFacebookLike']) : 0;
}
...
{
$count_34ee977f24a21e8789ac7aa068282815 = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_34ee977f24a21e8789ac7aa068282815]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_34ee977f24a21e8789ac7aa068282815]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_34ee977f24a21e8789ac7aa068282815]['opts'] = $opts;
}
...
{
$count_7b2c592dc35fe46ccf976027d96dd2e9 = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_7b2c592dc35fe46ccf976027d96dd2e9]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_7b2c592dc35fe46ccf976027d96dd2e9]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_7b2c592dc35fe46ccf976027d96dd2e9]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_7b2c592dc35fe46ccf976027d96dd2e9]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_7b2c592dc35fe46ccf976027d96dd2e9]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_7b2c592dc35fe46ccf976027d96dd2e9]['editPoll'] = $editPoll;
}
...
<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__caf4140b4a2a704e5b31e6e5c8d1ea90($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__a31d2de61b65f892d149738936c89410($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='',$choiceID='',$choiceData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ba0243bcb3af14ff48396f6de33a77c3($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							" . (($showResults) ? ("<li>
									...
									" . (($poll['poll_view_voters'] AND is_array( $choiceData['voters'] ) AND $this->settings['poll_allow_public'] AND $choiceData['votes']) ? ("
										<script type='text/javascript'>
											...
											".$this->__f__a31d2de61b65f892d149738936c89410($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData,$choiceID,$choiceData)."											ipb.topic.poll[ $questionID ][ $choiceID ] = { name: \"{$choiceData['choice']}\", users: users};
										</script>
									") : ("")) . "
...
function __f__caf4140b4a2a704e5b31e6e5c8d1ea90($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__ba0243bcb3af14ff48396f6de33a77c3($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_62c26fb7a6ecc687847ab1533feaae07 = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_62c26fb7a6ecc687847ab1533feaae07]['post'] = $post;
$this->functionData['post'][$count_62c26fb7a6ecc687847ab1533feaae07]['displayData'] = $displayData;
$this->functionData['post'][$count_62c26fb7a6ecc687847ab1533feaae07]['topic'] = $topic;
$this->functionData['post'][$count_62c26fb7a6ecc687847ab1533feaae07]['forum'] = $forum;
}
...
{
$count_bcd456565cc3dd5c291b63820062f4f4 = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_bcd456565cc3dd5c291b63820062f4f4]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_d6371570b0c5e7bef58a666df35036f4 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_d6371570b0c5e7bef58a666df35036f4]['title'] = $title;
$this->functionData['show_attachment_title'][$count_d6371570b0c5e7bef58a666df35036f4]['data'] = $data;
$this->functionData['show_attachment_title'][$count_d6371570b0c5e7bef58a666df35036f4]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__c501610c52363df67f7d2880adb2f1c3($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__c501610c52363df67f7d2880adb2f1c3($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_50fbd835ac8a4293d83444fdb0717cd9 = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_50fbd835ac8a4293d83444fdb0717cd9]['data'] = $data;
}
...
{
$count_b010aa8bf1f292e94ea5d3c40bf5e7ed = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_b010aa8bf1f292e94ea5d3c40bf5e7ed]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_b010aa8bf1f292e94ea5d3c40bf5e7ed]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_b010aa8bf1f292e94ea5d3c40bf5e7ed]['topic'] = $topic;
}
...
$IPBHTML = "";
$IPBHTML .= "".$this->__f__4242e7c557fdb29684202b29869a7a23($topic,$posts)."<br class='clear' />
...
function __f__4242e7c557fdb29684202b29869a7a23($topic, $posts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7d09fdfddb0e014c9b32a888f68d1f27 = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_7d09fdfddb0e014c9b32a888f68d1f27]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_7d09fdfddb0e014c9b32a888f68d1f27]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_7d09fdfddb0e014c9b32a888f68d1f27]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_7d09fdfddb0e014c9b32a888f68d1f27]['displayData'] = $displayData;
}
...
" . (($displayData['mod_links'] AND ( $this->memberData['is_mod'] OR $this->memberData['member_id'] == $topic['starter_id'] )) ? ("<ul class='ipbmenu_content' id='topic_mod_options_menucontent'  style='display:none'>
	".$this->__f__c0d451b53d991cd76b74bb2aaa930a46($forum,$topic,$post_data,$displayData)."	" . (($topic['topic_queuedposts'] AND $this->registry->class_forums->canQueuePosts( $forum['id'] )) ? ("
	...
	" . ((is_array( $displayData['multi_mod'] ) AND count( $displayData['multi_mod'] )) ? ("
		".$this->__f__151eddb3c04e4f6891e2dbb261033600($forum,$topic,$post_data,$displayData)."	") : ("")) . "
</ul>
<script type='text/javascript'>
...
" . (($this->settings['reputation_enabled'] && $this->settings['reputation_point_types'] != 'like' && $this->settings['reputation_show_content'] && $this->memberData['member_id'] != 0 && is_array($this->caches['reputation_levels'])) ? ("<ul id='rep_filter_menucontent' class='ipbmenu_content with_checks' style='display: none'>
		...
		" . ((is_array($this->caches['reputation_levels'])) ? ("
			".$this->__f__0c35a29a506eb6c1240e4698b827ebdd($forum,$topic,$post_data,$displayData)."		") : ("")) . "
	</ul>
	<script type='text/javascript'>
...
" . ((is_array( $post_data ) AND count( $post_data )) ? ("
	<div class='ipsBox'>
		<div class='ipsBox_container' id='ips_Posts'>
			".$this->__f__1692e1a74f442835df8ded6f0ea73a5d($forum,$topic,$post_data,$displayData)."		</div>
	</div>
") : ("")) . "
...
" . ((is_array( $displayData['same_tagged'] ) and count( $displayData['same_tagged'] )) ? ("
    <br />
        ...
        <div class='ipsBox_container removeDefault'>
            ...
            ".$this->__f__25db57f0d90bfffcdd9a047c5ef2b075($forum,$topic,$post_data,$displayData)."            </table>
        </div>" . $this->registry->getClass('output')->getReplacement("box_end") . "
") : ("")) . "
<!-- ACTIVE USERS -->
...
function __f__c0d451b53d991cd76b74bb2aaa930a46($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__151eddb3c04e4f6891e2dbb261033600($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0c35a29a506eb6c1240e4698b827ebdd($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1692e1a74f442835df8ded6f0ea73a5d($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__25db57f0d90bfffcdd9a047c5ef2b075($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
