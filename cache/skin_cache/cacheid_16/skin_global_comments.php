...
{
$count_729c181c80d58f72eb88bb619ef1202e = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_729c181c80d58f72eb88bb619ef1202e]['r'] = $r;
$this->functionData['comment'][$count_729c181c80d58f72eb88bb619ef1202e]['parent'] = $parent;
$this->functionData['comment'][$count_729c181c80d58f72eb88bb619ef1202e]['settings'] = $settings;
}
...
{
$count_e0547018246ca1d3d1213e55856abfc2 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_e0547018246ca1d3d1213e55856abfc2]['r'] = $r;
$this->functionData['commentHidden'][$count_e0547018246ca1d3d1213e55856abfc2]['parent'] = $parent;
$this->functionData['commentHidden'][$count_e0547018246ca1d3d1213e55856abfc2]['settings'] = $settings;
}
...
{
$count_1852913263adb5bebf14d9649ace4e92 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_1852913263adb5bebf14d9649ace4e92]['comments'] = $comments;
$this->functionData['commentsList'][$count_1852913263adb5bebf14d9649ace4e92]['settings'] = $settings;
$this->functionData['commentsList'][$count_1852913263adb5bebf14d9649ace4e92]['pages'] = $pages;
$this->functionData['commentsList'][$count_1852913263adb5bebf14d9649ace4e92]['parent'] = $parent;
$this->functionData['commentsList'][$count_1852913263adb5bebf14d9649ace4e92]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__acbcee6e0a60f571ce97c2523b5355a9($comments,$settings,$pages,$parent,$preReply)."</div>
...
function __f__acbcee6e0a60f571ce97c2523b5355a9($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_cc332f41e4f0ca86be55a411e4a37b16 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_cc332f41e4f0ca86be55a411e4a37b16]['comment'] = $comment;
$this->functionData['form'][$count_cc332f41e4f0ca86be55a411e4a37b16]['parent'] = $parent;
$this->functionData['form'][$count_cc332f41e4f0ca86be55a411e4a37b16]['editor'] = $editor;
$this->functionData['form'][$count_cc332f41e4f0ca86be55a411e4a37b16]['settings'] = $settings;
$this->functionData['form'][$count_cc332f41e4f0ca86be55a411e4a37b16]['errors'] = $errors;
$this->functionData['form'][$count_cc332f41e4f0ca86be55a411e4a37b16]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
