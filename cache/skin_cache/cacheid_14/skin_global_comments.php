...
{
$count_fd7f3fd5443fa8eddfc054ce43cb7043 = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_fd7f3fd5443fa8eddfc054ce43cb7043]['r'] = $r;
$this->functionData['comment'][$count_fd7f3fd5443fa8eddfc054ce43cb7043]['parent'] = $parent;
$this->functionData['comment'][$count_fd7f3fd5443fa8eddfc054ce43cb7043]['settings'] = $settings;
}
...
{
$count_fbbca5e64371df4139c038f16fa9e572 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_fbbca5e64371df4139c038f16fa9e572]['r'] = $r;
$this->functionData['commentHidden'][$count_fbbca5e64371df4139c038f16fa9e572]['parent'] = $parent;
$this->functionData['commentHidden'][$count_fbbca5e64371df4139c038f16fa9e572]['settings'] = $settings;
}
...
{
$count_d2a7bf74df53c252cb52ff6b6ca904a6 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_d2a7bf74df53c252cb52ff6b6ca904a6]['comments'] = $comments;
$this->functionData['commentsList'][$count_d2a7bf74df53c252cb52ff6b6ca904a6]['settings'] = $settings;
$this->functionData['commentsList'][$count_d2a7bf74df53c252cb52ff6b6ca904a6]['pages'] = $pages;
$this->functionData['commentsList'][$count_d2a7bf74df53c252cb52ff6b6ca904a6]['parent'] = $parent;
$this->functionData['commentsList'][$count_d2a7bf74df53c252cb52ff6b6ca904a6]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__7b43c850e46581ea5594ceb52d37f45c($comments,$settings,$pages,$parent,$preReply)."</div>
...
function __f__7b43c850e46581ea5594ceb52d37f45c($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b07a59fea3c93a4f2d16beb2206b2a1e = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_b07a59fea3c93a4f2d16beb2206b2a1e]['comment'] = $comment;
$this->functionData['form'][$count_b07a59fea3c93a4f2d16beb2206b2a1e]['parent'] = $parent;
$this->functionData['form'][$count_b07a59fea3c93a4f2d16beb2206b2a1e]['editor'] = $editor;
$this->functionData['form'][$count_b07a59fea3c93a4f2d16beb2206b2a1e]['settings'] = $settings;
$this->functionData['form'][$count_b07a59fea3c93a4f2d16beb2206b2a1e]['errors'] = $errors;
$this->functionData['form'][$count_b07a59fea3c93a4f2d16beb2206b2a1e]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
