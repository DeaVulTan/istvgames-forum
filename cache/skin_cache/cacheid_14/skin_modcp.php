...
{
$count_7c6a684b55532fe5499be0f47304f2e7 = is_array($this->functionData['deletedPosts']) ? count($this->functionData['deletedPosts']) : 0;
$this->functionData['deletedPosts'][$count_7c6a684b55532fe5499be0f47304f2e7]['posts'] = $posts;
$this->functionData['deletedPosts'][$count_7c6a684b55532fe5499be0f47304f2e7]['other_data'] = $other_data;
$this->functionData['deletedPosts'][$count_7c6a684b55532fe5499be0f47304f2e7]['pagelinks'] = $pagelinks;
}
...
<div class='clearfix'>
	" . ((is_array( $posts ) AND count( $posts )) ? ("
		<div id='ips_Posts'>
			".$this->__f__395738c6047d6f7ff7bdb2c0c470777b($posts,$other_data,$pagelinks)."		</div>
	") : ("
...
function __f__395738c6047d6f7ff7bdb2c0c470777b($posts, $other_data=array(), $pagelinks='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e77c8888a6f68a1d82f1f065fd1084c0 = is_array($this->functionData['deletedTopics']) ? count($this->functionData['deletedTopics']) : 0;
$this->functionData['deletedTopics'][$count_e77c8888a6f68a1d82f1f065fd1084c0]['topics'] = $topics;
$this->functionData['deletedTopics'][$count_e77c8888a6f68a1d82f1f065fd1084c0]['sdelete'] = $sdelete;
$this->functionData['deletedTopics'][$count_e77c8888a6f68a1d82f1f065fd1084c0]['pagelinks'] = $pagelinks;
}
...
{
$count_fbfa86e4002ad8a9931da8376bac37db = is_array($this->functionData['editUserForm']) ? count($this->functionData['editUserForm']) : 0;
$this->functionData['editUserForm'][$count_fbfa86e4002ad8a9931da8376bac37db]['profile'] = $profile;
$this->functionData['editUserForm'][$count_fbfa86e4002ad8a9931da8376bac37db]['custom_fields'] = $custom_fields;
}
	...
	<fieldset>
		...
		" . ((count($custom_fields->out_fields)) ? ("
			...
			<ul class='ipsForm ipsForm_horizontal'>
				...
				".$this->__f__2b3f7e691f99e08e99e893d4ad57e793($profile,$custom_fields)."			</ul>
		") : ("")) . "
...
function __f__2b3f7e691f99e08e99e893d4ad57e793($profile, $custom_fields=null)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_798a9e7604dc2ccf629bd532868e87f7 = is_array($this->functionData['latestWarnLogs']) ? count($this->functionData['latestWarnLogs']) : 0;
$this->functionData['latestWarnLogs'][$count_798a9e7604dc2ccf629bd532868e87f7]['warnings'] = $warnings;
$this->functionData['latestWarnLogs'][$count_798a9e7604dc2ccf629bd532868e87f7]['pagelinks'] = $pagelinks;
}
...
<div class='clearfix'>
	<table class='ipb_table'>
		...
		" . ((is_array( $warnings ) AND count( $warnings )) ? ("
						".$this->__f__6489b7137177dd38eb61cdcc3289e57f($warnings,$pagelinks)."		") : ("
			<tr>
...
function __f__6489b7137177dd38eb61cdcc3289e57f($warnings, $pagelinks)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c26ad1472ccb8a40a700be3eec76e736 = is_array($this->functionData['memberLookup']) ? count($this->functionData['memberLookup']) : 0;
}
...
{
$count_f5d065ce863f284b60187b1b1b0e8870 = is_array($this->functionData['membersList']) ? count($this->functionData['membersList']) : 0;
$this->functionData['membersList'][$count_f5d065ce863f284b60187b1b1b0e8870]['type'] = $type;
$this->functionData['membersList'][$count_f5d065ce863f284b60187b1b1b0e8870]['members'] = $members;
$this->functionData['membersList'][$count_f5d065ce863f284b60187b1b1b0e8870]['pagelinks'] = $pagelinks;
}
		...
		<div id='member_wrap'>
			<ul class='ipsMemberList'>
				" . ((is_array( $members ) and count( $members )) ? ("
										".$this->__f__5fc51d0ee4bbe1ab2f16ecc46d8239b8($type,$members,$pagelinks)."				") : ("
...
function __f__5fc51d0ee4bbe1ab2f16ecc46d8239b8($type, $members, $pagelinks='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_65a3ba3f7e45d72783c8de27ad35a495 = is_array($this->functionData['membersModIPForm']) ? count($this->functionData['membersModIPForm']) : 0;
$this->functionData['membersModIPForm'][$count_65a3ba3f7e45d72783c8de27ad35a495]['ip'] = $ip;
$this->functionData['membersModIPForm'][$count_65a3ba3f7e45d72783c8de27ad35a495]['inlineMsg'] = $inlineMsg;
}
...
{
$count_3ce103912ee135331fdec3568c4af313 = is_array($this->functionData['membersModIPFormMembers']) ? count($this->functionData['membersModIPFormMembers']) : 0;
$this->functionData['membersModIPFormMembers'][$count_3ce103912ee135331fdec3568c4af313]['pages'] = $pages;
$this->functionData['membersModIPFormMembers'][$count_3ce103912ee135331fdec3568c4af313]['members'] = $members;
}
...
<table class='ipb_table'>
	...
	" . ((is_array( $members ) AND count( $members )) ? ("
				".$this->__f__1a9a7b8036378f353e902c55ac90f757($pages,$members)."	") : ("")) . "
</table>
<br />
...
function __f__1a9a7b8036378f353e902c55ac90f757($pages="",$members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5df002b8aa75bf22e362cdd8793ee83d = is_array($this->functionData['membersModIPFormPosts']) ? count($this->functionData['membersModIPFormPosts']) : 0;
$this->functionData['membersModIPFormPosts'][$count_5df002b8aa75bf22e362cdd8793ee83d]['count'] = $count;
$this->functionData['membersModIPFormPosts'][$count_5df002b8aa75bf22e362cdd8793ee83d]['pageLinks'] = $pageLinks;
$this->functionData['membersModIPFormPosts'][$count_5df002b8aa75bf22e362cdd8793ee83d]['results'] = $results;
}
...
<br />
" . ((count($results)) ? ("
		".$this->__f__3b1cab1c6a13d1135d329f5a2b12cc68($count,$pageLinks,$results)."") : ("")) . "
<br />
<div class='topic_controls'>
	{$pageLinks}
</div>";
...
function __f__3b1cab1c6a13d1135d329f5a2b12cc68($count=0, $pageLinks='', $results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f379e14b9a74b5f1e0de849d4c23512a = is_array($this->functionData['modAnnounceForm']) ? count($this->functionData['modAnnounceForm']) : 0;
$this->functionData['modAnnounceForm'][$count_f379e14b9a74b5f1e0de849d4c23512a]['announce'] = $announce;
$this->functionData['modAnnounceForm'][$count_f379e14b9a74b5f1e0de849d4c23512a]['forum_html'] = $forum_html;
$this->functionData['modAnnounceForm'][$count_f379e14b9a74b5f1e0de849d4c23512a]['type'] = $type;
$this->functionData['modAnnounceForm'][$count_f379e14b9a74b5f1e0de849d4c23512a]['editor_html'] = $editor_html;
$this->functionData['modAnnounceForm'][$count_f379e14b9a74b5f1e0de849d4c23512a]['msg'] = $msg;
}
...
{
$count_2ea5ade85282651d2ee368c7f6064989 = is_array($this->functionData['modAnnouncements']) ? count($this->functionData['modAnnouncements']) : 0;
$this->functionData['modAnnouncements'][$count_2ea5ade85282651d2ee368c7f6064989]['announcements'] = $announcements;
}
...
<div class='topic_buttons'>
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_announcements']}\">
		...
		" . ((is_array( $announcements ) AND count( $announcements )) ? ("
						".$this->__f__2584e47bdad5f8101c0bbfbbf033794c($announcements)."		") : ("
			<tr>
...
function __f__9bd71c88ff244b25b281af7ad5ca37b1($announcements,$announce='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2584e47bdad5f8101c0bbfbbf033794c($announcements)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
					...
					<td>
						<div class=\"forumdesc\">
							...
							") : ("" . ((is_array( $announce['_forums'] ) and count( $announce['_forums'] )) ? ("
									<ul>
									".$this->__f__9bd71c88ff244b25b281af7ad5ca37b1($announcements,$announce)."									</ul>
								") : ("
...
{
$count_e86f97acedffa7cd05d38e2c6a3ca9fd = is_array($this->functionData['modControls']) ? count($this->functionData['modControls']) : 0;
$this->functionData['modControls'][$count_e86f97acedffa7cd05d38e2c6a3ca9fd]['editmember'] = $editmember;
$this->functionData['modControls'][$count_e86f97acedffa7cd05d38e2c6a3ca9fd]['warnpanel'] = $warnpanel;
$this->functionData['modControls'][$count_e86f97acedffa7cd05d38e2c6a3ca9fd]['warnlogs'] = $warnlogs;
$this->functionData['modControls'][$count_e86f97acedffa7cd05d38e2c6a3ca9fd]['noteForm'] = $noteForm;
$this->functionData['modControls'][$count_e86f97acedffa7cd05d38e2c6a3ca9fd]['return'] = $return;
}
...
{
$count_4721f26e245a17d265934346e54ba67c = is_array($this->functionData['modcpMessage']) ? count($this->functionData['modcpMessage']) : 0;
$this->functionData['modcpMessage'][$count_4721f26e245a17d265934346e54ba67c]['message'] = $message;
}
...
{
$count_86b57c6aec2a114ae10accd4e56821a7 = is_array($this->functionData['modCPpost']) ? count($this->functionData['modCPpost']) : 0;
$this->functionData['modCPpost'][$count_86b57c6aec2a114ae10accd4e56821a7]['post'] = $post;
$this->functionData['modCPpost'][$count_86b57c6aec2a114ae10accd4e56821a7]['displayData'] = $displayData;
$this->functionData['modCPpost'][$count_86b57c6aec2a114ae10accd4e56821a7]['topic'] = $topic;
$this->functionData['modCPpost'][$count_86b57c6aec2a114ae10accd4e56821a7]['type'] = $type;
}
...
{
$count_2011054904919296030a090f4184a818 = is_array($this->functionData['modCPtopic']) ? count($this->functionData['modCPtopic']) : 0;
$this->functionData['modCPtopic'][$count_2011054904919296030a090f4184a818]['topics'] = $topics;
$this->functionData['modCPtopic'][$count_2011054904919296030a090f4184a818]['pagelinks'] = $pagelinks;
$this->functionData['modCPtopic'][$count_2011054904919296030a090f4184a818]['type'] = $type;
$this->functionData['modCPtopic'][$count_2011054904919296030a090f4184a818]['sdelete'] = $sdelete;
}
$IPBHTML .= "".$this->__f__ae179a237f12c5f44bedf3863b39b994($topics,$pagelinks,$type,$sdelete)."";
return $IPBHTML;
}


function __f__7ffeba12c66a386754727c55bf201225($topics, $pagelinks, $type, $sdelete=array(),$tid='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ae179a237f12c5f44bedf3863b39b994($topics, $pagelinks, $type, $sdelete=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	<tr class='__topic' id='trow_{$data['tid']}' data-tid=\"{$data['tid']}\">
		<td class='__tid{$data['tid']} with_mod_links'>	
			...
			" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
				...
				".$this->__f__7ffeba12c66a386754727c55bf201225($topics,$pagelinks,$type,$sdelete,$tid,$data)."				</ul>
			") : ("")) . "
			<br />
...
{
$count_6084b9938e6d7092ce52320babfa18ab = is_array($this->functionData['overview']) ? count($this->functionData['overview']) : 0;
}
$IPBHTML .= "<div class='clearfix '>
	<div class='ipsBox_container ipsPad'>
		<p>{$this->lang->words['intro_blurb']}</p>
...
{
$count_8af3600e447988519adceec2dfd44cce = is_array($this->functionData['portalPage']) ? count($this->functionData['portalPage']) : 0;
$this->functionData['portalPage'][$count_8af3600e447988519adceec2dfd44cce]['output'] = $output;
$this->functionData['portalPage'][$count_8af3600e447988519adceec2dfd44cce]['tabs'] = $tabs;
$this->functionData['portalPage'][$count_8af3600e447988519adceec2dfd44cce]['_activeNav'] = $_activeNav;
}
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left' id='modcp_tabs'>
			<ul class='clear'>
				...
				".$this->__f__3a61caf6ae6cbceb1c503802022cddd8($output,$tabs,$_activeNav)."			</ul>
		</div>
...
function __f__3a61caf6ae6cbceb1c503802022cddd8($output, $tabs=array(), $_activeNav=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c8330f971b9f7c14a9efc8770cbf97fd = is_array($this->functionData['subTabLoop']) ? count($this->functionData['subTabLoop']) : 0;
}
$IPBHTML .= "".$this->__f__244ef90a6778be4acd37c1730c286d6e()."";
return $IPBHTML;
}


function __f__22bf7693da1ab4493593546ec16a12d6($mainTabKey='',$subTabs='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__244ef90a6778be4acd37c1730c286d6e()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	" . (($mainTabKey == $this->templateVars['activeNav']['primary']) ? ("" . ((count( $subTabs ) > 1) ? ("
			<div class='maintitle ipsFilterbar clear'>
				<ul class='ipsList_inline'>									
					".$this->__f__22bf7693da1ab4493593546ec16a12d6($mainTabKey,$subTabs)."				</ul>
			</div>
		") : ("")) . "") : ("")) . "
...
{
$count_b9815437c5b2f8137c493f04bccbcdca = is_array($this->functionData['unapprovedPosts']) ? count($this->functionData['unapprovedPosts']) : 0;
$this->functionData['unapprovedPosts'][$count_b9815437c5b2f8137c493f04bccbcdca]['posts'] = $posts;
$this->functionData['unapprovedPosts'][$count_b9815437c5b2f8137c493f04bccbcdca]['pagelinks'] = $pagelinks;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("topic", "0" ) . "
" . ((!$this->settings['disable_lightbox']) ? ("
" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'include_lightbox' ) ? $this->registry->getClass('output')->getTemplate('global')->include_lightbox() : '' ) . "
...
<div class='clearfix'>
	" . ((is_array( $posts ) AND count( $posts )) ? ("
		<div id='ips_Posts2'>
			".$this->__f__3deed7b4b9c7b5935f60a5c91c340246($posts,$pagelinks)."		</div>
	") : ("
		<div class='no_messages'>
...
function __f__3deed7b4b9c7b5935f60a5c91c340246($posts, $pagelinks)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $posts as $post )
...
{
$count_609a8d3dfa80f0013ca230a97ec3354c = is_array($this->functionData['unapprovedTopics']) ? count($this->functionData['unapprovedTopics']) : 0;
$this->functionData['unapprovedTopics'][$count_609a8d3dfa80f0013ca230a97ec3354c]['topics'] = $topics;
$this->functionData['unapprovedTopics'][$count_609a8d3dfa80f0013ca230a97ec3354c]['pagelinks'] = $pagelinks;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("forums", "0" ) . "
<div>{$pagelinks}</div>
" . ( method_exists( $this->registry->getClass('output')->getTemplate('modcp'), 'subTabLoop' ) ? $this->registry->getClass('output')->getTemplate('modcp')->subTabLoop() : '' ) . "
...
{
$count_0f71c18015c64bae4371e08ea9553926 = is_array($this->functionData['warn_view_log']) ? count($this->functionData['warn_view_log']) : 0;
$this->functionData['warn_view_log'][$count_0f71c18015c64bae4371e08ea9553926]['member'] = $member;
$this->functionData['warn_view_log'][$count_0f71c18015c64bae4371e08ea9553926]['rows'] = $rows;
$this->functionData['warn_view_log'][$count_0f71c18015c64bae4371e08ea9553926]['links'] = $links;
}
...
$IPBHTML .= "" . (($this->request['module']=='ajax') ? ("
	...
	") : ("")) . "
		<table class='ipb_table'>
			...
			") : ("
								".$this->__f__636b2a1855123e9e84cbd216c2a04a26($member,$rows,$links)."			")) . "
		</table>
...
function __f__636b2a1855123e9e84cbd216c2a04a26($member, $rows, $links='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
{
$count_73c7b6a814c84ce6421bdeefe47bc537 = is_array($this->functionData['warnForm']) ? count($this->functionData['warnForm']) : 0;
$this->functionData['warnForm'][$count_73c7b6a814c84ce6421bdeefe47bc537]['member'] = $member;
$this->functionData['warnForm'][$count_73c7b6a814c84ce6421bdeefe47bc537]['errors'] = $errors;
$this->functionData['warnForm'][$count_73c7b6a814c84ce6421bdeefe47bc537]['modque'] = $modque;
$this->functionData['warnForm'][$count_73c7b6a814c84ce6421bdeefe47bc537]['postque'] = $postque;
$this->functionData['warnForm'][$count_73c7b6a814c84ce6421bdeefe47bc537]['ban'] = $ban;
$this->functionData['warnForm'][$count_73c7b6a814c84ce6421bdeefe47bc537]['editor_html'] = $editor_html;
}
