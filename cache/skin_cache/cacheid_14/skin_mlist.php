...
{
$count_ad17c37060b1510642f04db90480cf2f = is_array($this->functionData['friendsOnline']) ? count($this->functionData['friendsOnline']) : 0;
$this->functionData['friendsOnline'][$count_ad17c37060b1510642f04db90480cf2f]['active'] = $active;
$this->functionData['friendsOnline'][$count_ad17c37060b1510642f04db90480cf2f]['actives'] = $actives;
}
	  ...
	  <div class='ipsBox_container ipsPad' id='mlist_content'>
			<ul class='ipsMemberList'>
				" . ((is_array( $active ) and count( $active )) ? ("
										".$this->__f__d47a6abc9f92455299f52701d93a9459($active,$actives)."				") : ("
		  ...
		  <div class='ipsBox_container ipsPad' id='mlist_content'>
				<ul class='ipsMemberList'>
					" . ((is_array( $actives ) and count( $actives )) ? ("
												".$this->__f__10dd03ff283be0db22a17b958f17bdba($active,$actives)."					") : ("
						<li class='no_messages'>
...
function __f__d47a6abc9f92455299f52701d93a9459($active, $actives)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__10dd03ff283be0db22a17b958f17bdba($active, $actives)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_60cf4363999e1741742db6c42e260a04 = is_array($this->functionData['member_alpha_ru']) ? count($this->functionData['member_alpha_ru']) : 0;
$this->functionData['member_alpha_ru'][$count_60cf4363999e1741742db6c42e260a04]['url'] = $url;
}
$IPBHTML .= "<li id='alpha_switch' class='clickable'>РУС</li>
	...
	<div class='ipsVerticalTabbed_tabs ipsVerticalTabbed_minitabs ipsLayout_left' id='mlist_tabs_ru'>
		<ul>
    		...
    		")) . "
    ".$this->__f__c9a1dbbacc770d637586da89ede607b5($url)."            <li id='alpha_switch_en' class='clickable'>АНГ</li>";
return $IPBHTML;
}


function __f__c9a1dbbacc770d637586da89ede607b5($url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b944efa9beeccd58429a67d25a589396 = is_array($this->functionData['member_list_show']) ? count($this->functionData['member_list_show']) : 0;
$this->functionData['member_list_show'][$count_b944efa9beeccd58429a67d25a589396]['members'] = $members;
$this->functionData['member_list_show'][$count_b944efa9beeccd58429a67d25a589396]['pages'] = $pages;
$this->functionData['member_list_show'][$count_b944efa9beeccd58429a67d25a589396]['dropdowns'] = $dropdowns;
$this->functionData['member_list_show'][$count_b944efa9beeccd58429a67d25a589396]['defaults'] = $defaults;
$this->functionData['member_list_show'][$count_b944efa9beeccd58429a67d25a589396]['custom_fields'] = $custom_fields;
$this->functionData['member_list_show'][$count_b944efa9beeccd58429a67d25a589396]['url'] = $url;
}
...
" . (($this->settings['pp_allow_member_rate']) ? ("<li class='field'>
			...
			" . ((count( $custom_fields->out_fields )) ? ("
				".$this->__f__ad5b2d75484291ce3dccc94d12c817e1($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			") : ("")) . "			
		</ul>
		<ul id='filters_2'>
			<li class='field'>
		...
		<fieldset class='other_filters'>
			<select name='filter' class='input_select'>
				".$this->__f__afd5f7fc01048fa45db9357a55e013e7($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_by']}
			<select name='sort_key' class='input_select'>
				".$this->__f__10e22fba816d3eaff6f94f78df0a98de($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_in']}
			<select name='sort_order' class='input_select'>
				".$this->__f__a00f42f3f39ba738ea381262865a682a($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_with']}
			<select name='max_results' class='input_select'>
				".$this->__f__66ca26bf765aafa6baa8aa432af33306($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
	...
	<div class='ipsVerticalTabbed_tabs ipsVerticalTabbed_minitabs ipsLayout_left' id='mlist_tabs'>
		<ul>
			...
			") : ("
				<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=members&amp;module=list", "public",'' ), "false", "members_list" ) . "' title='{$this->lang->words['mlist_view_all_title']}'>{$this->lang->words['mlist_view_all_txt']}</a></li>
			")) . "
			".$this->__f__cda0880fca2a4ae3cb10af0563f19e4a($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."		</ul>
	</div>
	<div class='ipsVerticalTabbed_content ipsLayout_content'>
		<div class='ipsBox_container ipsPad' id='mlist_content'>
			<ul class='ipsMemberList'>
				" . ((is_array( $members ) and count( $members )) ? ("
										".$this->__f__9aca30358fff91023eca6ea268f4c18b($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."				") : ("
					<li class='no_messages'>
...
function __f__ad5b2d75484291ce3dccc94d12c817e1($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__afd5f7fc01048fa45db9357a55e013e7($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__10e22fba816d3eaff6f94f78df0a98de($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a00f42f3f39ba738ea381262865a682a($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__66ca26bf765aafa6baa8aa432af33306($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__cda0880fca2a4ae3cb10af0563f19e4a($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__9aca30358fff91023eca6ea268f4c18b($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
