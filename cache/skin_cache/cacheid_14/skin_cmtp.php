...
class skin_cmtp_14 extends skinMaster{
...
{
$count_ea5582b1bea2f2ccd091f8a13c603853 = is_array($this->functionData['group_strip_fix']) ? count($this->functionData['group_strip_fix']) : 0;
$this->functionData['group_strip_fix'][$count_ea5582b1bea2f2ccd091f8a13c603853]['group'] = $group;
$this->functionData['group_strip_fix'][$count_ea5582b1bea2f2ccd091f8a13c603853]['members'] = $members;
$this->functionData['group_strip_fix'][$count_ea5582b1bea2f2ccd091f8a13c603853]['pagination'] = $pagination;
}
...
<table class='ipb_table ipsMemberList'>
	...
	" . ((count($members) AND is_array($members)) ? ("
				".$this->__f__18768453e7a3d7d443765fa295f77f12($group,$members,$pagination)."	") : ("")) . "
</table>
" . (($pagination) ? ("
	<div class='topic_controls'>{$pagination}</div>
") : ("")) . "
...
function __f__737c09d5e4b629977aff7952d9997888($group='', $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__73dec3f620a107969accd1a764e52ce4($group='', $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $info['forums'] as $id => $name )
...
function __f__18768453e7a3d7d443765fa295f77f12($group='', $members=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
			...
			<tr class='" .  IPSLib::next( $this->registry->templateStriping["staff"] ) . "'>
				...
				<td class='altrow short'>
					" . ((is_array($info['forums'])) ? ("" . ((count( $info['forums'] ) == 1) ? ("
							".$this->__f__737c09d5e4b629977aff7952d9997888($group,$members,$pagination,$info)."						") : ("
							...
							".$this->__f__73dec3f620a107969accd1a764e52ce4($group,$members,$pagination,$info)."							</ul>
