...
{
$count_12fa843b673a02ce8334f39bf02a3f99 = is_array($this->functionData['ajax__inlineLogInForm']) ? count($this->functionData['ajax__inlineLogInForm']) : 0;
}
...
{
$count_daf456b5d476ed37d41dce47c1f266c3 = is_array($this->functionData['showLogInForm']) ? count($this->functionData['showLogInForm']) : 0;
$this->functionData['showLogInForm'][$count_daf456b5d476ed37d41dce47c1f266c3]['message'] = $message;
$this->functionData['showLogInForm'][$count_daf456b5d476ed37d41dce47c1f266c3]['referer'] = $referer;
$this->functionData['showLogInForm'][$count_daf456b5d476ed37d41dce47c1f266c3]['extra_form'] = $extra_form;
$this->functionData['showLogInForm'][$count_daf456b5d476ed37d41dce47c1f266c3]['login_methods'] = $login_methods;
$this->functionData['showLogInForm'][$count_daf456b5d476ed37d41dce47c1f266c3]['facebookOpts'] = $facebookOpts;
}
				...
				<div class='right ipsPad_double' id='other_signin'>
					<ul class='ipsList_data clear ipsType_small'>
						...
						" . ((is_array($extra_form) AND count($extra_form)) ? ("
							".$this->__f__197a4f1b053fdebdd1f40f3b56d45596($message,$referer,$extra_form,$login_methods,$facebookOpts)."						") : ("")) . "
					</ul>
				</div>
			</div>
			" . ((IPSLib::loginMethod_enabled('live')) ? ("
...
function __f__197a4f1b053fdebdd1f40f3b56d45596($message="",$referer="",$extra_form="", $login_methods=array(), $facebookOpts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
