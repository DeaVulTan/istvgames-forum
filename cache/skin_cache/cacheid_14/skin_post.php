...
{
$count_cb488a110f5ed4a601fe51ad9ea5d517 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_cb488a110f5ed4a601fe51ad9ea5d517]['data'] = $data;
}
...
{
$count_6fc0f2f5b2bdfe4ba76e51cb7b8eac5d = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_6fc0f2f5b2bdfe4ba76e51cb7b8eac5d]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_6fc0f2f5b2bdfe4ba76e51cb7b8eac5d]['form'] = $form;
}
...
{
$count_ffca393a4c8232cfcb5eb3f3b4097c14 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_ffca393a4c8232cfcb5eb3f3b4097c14]['data'] = $data;
}
...
{
$count_ab93ba54d1d344884580b300de8dd14d = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_ab93ba54d1d344884580b300de8dd14d]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__dc72bc1f36ca0a4aec292cbd4f266fd8($posts)."") : ("")) . "
<p class='submit'>
...
function __f__dc72bc1f36ca0a4aec292cbd4f266fd8($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_413aa33428c9a5eb6a2073fea6209d27 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_413aa33428c9a5eb6a2073fea6209d27]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_413aa33428c9a5eb6a2073fea6209d27]['type'] = $type;
$this->functionData['uploadForm'][$count_413aa33428c9a5eb6a2073fea6209d27]['stats'] = $stats;
$this->functionData['uploadForm'][$count_413aa33428c9a5eb6a2073fea6209d27]['id'] = $id;
$this->functionData['uploadForm'][$count_413aa33428c9a5eb6a2073fea6209d27]['forum_id'] = $forum_id;
}
