...
$this->_funcHooks['globalTemplate'] = array('showingapp','applications','navigationlink','closenavigationlink','forsuredidfirstnav','navigation','didfirstappnowbottom','navigationlink','closenavigationlink','forsuredidfirstnavbottom','navigationbottom','isCoreRC','hideRcForPerms','fbcenabled','isLargeTouch','isSmallTouch','canSearch','notifications','messengerlink','notifications','showInboxNotify','ipsconnectRevalidateUrl','authenticating','updateTwitter','updateFacebook','update','canUpdateStatus','userLikeLink','nobbyNoMates','bloglink','pmLink','gallerylink','nexuslink','limFacebook','limTwitter','limWindows','memberbox','brandingBar','showhomeurl','applicationsloop','hasCustomPrimaryNavigation','didfirstnav','switchnavigation','ruleslink','siterulestitle','siteruleslink','viewnewcontentapp','showQuickNav','showacplink','rclink','accessreports','hasHeaderAd','mainpageContent','hasFooterAd','didfirstnavbottom','switchnavigationbottom','countnavbottom','isTouchDevice','skinchangerInner','uagentlocked','skinchangerOuter','langchooser','markRead','privvy','lastvisit','isfloat','sqldebuglink','closesqldebuglink','showdebuglevel','includeLightboxDoReal','vigLinkEnabled');
...
{
$count_51544a4d652dcfc27f5944bb2cc31d04 = is_array($this->functionData['fcRepBar']) ? count($this->functionData['fcRepBar']) : 0;
$this->functionData['fcRepBar'][$count_51544a4d652dcfc27f5944bb2cc31d04]['author'] = $author;
}
...
{
$count_f8e4b8f932ab97d27879e743ec57f92c = is_array($this->functionData['friendsOnline_globalmenu_frindslist']) ? count($this->functionData['friendsOnline_globalmenu_frindslist']) : 0;
$this->functionData['friendsOnline_globalmenu_frindslist'][$count_f8e4b8f932ab97d27879e743ec57f92c]['active'] = $active;
$this->functionData['friendsOnline_globalmenu_frindslist'][$count_f8e4b8f932ab97d27879e743ec57f92c]['actives'] = $actives;
}
...
<ul class='ipsList_withminiphoto'>
	" . ((is_array( $active ) && count( $active )) ? ("
		".$this->__f__0a21da3764f62d0dd3675dd5f4ff56f9($active,$actives)."	") : ("
...
" . (($this->settings['friendsOnline_staff_on']) ? ("<h4 class='ipsType_sectiontitle'>{$this->lang->words['staffOnline']}</h4>
	<ul class='ipsList_withminiphoto'>
		" . ((is_array( $actives ) && count( $actives )) ? ("
			".$this->__f__63962e95b89cab1a7152aca415e90b2d($active,$actives)."		") : ("
...
function __f__0a21da3764f62d0dd3675dd5f4ff56f9($active, $actives)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $active as $r )
...
function __f__63962e95b89cab1a7152aca415e90b2d($active, $actives)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_575443856a4db79d1390baf568c756a0 = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_575443856a4db79d1390baf568c756a0]['html'] = $html;
$this->functionData['globalTemplate'][$count_575443856a4db79d1390baf568c756a0]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_575443856a4db79d1390baf568c756a0]['css'] = $css;
$this->functionData['globalTemplate'][$count_575443856a4db79d1390baf568c756a0]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_575443856a4db79d1390baf568c756a0]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_575443856a4db79d1390baf568c756a0]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_575443856a4db79d1390baf568c756a0]['items'] = $items;
$this->functionData['globalTemplate'][$count_575443856a4db79d1390baf568c756a0]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_575443856a4db79d1390baf568c756a0]['stats'] = $stats;
}
...
$IPBHTML .= "<!DOCTYPE html>
	...
	<head>
		...
		<link href='http://fonts.googleapis.com/css?family=Source+Sans+Pro' rel='stylesheet' type='text/css'>
                ...
                <link href=\"//fast.fonts.net/cssapi/7492f661-79f4-4ab2-90f2-6a9eaf984a75.css\" rel=\"stylesheet\" />
...
<br />
                <!-- ::: USER MENU ::: -->
<div id='nav_wrap2'><div id='user_bar'><div class='clearfix'>
			...
			<div id='branding'>
                ...
                <!-- ::: MENU ::: -->
		 <div id='nav_wrap'><div id='primary_nav_under'><div id='primary_nav' class='clearfix'>
                <ul class='ipsList_inline' id='community_app_menu'>
                    ...
                    " . ((!empty($header_items['primary_navigation_menu'])) ? ("
                        ...
                        ".$this->__f__2e756d6f388e88f33a6328f2dd1ec570($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."                    ") : ("")) . "")) . "
            ...
            <div class='content'>
                ...
                <div id='secondary_navigation' class='clearfix'>
                    ...
                    <ol class='breadcrumb top ipsList_inline left' id='breadcrumb'>
                            ...
                            " . (($this->did_first=1) ? ("") : ("")) . "") : ("")) . "
                        ".$this->__f__c505b475398318432d2d99747b70d6d3($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."                    </ol>
...
" . (($items['adFooterCode']) ? ("
				...
				<ol class='breadcrumb bottom ipsList_inline left clearfix clear'>
					" . ((count( $items['navigation'] )) ? ("						" . ((!$this->settings['remove_forums_nav'] OR ipsRegistry::$current_application == 'forums') ? ("<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "act=idx", "public",'' ), "false", "" ) . "'>{$this->settings['board_name']}</a></li>
						...
						".$this->__f__7f8d49785c1cdc3cc4f58199eb5e3a17($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."") : ("
						<li>&nbsp;</li>
					")) . "
				</ol>
			</div>
			...
			<div id='footer_utilities' class='clearfix clear'>
				...
				<p style=\"color: #16A085;\">IPB Skin made by <b>AIMERS</b> # We aim the top !</p>
						...
						" . ((count($footer_items['skin_chooser']) > 1) ? ("
							<li>
								...
								<ul id='new_skin_menucontent' class='ipbmenu_content with_checks' style='display: none'>
									".$this->__f__5d95bb4d4160b0e3a1ef50460de2f1b6($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								</ul>
							</li>
						") : ("")) . "")) . "") : ("")) . "
					" . ((! $this->member->is_not_human && count( $footer_items['lang_chooser']['options'] ) > 1) ? ("
						<li>
							...
							<ul id='new_language_menucontent' class='ipbmenu_content with_checks' style='display: none'>
								".$this->__f__93190896fbf11f16396252afbefeb21e($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							</ul>
						</li>
					") : ("")) . "
					" . ((( ! $this->member->is_not_human ) && ( $this->memberData['member_id'] || $this->settings['topic_marking_guests'] )) ? ("
						<li>
							...
							<ul id='mark_all_read_menucontent' class='ipbmenu_content' style='display: none'>
								".$this->__f__027b600ff65fc64307810cbbf1523826($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								<li>
...
function __f__2e756d6f388e88f33a6328f2dd1ec570($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c505b475398318432d2d99747b70d6d3($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7f8d49785c1cdc3cc4f58199eb5e3a17($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $items['navigation'] as $idx => $data )
...
function __f__5d95bb4d4160b0e3a1ef50460de2f1b6($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__93190896fbf11f16396252afbefeb21e($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__027b600ff65fc64307810cbbf1523826($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_bb929b5109c9d2997cc9afc288bcfe4e = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_bb929b5109c9d2997cc9afc288bcfe4e]['css'] = $css;
}

$this->minify = array();
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__bd2030b96250c3527cbf38454d457cf7($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__85a905056533f7fe9f6d5b95440b1aa9($css)."") : ("")) . "<!--hook.if.skin_global.includeCSS.inlinecss.post.endif-->
<!--[if lte IE 7]>
...
function __f__bd2030b96250c3527cbf38454d457cf7($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__85a905056533f7fe9f6d5b95440b1aa9($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9fac5d991b3319864d1275de09a35f32 = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_9fac5d991b3319864d1275de09a35f32]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__23b7f1769681de1138b0486fa9e82013($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__6dbc33308fc07d5dc4f0c6c81a910295($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__23b7f1769681de1138b0486fa9e82013($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__6dbc33308fc07d5dc4f0c6c81a910295($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_f1368dc279c8c051ccf4a061371ce29a = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_f1368dc279c8c051ccf4a061371ce29a]['jsModules'] = $jsModules;
}
...
{
$count_e06c9afcff1b40bb5056b4636e4fdb4b = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_e06c9afcff1b40bb5056b4636e4fdb4b]['metaTags'] = $metaTags;
}
$IPBHTML .= "" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__89e8655d4fd3a114ba222bd7cd814a36($metaTags)."") : ("")) . "
<meta property=\"og:image\" content=\"{$this->settings['meta_imagesrc']}\"/>";
return $IPBHTML;
}


function __f__460ba6596ff448ded256586e8db4b8c2($metaTags,$tag='',$id='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__89e8655d4fd3a114ba222bd7cd814a36($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $metaTags as $tag => $id )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__460ba6596ff448ded256586e8db4b8c2($metaTags,$tag,$id)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_406669c18e4d95fe675404e69543e002 = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__f4f5cd896fffe434b82ff5e46e63d4a8()."" . (($this->isRtlLang AND is_file( DOC_IPS_ROOT_PATH . '/' . PUBLIC_DIRECTORY . '/style_css/' . $this->registry->output->skin['_csscacheid'] . '/ipb_rtl.css' )) ? ("
...
function __f__f4f5cd896fffe434b82ff5e46e63d4a8()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_08abe22a68eac8244dcac2cd00d1c5cc = is_array($this->functionData['includeVars']) ? count($this->functionData['includeVars']) : 0;
$this->functionData['includeVars'][$count_08abe22a68eac8244dcac2cd00d1c5cc]['header_items'] = $header_items;
}
...
{
$count_aa5f7b76c92f00c3c12fbc196884e5c7 = is_array($this->functionData['inlineLogin']) ? count($this->functionData['inlineLogin']) : 0;
}
					...
					<ul class='ipsList_inline'>
						...
						") : ("")) . "
							" . ((is_array($this->_formFields) AND count($this->_formFields)) ? ("
								".$this->__f__8f74da1f3b65277b4d21b5e78b454434()."							") : ("")) . "
					</ul>
				</div>") : ("")) . "
...
function __f__8f74da1f3b65277b4d21b5e78b454434()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f4c45e83ac7724fa7db8ce2c0c8a50d7 = is_array($this->functionData['liveEditJs']) ? count($this->functionData['liveEditJs']) : 0;
}
...
<div class='ipsBox ipsPad'>
	...
	<form action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&module=global&section=meta&do=save", "public",'' ), "", "" ) . "' method='post'>
		...
		<table class='ipb_table'>
			".$this->__f__33a5bc5c886e48a86054f8443d691c1c($tags,$url)."		</table>
		</div>
		<table class='ipb_table'>
			<tr>
...
function __f__33a5bc5c886e48a86054f8443d691c1c($tags, $url)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tags as $k => $v )
...
{
$count_f26e468d0dded2621495f42212dfae5a = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_f26e468d0dded2621495f42212dfae5a]['data'] = $data;
}
...
{
$count_e30797a91b75a84037d22f8d30a50c8b = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_e30797a91b75a84037d22f8d30a50c8b]['work'] = $work;
$this->functionData['paginationTemplate'][$count_e30797a91b75a84037d22f8d30a50c8b]['data'] = $data;
}
$IPBHTML .= "" . (($work['pages'] > 1) ? ("<div class='pagination clearfix left " . ((!$data['showNumbers']) ? ("no_numbers") : ("")) . "'>
		...
		<ul class='ipsList_inline left pages'>
			...
			" . ((is_array( $work['_pageNumbers'] ) && count( $work['_pageNumbers'] )) ? ("
				".$this->__f__832fdfbdd4d4cb9842a8e385c8aadf02($work,$data)."			") : ("")) . "
		</ul>
...
function __f__832fdfbdd4d4cb9842a8e385c8aadf02($work, $data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_80b4ad15f38e8cd00a93165e426cff41 = is_array($this->functionData['quickSearch']) ? count($this->functionData['quickSearch']) : 0;
}
		...
		<fieldset>
			...
			<span id='search_wrap' class='right'>
				...
				<ul id='search_options_menucontent' class='ipbmenu_content ipsPad' style='display: none'>
					...
					".$this->__f__6ca0c166b0e97a9097d406bd0cdecef7()."				</ul>
...
function __f__6ca0c166b0e97a9097d406bd0cdecef7()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_886b6a63e45649fc46200031404e89a9 = is_array($this->functionData['shareLinks']) ? count($this->functionData['shareLinks']) : 0;
$this->functionData['shareLinks'][$count_886b6a63e45649fc46200031404e89a9]['links'] = $links;
$this->functionData['shareLinks'][$count_886b6a63e45649fc46200031404e89a9]['title'] = $title;
$this->functionData['shareLinks'][$count_886b6a63e45649fc46200031404e89a9]['url'] = $url;
$this->functionData['shareLinks'][$count_886b6a63e45649fc46200031404e89a9]['cssClass'] = $cssClass;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("sharelinks", "0" ) . "
" . ((is_array( $links )) ? ("
	<ul class='{$cssClass} shareButtons ipsList_inline'>
	".$this->__f__121b056bcb29cf4f208d811fe7c48b38($links,$title,$url,$cssClass)."	</ul>
	<script type=\"text/javascript\">
...
function __f__121b056bcb29cf4f208d811fe7c48b38($links, $title='', $url='', $cssClass='topic_share left')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a1fe958d604c4ac42a5accb58aeae49b = is_array($this->functionData['signature_separator']) ? count($this->functionData['signature_separator']) : 0;
$this->functionData['signature_separator'][$count_a1fe958d604c4ac42a5accb58aeae49b]['sig'] = $sig;
$this->functionData['signature_separator'][$count_a1fe958d604c4ac42a5accb58aeae49b]['author_id'] = $author_id;
$this->functionData['signature_separator'][$count_a1fe958d604c4ac42a5accb58aeae49b]['can_ignore'] = $can_ignore;
}
...
{
$count_ce5d2b7685292aeabc1293491818611f = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_ce5d2b7685292aeabc1293491818611f]['member'] = $member;
}
...
{
$count_ff32e0a20c2668564dcb08ce0ce5db25 = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_ff32e0a20c2668564dcb08ce0ce5db25]['author'] = $author;
$this->functionData['userInfoPane'][$count_ff32e0a20c2668564dcb08ce0ce5db25]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_ff32e0a20c2668564dcb08ce0ce5db25]['options'] = $options;
}
$IPBHTML .= "<div itemscope itemtype=\"http://schema.org/Person\" class='user_details'>
	...
	" . (($author['custom_fields'] != "") ? ("
		<ul class='custom_fields'>
			".$this->__f__d32c770f80d0df86a74cdeaa79d2498b($author,$contentid,$options)."		</ul>
...
function __f__e98bee3ca0327f363a90f5c707b2c2ff($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__d32c770f80d0df86a74cdeaa79d2498b($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__e98bee3ca0327f363a90f5c707b2c2ff($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_64c976dd3dcf50e20cdb183f96ea13b7 = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_64c976dd3dcf50e20cdb183f96ea13b7]['member'] = $member;
}
...
{
$count_9b428fde4529cd71495f217228a64ff6 = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_9b428fde4529cd71495f217228a64ff6]['warning'] = $warning;
$this->functionData['warnDetails'][$count_9b428fde4529cd71495f217228a64ff6]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__040ea37eb805ba855aa222bef55c3547($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__040ea37eb805ba855aa222bef55c3547($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
