...
class skin_shoutbox_14 extends skinMaster{
...
{
$count_f756e8e6bfc638dd7275a01813aa9aae = is_array($this->functionData['archive']) ? count($this->functionData['archive']) : 0;
$this->functionData['archive'][$count_f756e8e6bfc638dd7275a01813aa9aae]['d'] = $d;
}
...
$IPBHTML .= "" . ((substr( $action, 0, 4 ) != 'edit') ? ("" . (($action == 'delete') ? ("
	...
	<div class=\"short\">
		...
		<table class=\"ipb_table\">
			...
			".$this->__f__24fe55a1e43602e5d99efa2772c97a7d($action,$data)."		</table>
		<br />
...
function __f__24fe55a1e43602e5d99efa2772c97a7d($action='',$data=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9be2971a5ecbf81a9a1f28e7dfbe3098 = is_array($this->functionData['popupWrapper']) ? count($this->functionData['popupWrapper']) : 0;
$this->functionData['popupWrapper'][$count_9be2971a5ecbf81a9a1f28e7dfbe3098]['output'] = $output;
}
...
{
$count_4c498dff81f2b4f8b167f953f340be38 = is_array($this->functionData['shout_row']) ? count($this->functionData['shout_row']) : 0;
$this->functionData['shout_row'][$count_4c498dff81f2b4f8b167f953f340be38]['d'] = $d;
$this->functionData['shout_row'][$count_4c498dff81f2b4f8b167f953f340be38]['can_edit'] = $can_edit;
$this->functionData['shout_row'][$count_4c498dff81f2b4f8b167f953f340be38]['ajax'] = $ajax;
}
...
{
$count_003dcd37d41d0bcb3c76c2c445d90ffe = is_array($this->functionData['shout_row_sidebar']) ? count($this->functionData['shout_row_sidebar']) : 0;
$this->functionData['shout_row_sidebar'][$count_003dcd37d41d0bcb3c76c2c445d90ffe]['d'] = $d;
$this->functionData['shout_row_sidebar'][$count_003dcd37d41d0bcb3c76c2c445d90ffe]['can_edit'] = $can_edit;
$this->functionData['shout_row_sidebar'][$count_003dcd37d41d0bcb3c76c2c445d90ffe]['ajax'] = $ajax;
}
...
{
$count_b5d7361a8b5df613dd9276eff887318e = is_array($this->functionData['shoutbox']) ? count($this->functionData['shoutbox']) : 0;
$this->functionData['shoutbox'][$count_b5d7361a8b5df613dd9276eff887318e]['data'] = $data;
$this->functionData['shoutbox'][$count_b5d7361a8b5df613dd9276eff887318e]['stats'] = $stats;
}
