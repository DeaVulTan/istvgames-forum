...
{
$count_03d71f38d810491b4928dad16774bf2f = is_array($this->functionData['forumAttachments']) ? count($this->functionData['forumAttachments']) : 0;
$this->functionData['forumAttachments'][$count_03d71f38d810491b4928dad16774bf2f]['title'] = $title;
$this->functionData['forumAttachments'][$count_03d71f38d810491b4928dad16774bf2f]['rows'] = $rows;
$this->functionData['forumAttachments'][$count_03d71f38d810491b4928dad16774bf2f]['pages'] = $pages;
}
...
<table class='ipb_table'>
	<tr class='header'>
		...
		" . ((count($rows)) ? ("".$this->__f__0dc18454089c6e445cf4ef6a8e667110($title,$rows,$pages)."	") : ("")) . "
</table>
" . (($pages) ? ("
	<br />
	<div class='topic_controls'>{$pages}</div>
...
function __f__0dc18454089c6e445cf4ef6a8e667110($title, $rows, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9c7d768116dd97452352d8a06eb6152c = is_array($this->functionData['forumIndexTemplate']) ? count($this->functionData['forumIndexTemplate']) : 0;
$this->functionData['forumIndexTemplate'][$count_9c7d768116dd97452352d8a06eb6152c]['forum_data'] = $forum_data;
$this->functionData['forumIndexTemplate'][$count_9c7d768116dd97452352d8a06eb6152c]['announce_data'] = $announce_data;
$this->functionData['forumIndexTemplate'][$count_9c7d768116dd97452352d8a06eb6152c]['topic_data'] = $topic_data;
$this->functionData['forumIndexTemplate'][$count_9c7d768116dd97452352d8a06eb6152c]['other_data'] = $other_data;
$this->functionData['forumIndexTemplate'][$count_9c7d768116dd97452352d8a06eb6152c]['multi_mod_data'] = $multi_mod_data;
$this->functionData['forumIndexTemplate'][$count_9c7d768116dd97452352d8a06eb6152c]['sub_forum_data'] = $sub_forum_data;
$this->functionData['forumIndexTemplate'][$count_9c7d768116dd97452352d8a06eb6152c]['footer_filter'] = $footer_filter;
$this->functionData['forumIndexTemplate'][$count_9c7d768116dd97452352d8a06eb6152c]['active_user_data'] = $active_user_data;
$this->functionData['forumIndexTemplate'][$count_9c7d768116dd97452352d8a06eb6152c]['mod_data'] = $mod_data;
$this->functionData['forumIndexTemplate'][$count_9c7d768116dd97452352d8a06eb6152c]['inforum'] = $inforum;
}
...
" . ((is_array( $announce_data ) AND count( $announce_data )) ? ("
	<div class='content_border'><table class='ipb_table topic_list hover_rows' summary='{$this->lang->words['forum_topic_list']} \"{$forum_data['name']}\"' id='announcements'>
		".$this->__f__712a22b6e34b59a90646f5d019257456($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."	</table></div>
	<br />	
") : ("")) . "
<!-- __-SUBFORUMS-__ -->
		...
		<div class='ipsBox table_wrap removeDefault'>
			<div class='ipsBox_container'>
				<table class='ipb_table' summary=\"{$this->lang->words['cat_subforums']} '{$forum_data['name']}'\">
					".$this->__f__340c392210cc238013b01f4e8f6d3ecb($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."				</table>
			</div>
		...
		<div class='ipsBox_container'>
			<table class='ipb_table topic_list hover_rows " . (($this->memberData['is_mod'] == 1) ? ("is_mod") : ("")) . "' summary='{$this->lang->words['forum_topic_list']} \"{$forum_data['name']}\"' id='forum_table'>
				...
				" . ((is_array( $topic_data ) AND count( $topic_data )) ? ("
					".$this->__f__76633f004197cdd2e6cd0ecb1439fb69($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."				") : ("<tr> 
						" . (($this->memberData['is_mod'] == 1) ? ("
	...
	<div id='forum_footer' class='statistics clear clearfix'>
		" . ((is_array( $mod_data ) AND count( $mod_data )) ? ("
			<div id='forum_led_by' class='right ipsType_small'>
				...
				".$this->__f__52631e6dab621eefec1cdbea623a3382($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."			</div>
		") : ("")) . "
...
" . ((is_array( $multi_mod_data ) AND count( $multi_mod_data )) ? ("
    ".$this->__f__9699717e0b8ef97850f31ab6ea9d2fb2($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."") : ("")) . "
</select>";
return $IPBHTML;
}


function __f__712a22b6e34b59a90646f5d019257456($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2ab28ab46a42ca465ff255b30df99256($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__bfcebc34481b300c40ebf0d303cc03a2($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $forum_data['subforums'] as $__id => $__data )
...
function __f__fc5f47e4edb9304b82248c42c5c79e9b($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
" . (($this->settings['customForumIcons']=='yes') ? ("															" . ((is_file( DOC_IPS_ROOT_PATH . '/' . PUBLIC_DIRECTORY . '/style_images/' . $imageFolder . '/forum_images/' . $forumId . '.png' )) ? ("
										...
										<td class='col_c_forum'>									
											...
											" . (($forum_data['show_subforums'] AND count( $forum_data['subforums'] ) AND $forum_data['show_subforums']) ? ("
												<ol class='ipsList_inline ipsType_small subforums2' id='subforums_{$forum_data['id']}'>".$this->__f__2ab28ab46a42ca465ff255b30df99256($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data,$forum_id,$forum_data)."</ol> <ol class='ipsList_inline ipsType_small subforums' id='subforums_{$forum_data['id']}'>".$this->__f__bfcebc34481b300c40ebf0d303cc03a2($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data,$forum_id,$forum_data)."</ol>
											") : ("")) . "
...
function __f__340c392210cc238013b01f4e8f6d3ecb($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sub_forum_data as $_data )
	{
		...
		$_ips___x_retval .= "
						" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("
							".$this->__f__fc5f47e4edb9304b82248c42c5c79e9b($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data)."						") : ("")) . "
...
function __f__76633f004197cdd2e6cd0ecb1439fb69($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__52631e6dab621eefec1cdbea623a3382($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__9699717e0b8ef97850f31ab6ea9d2fb2($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_da745feb679af02472aad6c53aea6286 = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_da745feb679af02472aad6c53aea6286]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_da745feb679af02472aad6c53aea6286]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_da745feb679af02472aad6c53aea6286]['opts'] = $opts;
}
...
$IPBHTML .= "" . (($this->settings['moderatorsindex_onoff'] AND $this->registry->getClass('class_forums')->forumsGetModerators( $fid )) ? ("<div id='forum_led_by' class='ipsType_small'>
		...
		".$this->__f__156cb1ca8781915e3b579959c0e85005($fid)."	</div>
<br />") : ("")) . "";
return $IPBHTML;
}


function __f__156cb1ca8781915e3b579959c0e85005($fid)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_335c24fc244d822e2f0a5c193ecb5818 = is_array($this->functionData['topic']) ? count($this->functionData['topic']) : 0;
$this->functionData['topic'][$count_335c24fc244d822e2f0a5c193ecb5818]['data'] = $data;
$this->functionData['topic'][$count_335c24fc244d822e2f0a5c193ecb5818]['forum_data'] = $forum_data;
$this->functionData['topic'][$count_335c24fc244d822e2f0a5c193ecb5818]['other_data'] = $other_data;
$this->functionData['topic'][$count_335c24fc244d822e2f0a5c193ecb5818]['inforum'] = $inforum;
}
...
" . (($data['_answeredPid'] !== false) ? ("
		...
		") : ("")) . "
		" . ((! $inforum && $data['nav']) ? ("
            ".$this->__f__ca5eb4bfa629938f1977506f021c9aac($data,$forum_data,$other_data,$inforum)."        ") : ("")) . "
        <h4>
            {$data['prefix']}
		...
		" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
			...
			".$this->__f__1b6055e23cea6e3d2294e64c4fff7808($data,$forum_data,$other_data,$inforum)."			</ul>
		") : ("")) . "
	</td>
...
function __f__ca5eb4bfa629938f1977506f021c9aac($data, $forum_data, $other_data, $inforum)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1b6055e23cea6e3d2294e64c4fff7808($data, $forum_data, $other_data, $inforum)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a014dacb8395677d79799a0dbbfbed9a = is_array($this->functionData['topic_rating_image']) ? count($this->functionData['topic_rating_image']) : 0;
$this->functionData['topic_rating_image'][$count_a014dacb8395677d79799a0dbbfbed9a]['rating_id'] = $rating_id;
}
$IPBHTML .= "<span class='mini_rate'>".$this->__f__6cf6d7bb00166de1252710c6485efec7($rating_id)."</span>";
return $IPBHTML;
}


function __f__6cf6d7bb00166de1252710c6485efec7($rating_id=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_85ee6553f2bab3b917cdcc85693c2482 = is_array($this->functionData['topicPrefixWrap']) ? count($this->functionData['topicPrefixWrap']) : 0;
$this->functionData['topicPrefixWrap'][$count_85ee6553f2bab3b917cdcc85693c2482]['text'] = $text;
}
$IPBHTML .= "" . (($text) ? ("
