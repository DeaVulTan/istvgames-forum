...
{
$count_01d5c818369234bb92e5a69bba799cad = is_array($this->functionData['group_strip']) ? count($this->functionData['group_strip']) : 0;
$this->functionData['group_strip'][$count_01d5c818369234bb92e5a69bba799cad]['group'] = $group;
$this->functionData['group_strip'][$count_01d5c818369234bb92e5a69bba799cad]['members'] = $members;
$this->functionData['group_strip'][$count_01d5c818369234bb92e5a69bba799cad]['pagination'] = $pagination;
}
...
<table class='ipb_table ipsMemberList'>
	...
	" . ((count($members) AND is_array($members)) ? ("
				".$this->__f__8582e30fe9b0f8f2c85650673e2a7700($group,$members,$pagination)."	") : ("")) . "
...
function __f__4cb7a1544887b2d375e3582f27adc57d($group="", $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5470ed34cab46f4641d836a459739820($group="", $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $info['forums'] as $id => $name )
...
function __f__8582e30fe9b0f8f2c85650673e2a7700($group="", $members=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
			...
			<tr class='" .  IPSLib::next( $this->registry->templateStriping["staff"] ) . "'>
				...
				<td class='altrow short'>
					" . ((is_array($info['forums'])) ? ("" . ((empty( $info['forums'] )) ? ("
							--
						") : ("" . ((count( $info['forums'] ) == 1) ? ("
								".$this->__f__4cb7a1544887b2d375e3582f27adc57d($group,$members,$pagination,$info)."							") : ("
								...
								".$this->__f__5470ed34cab46f4641d836a459739820($group,$members,$pagination,$info)."								</ul>
...
{
$count_04c92623139d8e2926998f498674760b = is_array($this->functionData['top_posters']) ? count($this->functionData['top_posters']) : 0;
$this->functionData['top_posters'][$count_04c92623139d8e2926998f498674760b]['rows'] = $rows;
}
...
<table class='ipb_table ipsMemberList'>
	...
	") : ("
				".$this->__f__8c05f809ad4b956889fb58b47dceff39($rows)."	")) . "
</table>
...
function __f__8c05f809ad4b956889fb58b47dceff39($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8f253f2d51900c413e5b09dd155bb176 = is_array($this->functionData['whoPosted']) ? count($this->functionData['whoPosted']) : 0;
$this->functionData['whoPosted'][$count_8f253f2d51900c413e5b09dd155bb176]['tid'] = $tid;
$this->functionData['whoPosted'][$count_8f253f2d51900c413e5b09dd155bb176]['title'] = $title;
$this->functionData['whoPosted'][$count_8f253f2d51900c413e5b09dd155bb176]['rows'] = $rows;
}
...
<div class='fixed_inner'>
	<table class='ipb_table'>
		...
		" . ((count($rows) AND is_array($rows)) ? ("
						".$this->__f__306bc63780d491f751189ef1fef956d7($tid,$title,$rows)."		") : ("")) . "
	</table>
</div>
...
function __f__306bc63780d491f751189ef1fef956d7($tid=0, $title="", $rows=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
