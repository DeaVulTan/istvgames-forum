...
class admin_jawards_system_root extends ipsCommand
{
	public function doExecute(ipsRegistry $registry)
	{
		...
		if(!$removalRows)
		{
			$removalRows = "
			<tr>
			  <td colspan='5' align='center'><em>Нету наград для отображения</em></td>
			</tr>";
		}
		...
		if( $x[0] == '0' )
		{
			$dwnld = "<span class='desctext'>Обновить</span>";
		}
		else
		{
			$dwnld = "";
		...
		<div style='float:right; width:39%;'>
		  ...
		  <div class='acp-box' style='margin-top:10px;'>
			<table class='ipsTable'>
			  <tr>
			    <td width='50%'><strong>Версия</strong></td>
		...
		<div style='float:left; width:60%;'>
		  <div class='acp-box'>
 		    <h3>Награды ожидающие утверждения</h3>
			<table class='ipsTable'>
			  <tr>
			    <th width='20%'>Награда</th>
				<th width='20%'>Награждённый</th>
				<th width='20%'>Выдал награду</th>
		  ...
		  <br />
		  <div class='acp-box'>
 		    <h3>Награды ожидающие удаления</h3>
			<table class='ipsTable'>
			  <tr>
			    <th width='20%'>Награда</th>
				<th width='20%'>Награждённый</th>
