...
<div class='warning' style='margin-bottom:15px;'>
	<h4><img src={$this->settings['skin_acp_url']}/images/icons/bullet_error.png' /> Ошибка!</h4>
	{$text}
</div>
HTML;
		//--endhtml--//
...
HTML;
	...
	public function main( $data )
	{
		...
		<tr>
			<th width='25%'>Название функции</th>
			<th width='5%'></th>
			<th width='*'>Награда</th>
...
<form name='typeOfAutoAward' method='post' action='{$this->settings['base_url']}module=awards&section=auto&do=add&continue'>
	<div class='acp-box'>
		...
		<div class='acp-actionbar' align='center'>
			<input type='submit' value=' {$this->lang->words['ja_continue']} ' class='realbutton' /> или <strong><a href='{$this->settings['base_url']}module=awards&section=auto'>{$this->lang->words['ja_cancel']}</a></strong>
		</div>
	</div>
</form>
HTML;
