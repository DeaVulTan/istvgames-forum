...
class fiLibrary
{
	...
	public function convertForum( $forum = array() )
	{
		...
		if( is_file( $iconPath ) )
		{
			...
			if( ! $this->caches['fi_icons'][ $forum['id'] ]['i_location'] )
			{
				...
				/* Insert info nad update forums info */
	...
	{
		return "<div id='footer' style='margin: 0px; text-align: center;-moz-border-radius:5px;'>Локализация <a target='_blank' href='http://www.ipbzona.ru'>" . $this->caches['app_cache']['forumicons']['app_title'] . " " . $this->caches['app_cache']['forumicons']['app_version'] . "</a> &copy; 2011 <a target='_blank' href='http://www.ipbzona.ru/' title='Моды, стили, локализации.'>IpbZona</a></div>";
	}
	
	public function small_c_acp()
	{
		return "<br /><div id='footer_utilities'><p id='copyright' class='right'>Локализация <a target='_blank' href='http://www.ipbzona.ru'>" . $this->caches['app_cache']['forumicons']['app_title'] . " " . $this->caches['app_cache']['forumicons']['app_version'] . "</a> &copy; <a target='_blank' href='http://www.ipbzona.ru' title='Моды, стили, локализации.'>IpbZona</a></p></div>";
	}		
}// End of class